inherited FormMovTransferenciaStock: TFormMovTransferenciaStock
  Left = 168
  Top = 113
  Caption = 'Movimientos de Transferencias por Deposito'
  ClientHeight = 649
  ClientWidth = 998
  ...
  inherited pnPrincipal: TPanel
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet2: TTabSheet
        ...
        object cxDBPivotGrid1: TcxDBPivotGrid
          ...
          object cxDBPivotGrid1Field6: TcxDBPivotGridField
            Area = faColumn
            AreaIndex = 0
            DataBinding.FieldName = 'NOMBRE_DEPOSITO_DESTINO'
            Visible = True
            UniqueName = 'Destino'
          end
          object cxDBPivotGrid1Field7: TcxDBPivotGridField
            AreaIndex = 3
            DataBinding.FieldName = 'NOMBRE_DEPOSITO_ORIGEN'
            Visible = True
            UniqueName = 'Origen'
          end
          ...
          object cxDBPivotGrid1Field10: TcxDBPivotGridField
            AreaIndex = 5
            DataBinding.FieldName = 'FIJACION_PRECIO_TOTAL'
            Visible = True
            UniqueName = 'F.Precio'
          end
          object cxDBPivotGrid1Field11: TcxDBPivotGridField
            AreaIndex = 6
            DataBinding.FieldName = 'ANIOMOVIMIENTO'
            Visible = True
            UniqueName = 'A'#241'o Movi.'
          end
          object cxDBPivotGrid1Field12: TcxDBPivotGridField
            AreaIndex = 7
            DataBinding.FieldName = 'MESMOVIMIENTO'
            Visible = True
            UniqueName = 'Mes Movi.'
          end
      ...
      object TabSheet3: TTabSheet
        ...
        object pnPieCOmprobantes: TPanel
          Left = 0
          Top = 374
          Width = 990
          Height = 33
    ...
    object pnCabecera: TPanel
      ...
      object dbcOrigen: TJvDBLookupCombo
        ...
        LookupSource = DSOrigen
        TabOrder = 1
        OnChange = TraerMovExecute
        OnClick = dbcOrigenClick
      end
    ...
    object pnPie: TPanel
      ...
      object rgModo: TAdvOfficeRadioGroup
        ...
        ItemIndex = 1
        Items.Strings = (
          'Listado agrupado x Articulo'
          'Listado Sin Agrupar')
        Ellipsis = False
      end
      object rgCosto: TAdvOfficeRadioGroup
        Left = 593
        Top = 2
        Width = 162
        Height = 50
        ...
        Items.Strings = (
          'por el Costo Actual'
          'por el Costo dia operaci'#243'n')
        Ellipsis = False
      end
    end
  end
  ...
  inherited ActionList1: TActionList
    Left = 536
    Top = 48
    object TraerMov: TAction
      Caption = 'TraerMov'
      OnExecute = TraerMovExecute
    end
  ...
  object frxReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.121867407400000000
    ReportOptions.LastChange = 39643.000149548600000000
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          HideZeros = True
          Memo.UTF8W = (
            'Listado de Mov.transferencia de Stock')
          ParentFont = False
        end
        object Memo2: TfrxMemoView
          AllowVectorExport = True
          Left = 661.338590000000000000
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Condition = '<frDBMov."CODIGO_ARTICULO">'
      end
  ...
  object frDBMov: TfrxDBDataset
    ...
    FieldDefs = <
      ...
      item
        FieldName = 'MUESTRACODIGODEPOSITO'
        FieldAlias = 'MUESTRACODIGODEPOSITO'
      end
      item
        FieldName = 'MUESTRANOMBREDEPO'
        FieldAlias = 'MUESTRANOMBREDEPO'
      end
      item
      ...
      item
        FieldName = 'COSTOTOAL'
        FieldAlias = 'COSTOTOAL'
      end
      item
        FieldName = 'CONDETALLE'
        FieldAlias = 'CONDETALLE'
      end>
  end
  object CDSMov: TClientDataSet
    ...
    object CDSMovDETALLE_STK: TStringField
    ...
    object CDSMovFIJACION_PRECIO_TOTAL: TFloatField
      DisplayLabel = 'F.Precio'
      FieldName = 'FIJACION_PRECIO_TOTAL'
    ...
    object CDSMovMUESTRACODIGODEPOSITO: TIntegerField
      DisplayLabel = 'Deposito'
      FieldName = 'MUESTRACODIGODEPOSITO'
      Origin = 'DEPOSITO'
    end
    object CDSMovMUESTRANOMBREDEPO: TStringField
      DisplayLabel = 'Deposito'
      FieldName = 'MUESTRANOMBREDEPO'
      Origin = 'NOMBRE'
      ProviderFlags = []
    ...
    object CDSMovDEPOSITO_ORIGEN: TIntegerField
      DisplayLabel = 'Dep.Origen'
      FieldName = 'DEPOSITO_ORIGEN'
      Origin = 'DEPOSITO_ORIGEN'
      ProviderFlags = []
    end
    object CDSMovDEPOSITO_DESTINO: TIntegerField
      DisplayLabel = 'Dep.Destino'
      FieldName = 'DEPOSITO_DESTINO'
      Origin = 'DEPOSITO_DESTINO'
      ProviderFlags = []
    end
    object CDSMovNOMBRE_DEPOSITO_DESTINO: TStringField
    ...
    object CDSMovNOMBRE_DEPOSITO_ORIGEN: TStringField
      DisplayLabel = 'Origen'
      FieldName = 'NOMBRE_DEPOSITO_ORIGEN'
    ...
    object CDSMovRECIBIDO_POR: TStringField
    ...
    object CDSMovUSUARIO: TStringField
      DisplayLabel = 'Genero'
      FieldName = 'USUARIO'
      Origin = 'USUARIO'
      ProviderFlags = []
    ...
    object CDSMovCOSTOTOAL: TFloatField
    ...
    object CDSMovCONDETALLE: TBooleanField
      FieldKind = fkInternalCalc
      FieldName = 'CONDETALLE'
    end
    object CDSMovMESMOVIMIENTO: TSmallintField
      DisplayLabel = 'Mes Movi.'
      FieldName = 'MESMOVIMIENTO'
      Origin = 'MESMOVIMIENTO'
      ProviderFlags = []
    end
    object CDSMovANIOMOVIMIENTO: TSmallintField
      DisplayLabel = 'A'#241'o Movi.'
      FieldName = 'ANIOMOVIMIENTO'
      Origin = 'ANIOMOVIMIENTO'
      ProviderFlags = []
    end
    ...
    object CDSMovCONTENIDO_COMPRA: TFloatField
      FieldName = 'CONTENIDO_COMPRA'
    ...
    object CDSMovFECHA_HORA: TSQLTimeStampField
    ...
    object CDSMovFECHA_RECECION: TSQLTimeStampField
      DisplayLabel = 'F.Recibido'
      FieldName = 'FECHA_RECECION'
      Origin = 'FECHA_RECECION'
      ProviderFlags = []
      ReadOnly = True
    end
    object CDSMovDETALLE_RUBRO: TStringField
      DisplayLabel = 'Rubro'
    ...
    object CDSMovDETALLE_SUBRUBRO: TStringField
    ...
    object CDSMovCODIGOALTERNATIVO: TStringField
  ...
  object DSCpbte: TDataSource
    DataSet = QCpbte
    Left = 648
    Top = 208
  end
  object frDBCpbte: TfrxDBDataset
    UserName = 'frDBCpbte'
    CloseDataSource = False
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object QMov: TFDQuery
    ...
    SQL.Strings = (
      ...
      'tr.fecha_rececion,mov.id_cpbte,'
        ...
        'al/s.contenido_compra)*(mov.sale+mov.entra)) as CostoToal,'
      'extract (month from mov.fecha) as MesMovimiento,'
      'extract (year from mov.fecha) as AnioMovimiento,'
      
        'r.detalle_rubro,sr.detalle_subrubro,s.reemplazo_stk as CodigoAlt' +
        'ernativo  from mov_stock mov'
  ...
  object QCpbte: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select t.id_trcab,t.fecha,t.tipocpbte,t.clasecpbte,t.letratr,t.s' +
        'uctr,t.numerotr,'
      
        '  t.nombre_deposito_origen,t.nombre_deposito_destino,t.nrocpbte,' +
        't.sucursal, s.detalle from trancab t'
    ...
    object QCpbteID_TRCAB: TIntegerField
      FieldName = 'ID_TRCAB'
      Origin = 'ID_TRCAB'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QCpbteTIPOCPBTE: TStringField
      DisplayLabel = 'Tipo'
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Size = 2
    end
    object QCpbteCLASECPBTE: TStringField
      DisplayLabel = 'Clase'
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object QCpbteLETRATR: TStringField
      FieldName = 'LETRATR'
      Origin = 'LETRATR'
      Required = True
      Size = 1
    end
    object QCpbteSUCTR: TStringField
      FieldName = 'SUCTR'
      Origin = 'SUCTR'
      Required = True
      Size = 4
    end
    object QCpbteNUMEROTR: TStringField
      FieldName = 'NUMEROTR'
      Origin = 'NUMEROTR'
      Required = True
      Size = 8
    end
    object QCpbteNOMBRE_DEPOSITO_ORIGEN: TStringField
      DisplayLabel = 'Depsito Origen'
      FieldName = 'NOMBRE_DEPOSITO_ORIGEN'
      Origin = 'NOMBRE_DEPOSITO_ORIGEN'
      Size = 25
    end
    object QCpbteNOMBRE_DEPOSITO_DESTINO: TStringField
      DisplayLabel = 'Deposito Destino'
      FieldName = 'NOMBRE_DEPOSITO_DESTINO'
      Origin = 'NOMBRE_DEPOSITO_DESTINO'
      Size = 25
    end
    object QCpbteNROCPBTE: TStringField
      DisplayLabel = 'Nro.Cpbte'
      FieldName = 'NROCPBTE'
      Origin = 'NROCPBTE'
      Size = 13
    end
    object QCpbteSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Origin = 'SUCURSAL'
      Required = True
    end
    object QCpbteDETALLE: TStringField
    ...
    object QCpbteFECHA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
      Origin = 'FECHA'
      Required = True
