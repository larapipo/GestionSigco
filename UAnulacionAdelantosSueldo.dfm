inherited FormAnulacionAdelantos: TFormAnulacionAdelantos
  Left = 196
  Top = 81
  Caption = 'Anulaci'#243'n de Adelantos'
  ClientHeight = 622
  ClientWidth = 709
    ...
    object pnValores: TPanel
      ...
      inline FrameMovValoresIngreso1: TFrameMovValoresIngreso
        ...
        inherited pcValores: TPageControl
          ActivePage = FrameMovValoresIngreso1.tsDebito
  ...
  object DSPAnulacionAdelantos: TDataSetProvider
    DataSet = QAnulacionAdelantos
    Options = []
  ...
  object IBGId_Adelantos: TIBGenerator
    DatabaseFD = DMMain_FD.fdcGestion
    GeneratorName = 'NEXT_ID_ANULA_ADELANTOS_SUELDO'
    SystemGenerators = False
    Left = 416
    Top = 560
  end
  object frAdelantos: TfrxReport
    Version = '2024.1.8'
    ...
    ReportOptions.CreateDate = 39638.835443611110000000
    ReportOptions.LastChange = 39638.835443611110000000
  ...
  object frdbAdelantos: TfrxDBDataset
    UserName = 'frdbAdelantos'
    CloseDataSource = False
    DataSet = CDSAnulacionAdelantos
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object frDBCheques: TfrxDBDataset
    ...
    FieldDefs = <
      ...
      item
        FieldName = 'ID_CUENTA'
        FieldAlias = 'ID_CUENTA'
      end
      item
        FieldName = 'NRO_CUENTA'
        FieldAlias = 'NRO_CUENTA'
      end
      item
        FieldName = 'NUMERO_INCIAL'
        FieldAlias = 'NUMERO_INCIAL'
      end
      item
        FieldName = 'NUMERO_FINAL'
        FieldAlias = 'NUMERO_FINAL'
      end
      item
      ...
      item
        ...
        FieldAlias = 'CANT_CHE_EMITIDOS'
      end
      item
        FieldName = 'CHEQUERA_TERMINADA'
        FieldAlias = 'CHEQUERA_TERMINADA'
      end
      item
        FieldName = 'MUESTRABANCO'
        FieldAlias = 'MUESTRABANCO'
  ...
  object QAnulacionAdelantos: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select a.*,'
      ...
      '  cp.denominacion as MuestraComprobante,'
        ...
        '  cp.id_comprobante as id_tipocomprobante from Anulacion_adelant' +
        'os_sueldo a'
      'left join sucursal s on s.codigo=a.sucursal'
      'left join comprobantes cp on cp.clase_comprob=a.ClaseCpbte and'
      '          cp.letra=a.Letra and'
      '          cp.sucursal=a.sucursal and'
      '          cp.tipo_comprob=a.tipocpbte and'
      '          cp.compra_venta='#39'C'#39
      'where a.id=:id and a.TipoCpbte=:TipoCpbte'
      ' ')
    Left = 120
    Top = 560
    ParamData = <
    ...
    object QAnulacionAdelantosID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QAnulacionAdelantosTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Required = True
      Size = 4
    end
    object QAnulacionAdelantosCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Size = 4
    end
    object QAnulacionAdelantosLETRA: TStringField
      FieldName = 'LETRA'
      Required = True
      Size = 1
    end
    object QAnulacionAdelantosSUC: TStringField
      FieldName = 'SUC'
      Required = True
      Size = 4
    end
    object QAnulacionAdelantosNUMERO: TStringField
      FieldName = 'NUMERO'
      Required = True
      Size = 8
    end
    object QAnulacionAdelantosSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Required = True
    end
    object QAnulacionAdelantosFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object QAnulacionAdelantosCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 6
    end
    object QAnulacionAdelantosIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object QAnulacionAdelantosDETALLE: TStringField
      FieldName = 'DETALLE'
      Size = 100
    end
    object QAnulacionAdelantosNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Required = True
      Size = 13
    end
    object QAnulacionAdelantosNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 50
    end
    object QAnulacionAdelantosMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object QAnulacionAdelantosMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object QAnulacionAdelantosID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
    end
  end
  object CDSAnulacionAdelantos: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPAnulacionAdelantos'
    OnNewRecord = CDSAnulacionAdelantosNewRecord
    Left = 288
    Top = 560
    object CDSAnulacionAdelantosID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSAnulacionAdelantosTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Required = True
      Size = 4
    end
    object CDSAnulacionAdelantosCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Size = 4
    end
    object CDSAnulacionAdelantosLETRA: TStringField
      FieldName = 'LETRA'
      Required = True
      Size = 1
    end
    object CDSAnulacionAdelantosSUC: TStringField
      FieldName = 'SUC'
      Required = True
      OnSetText = CDSAnulacionAdelantosSUCSetText
      Size = 4
    end
    object CDSAnulacionAdelantosNUMERO: TStringField
      FieldName = 'NUMERO'
      Required = True
      OnSetText = CDSAnulacionAdelantosNUMEROSetText
      Size = 8
    end
    object CDSAnulacionAdelantosSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Required = True
      OnSetText = CDSAnulacionAdelantosSUCURSALSetText
    end
    object CDSAnulacionAdelantosFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object CDSAnulacionAdelantosCODIGO: TStringField
      FieldName = 'CODIGO'
      OnSetText = CDSAnulacionAdelantosCODIGOSetText
      Size = 6
    end
    object CDSAnulacionAdelantosIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
    object CDSAnulacionAdelantosDETALLE: TStringField
      FieldName = 'DETALLE'
      Size = 100
    end
    object CDSAnulacionAdelantosNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Required = True
      Size = 13
    end
    object CDSAnulacionAdelantosNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 50
    end
    object CDSAnulacionAdelantosMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object CDSAnulacionAdelantosMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object CDSAnulacionAdelantosID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
      OnSetText = CDSAnulacionAdelantosID_TIPOCOMPROBANTESetText
    end
  end
  ...
  object CDSBuscaEmpleado: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSPBuscaEmpleado'
    Left = 514
    Top = 520
    object CDSBuscaEmpleadoNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 50
    end
    object CDSBuscaEmpleadoCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 6
    end
  end
  object DSPBuscaEmpleado: TDataSetProvider
