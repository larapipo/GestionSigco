  ...
  object QBuscaDetFD: TFDQuery
    ...
    SQL.Strings = (
      'select sub.id, cab.fecha_iniciada, sub.codigo ,sub.detalle,'
        ...
        '       cab.nrocpbte,cab.cliente,cl.nombre from ordenproduccion_s' +
        'ub_det sub'
      ...
      '  where cab.estado='#39'P'#39' and sub.estacion= :estacion')
    Left = 200
    Top = 368
    ParamData = <
      item
