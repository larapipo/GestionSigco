inherited FormCpbteCtaCteReducida: TFormCpbteCtaCteReducida
  Left = 227
  Top = 107
  Caption = 'Comprobante de Venta Reducido'
  ClientHeight = 578
  ClientWidth = 684
  OldCreateOrder = True
  ExplicitLeft = 227
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnPieFactura: TPanel
      ...
      object dbgIva: TDBGrid
        ...
        Width = 387
        Height = 59
        DataSource = DatosVentaReducida.wwDSImpuestos
  ...
  object wwLookupLdr: TwwLookupDialog
    Selected.Strings = (
      'Codigo_Ldr'#9'10'#9'Codigo'#9'F'
      'Nombre'#9'35'#9'Nombre'#9#9
      'Direccion'#9'35'#9'Direccion'#9#9)
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = DatosVentaReducida.QLdr
    Caption = 'Lugar de Recepci'#243'n'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
    Left = 212
  ...
  object wwBuscadorSucursal: TwwLookupDialog
    ...
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = DatosVentaReducida.CDSBuscaSucursal
    Caption = 'Sucursales'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
  ...
  object QBuscaComprob: TQuery
    ...
    SQL.Strings = (
        ...
        '(tipo_comprob='#39'FC'#39' or tipo_comprob='#39'NC'#39' or tipo_comprob='#39'ND'#39' or ' +
  ...
  object wwBuscadorDeposito: TwwLookupDialog
    Selected.Strings = (
      'NOMBRE'#9'25'#9'Detalle'#9'F'
      'ID'#9'10'#9'Codigo'#9'F')
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = DatosVentaReducida.CDSBuscaDeposito
  ...
  object wwLookupStock: TwwLookupDialog
    Selected.Strings = (
      'DETALLE_STK'#9'45'#9'Detalle'#9'F'#9
      'CODIGO_STK'#9'8'#9'Codigo'#9'F'#9
      'CODIGO_PROVEEDOR'#9'10'#9'Codigo Proveedor'#9'F'#9)
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    Caption = 'Stock'
  ...
  object wwLookupCondVta: TwwLookupDialog
    Selected.Strings = (
      'CODIGOPAGO'#9'10'#9'Codigo'#9'F'
  ...
  object BuscadorIva: TwwLookupDialog
    Selected.Strings = (
      'CODIGO'#9'10'#9'Codigo'#9'F'
  ...
  object wwBuscadorVendedor: TwwLookupDialog
    Selected.Strings = (
    ...
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = DatosVentaReducida.CDSBuscaVendedor
    Caption = 'Venedores'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
