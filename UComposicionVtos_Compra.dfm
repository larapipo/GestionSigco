inherited FormComposicionVtosComp: TFormComposicionVtosComp
  Left = 235
  Top = 159
  Caption = 'Composici'#243'n de Deudas Proveedores'
  ClientHeight = 640
  ClientWidth = 983
  ...
  inherited pnPrincipal: TPanel [1]
    Width = 983
    Height = 587
    Align = alClient
    TabOrder = 1
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object pnCabecera: TPanel
          ...
          object Label5: TLabel
            ...
            Width = 483
            Height = 32
            Caption = 'Composicion de Deuda Proveedores'
        ...
        object cxDBPivotGrid1: TcxDBPivotGrid
          ...
          object cxDBPivotGrid1Field6: TcxDBPivotGridField
            AreaIndex = 3
            DataBinding.FieldName = 'DIASMCPR'
            Visible = True
            UniqueName = 'Dia Cpr'
          end
          ...
          object cxDBPivotGrid1Field15: TcxDBPivotGridField
            AreaIndex = 10
            DataBinding.FieldName = 'SEMANACPRA'
            Visible = True
            UniqueName = 'Sem.Cpra'
          end
      ...
      object TabSheet2: TTabSheet
        ...
        object PnCabeceraCC: TPanel
          ...
          object LComposCCprovee: TLabel
            Left = 16
            Top = 11
            Width = 354
            Height = 29
            Caption = 'Compocision CC Proveedores'
            Font.Charset = DEFAULT_CHARSET
        ...
        object PnCuerpoCC: TPanel
          ...
          Caption = 'PnCuerpoCC'
          TabOrder = 1
          object DBGCCprovee: TDBGrid
            Left = 1
            Top = 1
            Width = 973
            Height = 508
            Align = alClient
            DataSource = DSCCprovee
            TabOrder = 0
  ...
  object CDSCompras: TClientDataSet
    ...
    object CDSComprasID_MOVCCCOMPRA: TIntegerField
      FieldName = 'ID_MOVCCCOMPRA'
      Origin = 'ID_MOVCCCOMPRA'
    end
    object CDSComprasMESVTO: TSmallintField
      DisplayLabel = 'Mes Vto'
      FieldName = 'MESVTO'
      Origin = 'MESVTO'
    end
    object CDSComprasANIOVTO: TSmallintField
      DisplayLabel = 'A'#241'o Vto'
      FieldName = 'ANIOVTO'
      Origin = 'ANIOVTO'
    end
    object CDSComprasMESCPR: TSmallintField
      DisplayLabel = 'Mes Cpra.'
      FieldName = 'MESCPR'
      Origin = 'MESCPR'
      Required = True
    end
    object CDSComprasANIOCPR: TSmallintField
      DisplayLabel = 'A'#241'o Compra.'
      FieldName = 'ANIOCPR'
      Origin = 'ANIOCPR'
      Required = True
    end
    object CDSComprasDIASMCPR: TSmallintField
      DisplayLabel = 'Dia Cpr'
      FieldName = 'DIASMCPR'
      Origin = 'DIASMCPR'
      Required = True
    end
    object CDSComprasDIASMVTO: TSmallintField
      DisplayLabel = 'Dia Vto'
      FieldName = 'DIASMVTO'
      Origin = 'DIASMVTO'
    end
    object CDSComprasSEMANACPRA: TWordField
      DisplayLabel = 'Sem.Cpra'
      FieldKind = fkCalculated
      FieldName = 'SEMANACPRA'
      Calculated = True
    end
    object CDSComprasSEMANAVTO: TWordField
    ...
    object CDSComprasHABER: TFloatField
      DisplayLabel = 'Haber'
      FieldName = 'HABER'
      Origin = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSComprasSALDO: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      Origin = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSComprasSALDO_ANTERIOR: TFloatField
      DisplayLabel = 'Saldo Anter.'
      FieldName = 'SALDO_ANTERIOR'
      Origin = 'SALDO_ANTERIOR'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSComprasDEBE: TFloatField
      DisplayLabel = 'Debe'
      FieldName = 'DEBE'
      Origin = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    ...
    object CDSComprasFECHAVTO: TSQLTimeStampField
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TcxPivotGridReportLink
      ...
      ReportDocument.CreationDate = 46071.512582210650000000
      PixelsPerInch = 96
  ...
  object QCompras: TFDQuery
    ...
    SQL.Strings = (
      'select  * from LST_DEUDAS_COMPRA ( :desde,:hasta )')
    Left = 224
    Top = 392
    ParamData = <
      item
  ...
  object QCCprovee: TFDQuery
    ...
    SQL.Strings = (
      ...
      ' from movcccompra m'
      ' left join poveedor p on m.proveedor = p.codigo'
      ' where m.fechacompra between :desde and :hasta'
  ...
  object DSPCCprovee: TDataSetProvider
    DataSet = QCCprovee
    Left = 776
    Top = 192
  end
  object CDSCCprovee: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftTimeStamp
    ...
    ProviderName = 'DSPCCprovee'
    Left = 792
    Top = 280
    object CDSCCproveeCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 6
    end
    object CDSCCproveeNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 35
    end
    object CDSCCproveeHABER: TFloatField
      FieldName = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSCCproveeDEBE: TFloatField
      FieldName = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSCCproveeSALDO: TFloatField
      FieldName = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
  end
  object DSCCprovee: TDataSource
    DataSet = CDSCCprovee
    Left = 792
    Top = 392
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 46071.531189131940000000
    ReportOptions.LastChange = 46071.531189131940000000
