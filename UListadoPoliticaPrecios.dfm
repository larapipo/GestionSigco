inherited FormListaPoliticasPrecios: TFormListaPoliticasPrecios
  Left = 144
  Top = 87
  Caption = 'Listado de Politicas de Precios'
  ClientHeight = 762
  ClientWidth = 1108
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet2: TTabSheet
        ...
        object cxDBPivotGrid1: TcxDBPivotGrid
          ...
          OptionsView.RowGrandTotalWidth = 254
          ...
          object cxDBPivotGrid1Field9: TcxDBPivotGridField
            AreaIndex = 4
            DataBinding.FieldName = 'FIJACION_PRECIO_FINAL'
            Visible = True
            UniqueName = 'Costo Final'
          end
          object cxDBPivotGrid1Field10: TcxDBPivotGridField
            AreaIndex = 5
            DataBinding.FieldName = 'COSTOEXENTOLISTA'
            Visible = True
            UniqueName = 'C.Exento Lista'
          end
          object cxDBPivotGrid1Field11: TcxDBPivotGridField
            AreaIndex = 6
            DataBinding.FieldName = 'COSTOGRAVLISTA'
            Visible = True
            UniqueName = 'C.Grav.Lista'
          end
          object cxDBPivotGrid1Field12: TcxDBPivotGridField
            AreaIndex = 8
            DataBinding.FieldName = 'COSTOTOTLISTA'
            Visible = True
            Width = 86
            UniqueName = 'C.Total Lista'
          end
          object cxDBPivotGrid1Field13: TcxDBPivotGridField
            AreaIndex = 7
            DataBinding.FieldName = 'DESCUENTOLISTA'
            Visible = True
            UniqueName = 'Dscto.Lista'
          end
          object cxDBPivotGrid1Field14: TcxDBPivotGridField
            Area = faData
            AreaIndex = 0
            DataBinding.FieldName = 'RECARGILISTA'
            Visible = True
            Width = 68
            UniqueName = 'Rec.Lista'
          end
          object cxDBPivotGrid1Field15: TcxDBPivotGridField
            AreaIndex = 9
            DataBinding.FieldName = 'PRECIOEXELISTA'
            Visible = True
            UniqueName = 'P.Exento Lista'
          end
          object cxDBPivotGrid1Field16: TcxDBPivotGridField
            AreaIndex = 10
            DataBinding.FieldName = 'PRECIOGRAVLISTA'
            Visible = True
            UniqueName = 'P.Gravado Lista'
          end
          object cxDBPivotGrid1Field17: TcxDBPivotGridField
            AreaIndex = 11
            DataBinding.FieldName = 'PRECIOIVALISTA'
            Visible = True
            UniqueName = 'Iva Lista'
          end
          object cxDBPivotGrid1Field18: TcxDBPivotGridField
            Area = faData
            AreaIndex = 1
            DataBinding.FieldName = 'PRECIOLISTA'
            Visible = True
            Width = 77
            UniqueName = 'P. de Lista'
          end
          object cxDBPivotGrid1Field19: TcxDBPivotGridField
            AreaIndex = 13
            DataBinding.FieldName = 'CODIGOALTERNATIVO'
            Visible = True
            UniqueName = 'Cod.Altern.'
          end
  ...
  object DSPoliticaPrecios: TDataSource
    DataSet = CDSPoliticaPrecios
    Left = 192
    Top = 432
  end
  object DSPPoliticaPrecios: TDataSetProvider
    DataSet = QPoliticaPrecios
    Options = []
    Left = 80
    Top = 432
  end
  ...
  object CDSPoliticaPrecios: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSPPoliticaPrecios'
    Left = 136
    Top = 440
    object CDSPoliticaPreciosCODIGOARTICULO: TStringField
      FieldName = 'CODIGOARTICULO'
      Origin = 'CODIGOARTICULO'
      Size = 8
    end
    object CDSPoliticaPreciosID_CAB: TIntegerField
      Alignment = taCenter
      FieldName = 'ID_CAB'
      Origin = 'ID_CAB'
    end
    object CDSPoliticaPreciosNOMBRE: TStringField
      DisplayLabel = 'Nombre Lista'
      FieldName = 'NOMBRE'
      Origin = 'NOMBRE'
      ProviderFlags = []
      Size = 50
    end
    object CDSPoliticaPreciosRECARGO: TFloatField
      DisplayLabel = 'Rec %'
      FieldName = 'RECARGO'
      Origin = 'RECARGO'
      DisplayFormat = '0.00'
    end
    object CDSPoliticaPreciosPRECIO: TFloatField
      DisplayLabel = 'Precio'
      FieldName = 'PRECIO'
      Origin = 'PRECIO'
      DisplayFormat = ',0.00'
    end
    object CDSPoliticaPreciosIVA_TASA: TFloatField
      DisplayLabel = '% IVA'
      FieldName = 'IVA_TASA'
      Required = True
      DisplayFormat = '0.00'
    end
    object CDSPoliticaPreciosDESCUENTO: TFloatField
      DisplayLabel = 'Desct.'
      FieldName = 'DESCUENTO'
      Required = True
      DisplayFormat = '0.00'
    end
    object CDSPoliticaPreciosFECHA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
    end
  end
  object frxReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.817307581020000000
    ReportOptions.LastChange = 39638.817307581020000000
  ...
  object frDBPrecios: TfrxDBDataset
    UserName = 'frDBPrecios'
  ...
  object pdProgress: TJvProgressDialog
    ...
    ShowCancel = False
    Smooth = True
    Text = 'Generando Archio Excel'
    Transparent = True
    Left = 272
    Top = 352
  end
  object DSPStock_2: TDataSetProvider
    DataSet = QStock_2
    Options = []
    Left = 208
    Top = 552
  end
  object CDSStock_2: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSPStock_2'
    Left = 272
    Top = 528
    object CDSStock_2CODIGO_STK: TStringField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGO_STK'
      Required = True
      Size = 8
    end
    object CDSStock_2DETALLE_STK: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE_STK'
      Size = 45
    end
    object CDSStock_2RUBRO_STK: TStringField
      FieldName = 'RUBRO_STK'
      Required = True
      Size = 3
    end
    object CDSStock_2DETALLE_RUBRO: TStringField
      DisplayLabel = 'Rubro'
      FieldName = 'DETALLE_RUBRO'
      Size = 35
    end
    object CDSStock_2SUBRUBRO_STK: TStringField
      FieldName = 'SUBRUBRO_STK'
      Required = True
      Size = 5
    end
    object CDSStock_2DETALLE_SUBRUBRO: TStringField
      DisplayLabel = 'Sub Rubro'
      FieldName = 'DETALLE_SUBRUBRO'
      Size = 45
    end
    object CDSStock_2NOMBRELISTA: TStringField
      DisplayLabel = 'Lista de Precios'
      FieldName = 'NOMBRELISTA'
      Size = 50
    end
    object CDSStock_2CODIGOALTERNATIVO: TStringField
      DisplayLabel = 'Cod.Altern.'
      FieldName = 'CODIGOALTERNATIVO'
      Required = True
    end
    object CDSStock_2FIJACION_PRECIO_EXENTO: TFloatField
      DisplayLabel = 'Costo Exe'
      FieldName = 'FIJACION_PRECIO_EXENTO'
      Required = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2FIJACION_PRECIO_GRAVADO: TFloatField
      DisplayLabel = 'Costo Grav'
      FieldName = 'FIJACION_PRECIO_GRAVADO'
      Required = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2FIJACION_PRECIO_IVA: TFloatField
      DisplayLabel = 'Costo Iva'
      FieldName = 'FIJACION_PRECIO_IVA'
      Required = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2FIJACION_PRECIO_FINAL: TFloatField
      DisplayLabel = 'Costo Final'
      FieldName = 'FIJACION_PRECIO_FINAL'
      Required = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2FIJACION_PRECIO_TOTAL: TFloatField
      DisplayLabel = 'Costo Total'
      FieldName = 'FIJACION_PRECIO_TOTAL'
      Required = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2COSTOEXENTOLISTA: TFloatField
      DisplayLabel = 'C.Exento Lista'
      FieldName = 'COSTOEXENTOLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2COSTOGRAVLISTA: TFloatField
      DisplayLabel = 'C.Grav.Lista'
      FieldName = 'COSTOGRAVLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2COSTOTOTLISTA: TFloatField
      DisplayLabel = 'C.Total Lista'
      FieldName = 'COSTOTOTLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2RECARGILISTA: TFloatField
      DisplayLabel = 'Rec.Lista'
      FieldName = 'RECARGILISTA'
      ReadOnly = True
      DisplayFormat = '0.00'
    end
    object CDSStock_2DESCUENTOLISTA: TFloatField
      DisplayLabel = 'Dscto.Lista'
      FieldName = 'DESCUENTOLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2PRECIOEXELISTA: TFloatField
      DisplayLabel = 'P.Exento Lista'
      FieldName = 'PRECIOEXELISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2PRECIOGRAVLISTA: TFloatField
      DisplayLabel = 'P.Gravado Lista'
      FieldName = 'PRECIOGRAVLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2PRECIOIVALISTA: TFloatField
      DisplayLabel = 'Iva Lista'
      FieldName = 'PRECIOIVALISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
    object CDSStock_2PRECIOLISTA: TFloatField
      DisplayLabel = 'P. de Lista'
      FieldName = 'PRECIOLISTA'
      ReadOnly = True
      DisplayFormat = ',0.00'
    end
  end
  object DSStock_2: TDataSource
    DataSet = CDSStock_2
    Left = 344
    Top = 512
  end
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    PreviewOptions.Caption = 'Politicas de Precio'
    ...
    object dxComponentPrinter1Link1: TcxPivotGridReportLink
      ...
      ReportDocument.CreationDate = 45891.434844444450000000
  ...
  object QStock: TFDQuery
    ...
    SQL.Strings = (
      ...
      'order by s.rubro_stk,s.subrubro_stk,s.codigo_stk')
    Left = 60
    Top = 240
  end
  object QPoliticaPrecios: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select d.id_cab,c.nombre,d.codigoarticulo, d.recargo, d.precio,d' +
        '.iva_tasa,d.descuento,d.fecha'
      'from LISTAPRECIOESPECIALART d'
      'left join listaprecioespecialcab c on c.id=d.id_cab'
      'left join stock st on st.codigo_stk=d.codigoarticulo'
      
        'where st.imprimir_lstprecios='#39'S'#39' and ((st.clase_articulo=1) or (' +
        'st.clase_articulo=3))'
      'order by d.id_cab')
    Left = 20
    Top = 440
  end
  object QStock_2: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
        ...
        'lp.costo_exento as CostoExentoLista,lp.costo_gravado as CostoGra' +
        'vLista,lp.costo_total as CostoTotLista,'
      'lp.recargo as RecargiLista, lp.descuento as DescuentoLista,'
        ...
        'lpc.nombre as NombreLIsta,s.reemplazo_stk as CodigoAlternativo f' +
        'rom stock s'
      'left join rubros r on r.codigo_rubro=s.rubro_stk'
      'left join subrubros sr on sr.codigo_subrubro=s.subrubro_stk'
      ...
      'left join listaprecioespecialcab lpc on lpc.id = lp.id_cab'
        ...
        'where ((s.clase_articulo=1) or ( s.clase_articulo=3)) and s.impr' +
        'imir_lstprecios='#39'S'#39
      'order by lpc.id,s.rubro_stk,s.subrubro_stk,s.codigo_stk')
    Left = 128
    Top = 537
  end
