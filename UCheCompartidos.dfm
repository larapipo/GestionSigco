inherited FormCheCompartidos: TFormCheCompartidos
  Left = 451
  Top = 121
  Caption = 'Ingresos de Cheques a Compartir'
  ClientHeight = 687
  ClientWidth = 873
      ...
      inline FrameMovValoresIngreso1: TFrameMovValoresIngreso
        ...
        inherited pcValores: TPageControl
          ...
          inherited tsChe3: TTabSheet
            ...
            inherited dbchE_check: TDBCheckBox
              OnClick = FrameMovValoresIngreso1dbchE_checkClick
            end
          end
        ...
        inherited CDSCajaMov: TClientDataSet
          BeforeInsert = FrameMovValoresIngreso1CDSCajaMovBeforeInsert
  ...
  inherited ToolBar1: TToolBar
    ...
    object spCorregirSaldo: TSpeedButton
      Left = 588
      Top = 0
      Width = 23
      Height = 29
      Action = CorregirSaldo
    end
  end
  ...
  inherited ActionList1: TActionList
    ...
    object CorregirSaldo: TAction
      Caption = '<>'
      Hint = 'Corregir Saldo'
      OnExecute = CorregirSaldoExecute
    end
  end
  ...
  object QCheComp: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select che.*,s.detalle as MuestraSucursal ,'
      '            cp.denominacion as MuestraComprobante,'
      '            cp.id_comprobante as Id_tipocomprobante'
      'from cheque_compartido che'
      '  left join sucursal s on s.codigo=che.sucursalventa'
      
        '  left join comprobantes cp on cp.clase_comprob=che.clasecpbte a' +
        'nd'
      '                         cp.letra=che.Letra and'
      '                         cp.sucursal=che.sucursalventa and'
      '                         cp.tipo_comprob=che.tipocpbte and'
      '                         cp.compra_venta='#39'V'#39
      'where che.id=:Id and che.tipocpbte=:Tipo')
    Left = 192
    Top = 392
    ParamData = <
      item
    ...
    object QCheCompID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QCheCompFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object QCheCompTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object QCheCompCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Size = 2
    end
    object QCheCompLETRA: TStringField
      FieldName = 'LETRA'
      Required = True
      Size = 1
    end
    object QCheCompSUC: TStringField
      FieldName = 'SUC'
      Required = True
      Size = 4
    end
    object QCheCompNUMERO: TStringField
      FieldName = 'NUMERO'
      Required = True
      Size = 8
    end
    object QCheCompCODIGO: TStringField
      FieldName = 'CODIGO'
      Required = True
      Size = 6
    end
    object QCheCompNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Size = 35
    end
    object QCheCompRAZONSOCIAL: TStringField
      FieldName = 'RAZONSOCIAL'
      Size = 35
    end
    object QCheCompSUCURSALVENTA: TIntegerField
      FieldName = 'SUCURSALVENTA'
      Required = True
    end
    object QCheCompIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object QCheCompSALDO: TFloatField
      FieldName = 'SALDO'
    end
    object QCheCompDETALLE: TStringField
      FieldName = 'DETALLE'
      Size = 100
    end
    object QCheCompNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Required = True
      Size = 13
    end
    object QCheCompMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object QCheCompMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object QCheCompID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
    end
    object QCheCompDISPONIBLE: TStringField
  ...
  object CDSCheComp: TClientDataSet
    ...
    OnNewRecord = CDSCheCompNewRecord
    Left = 400
    Top = 392
    ...
    object CDSCheCompSUC: TStringField
      FieldName = 'SUC'
      Required = True
      OnSetText = CDSCheCompSUCSetText
      Size = 4
    end
    object CDSCheCompNUMERO: TStringField
      FieldName = 'NUMERO'
      Required = True
      OnSetText = CDSCheCompNUMEROSetText
      Size = 8
    end
    object CDSCheCompCODIGO: TStringField
      FieldName = 'CODIGO'
      Required = True
      OnSetText = CDSCheCompCODIGOSetText
      Size = 6
    end
    ...
    object CDSCheCompSUCURSALVENTA: TIntegerField
      FieldName = 'SUCURSALVENTA'
      Required = True
      OnSetText = CDSCheCompSUCURSALVENTASetText
    end
    ...
    object CDSCheCompMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object CDSCheCompMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object CDSCheCompID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
      OnSetText = CDSCheCompID_TIPOCOMPROBANTESetText
    end
  ...
  object ibgIdChe: TIBGenerator
    DatabaseFD = DMMain_FD.fdcGestion
    GeneratorName = 'NEXT_ID_CHEQUE_COMPARTIDO'
  ...
  object QBuscaComprob: TFDQuery
    ...
    SQL.Strings = (
      'select * from comprobantes where '
      'sucursal=:suc and compra_venta='#39'V'#39' and'
      '(tipo_comprob='#39'CO'#39')')
    Left = 508
    Top = 71
    ParamData = <
      item
  ...
  object QVerificaMovChe: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select count(*)  from MOV_VALOR_COMPARTIDO m where m.ID_CHEQUE_C' +
        'OMPARTIDO=:id')
    Left = 560
    Top = 528
    ParamData = <
  ...
  object QMovChe: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where vc.id_cheque_compartido =:id')
    Left = 160
    Top = 640
    ParamData = <
      item
