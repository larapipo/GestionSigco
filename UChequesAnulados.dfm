inherited FormChequesAnulados: TFormChequesAnulados
    ...
    object pnValores: TPanel
      ...
      inline FrameMovValoresEgresos1: TFrameMovValoresEgresos
        ...
        inherited CDSCajaMov: TClientDataSet
          BeforeInsert = FrameMovValoresEgresos1CDSCajaMovBeforeInsert
  ...
  inherited QUltimoCodigo2: TFDQuery
    SQL.Strings = (
      'select max(ch.id)  from cheques_anuldos ch')
    Left = 192
    Top = 568
  end
  object QCheques: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select ch.*,s.detalle as MuestraSucursal,cp.denominacion as Mues' +
        'traComprobante,'
      'cp.id_comprobante as id_tipocomprobante  from cheques_anuldos ch'
      'left join sucursal s on s.codigo=ch.sucursal'
      'left join comprobantes cp on cp.sucursal=ch.sucursal and'
      '                             cp.tipo_comprob=ch.tipocpbte and'
      '                             cp.clase_comprob=ch.clasecpbte and'
      '                             cp.letra = ch.letra and'
    ...
    object QChequesID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QChequesFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
    end
    object QChequesTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Size = 2
    end
    object QChequesCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Size = 2
    end
    object QChequesLETRA: TStringField
      FieldName = 'LETRA'
      FixedChar = True
      Size = 1
    end
    object QChequesSUC: TStringField
      FieldName = 'SUC'
      FixedChar = True
      Size = 4
    end
    object QChequesNUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 8
    end
    object QChequesNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Size = 13
    end
    ...
    object QChequesSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
    end
    object QChequesMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object QChequesMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object QChequesID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
    end
    object QChequesUSUARIO: TStringField
      FieldName = 'USUARIO'
      Size = 50
    end
    object QChequesFECHA_HORA: TSQLTimeStampField
      FieldName = 'FECHA_HORA'
    end
    object QChequesDETALLE: TStringField
      FieldName = 'DETALLE'
      Size = 30
    end
    object QChequesID_CHEQUE: TIntegerField
      FieldName = 'ID_CHEQUE'
      Required = True
    end
  end
  object CDSCheques: TClientDataSet
    ...
    object CDSChequesFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
    end
    object CDSChequesTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Size = 2
    end
    object CDSChequesCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Size = 2
    end
    object CDSChequesLETRA: TStringField
      FieldName = 'LETRA'
      FixedChar = True
      Size = 1
    end
    object CDSChequesSUC: TStringField
      FieldName = 'SUC'
      OnSetText = CDSChequesSUCSetText
      FixedChar = True
      Size = 4
    end
    ...
    object CDSChequesNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Size = 13
    end
    ...
    object CDSChequesSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      OnSetText = CDSChequesSUCURSALSetText
    end
    object CDSChequesMUESTRASUCURSAL: TStringField
      FieldName = 'MUESTRASUCURSAL'
      ProviderFlags = []
      Size = 35
    end
    object CDSChequesMUESTRACOMPROBANTE: TStringField
      FieldName = 'MUESTRACOMPROBANTE'
      ProviderFlags = []
      Size = 15
    end
    object CDSChequesID_TIPOCOMPROBANTE: TIntegerField
      FieldName = 'ID_TIPOCOMPROBANTE'
      ProviderFlags = []
      OnSetText = CDSChequesID_TIPOCOMPROBANTESetText
    end
    object CDSChequesUSUARIO: TStringField
      FieldName = 'USUARIO'
      Size = 50
    end
    object CDSChequesFECHA_HORA: TSQLTimeStampField
      FieldName = 'FECHA_HORA'
    end
    object CDSChequesDETALLE: TStringField
      FieldName = 'DETALLE'
      Size = 30
    end
  ...
  object QBuscadorCheque: TFDQuery
    ...
    object QBuscadorChequeID_CHEQUE_PRO: TIntegerField
      FieldName = 'ID_CHEQUE_PRO'
      Required = True
    end
    object QBuscadorChequeID_CHEQUERA: TIntegerField
      FieldName = 'ID_CHEQUERA'
      Required = True
    end
    object QBuscadorChequeID_BANCO: TIntegerField
      FieldName = 'ID_BANCO'
      Required = True
    end
    object QBuscadorChequeFECHA_EMISION: TSQLTimeStampField
      FieldName = 'FECHA_EMISION'
    end
    object QBuscadorChequeFECHA_COBRO: TSQLTimeStampField
      FieldName = 'FECHA_COBRO'
    end
    object QBuscadorChequeORDEN_DE: TStringField
      FieldName = 'ORDEN_DE'
      Size = 30
    end
    object QBuscadorChequeDEBITADO: TStringField
      FieldName = 'DEBITADO'
      Required = True
      FixedChar = True
      Size = 1
    end
    object QBuscadorChequeNUMERO: TIntegerField
      FieldName = 'NUMERO'
    end
    object QBuscadorChequeIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object QBuscadorChequeUNIDADES: TFloatField
      FieldName = 'UNIDADES'
    end
    object QBuscadorChequeMUESTRABCO: TStringField
      FieldName = 'MUESTRABCO'
      Size = 25
    end
    object QBuscadorChequeID_CUENTA_BANCO: TIntegerField
  ...
  object frReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 43080.527034201390000000
    ReportOptions.LastChange = 43080.527034201390000000
  ...
  object frxDBCajaMov: TfrxDBDataset
    UserName = 'frxDBCajaMov'
  ...
  object frxDBAnulacion: TfrxDBDataset
    UserName = 'frxDBAnulacion'
    CloseDataSource = False
    DataSource = DSBase
    BCDToCurrency = False
    DataSetOptions = []
