inherited FormDepositosBancarios: TFormDepositosBancarios
  Left = 383
  Top = 97
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnCabecera: TPanel
      ...
      object Label6: TLabel
        ...
        Width = 63
        Height = 26
        Caption = 'Sucursal'#13#10'que Deposita'
      end
      object dbeMuestraCtaBco: TDBEdit
        Left = 176
        Top = 24
        Width = 169
        Height = 21
      ...
      object dbeMuestraNumeroCta: TDBEdit
        Left = 352
        Top = 24
        Width = 145
        Height = 21
      ...
      object RxDBCtaBco: TJvDBComboEdit
        Left = 112
        Top = 24
        Width = 57
        Height = 21
    ...
    object pnDetalle: TPanel
      ...
      inline FrameMovValoresEgresos1: TFrameMovValoresEgresos
        ...
        inherited CDSChe3: TClientDataSet
          OnNewRecord = FrameMovValoresEgresos1CDSChe3NewRecord
        end
  ...
  inherited ActionList1: TActionList
    ...
    object ModificaFecha: TAction
      Hint = 'Modificar Fecha ( solo administrador)'
      OnExecute = ModificaFechaExecute
    end
    object ForzarBorrado: TAction
      Caption = 'Forzar Borrado'
      OnExecute = ForzarBorradoExecute
    end
    object AplicarSuma: TAction
      Caption = 'Aplicar Suma'
      OnExecute = AplicarSumaExecute
    end
  end
  ...
  inherited QUltimoCodigo: TSQLQuery
    SQL.Strings = (
      'select max(numero) from  dep_banco_cab')
    Left = 32
    Top = 472
  end
  object DSPDepCab: TDataSetProvider
    DataSet = QDepCab
    Options = []
  ...
  object ibgId_cab: TIBGenerator
    ...
    GeneratorName = 'NEXT_ID_DEPOSITO_BCO_CAB'
  ...
  object frxReport: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.787459849540000000
    ReportOptions.LastChange = 39638.787459849540000000
  ...
  object frDBDepCabecera: TfrxDBDataset
    UserName = 'frDBDepCabecera'
  ...
  object QDepCab: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select dc.* , cta.nombre as MuestraCtaCaja,cta.Nro_cuenta as Mue' +
        'straNroCta from dep_banco_cab dc'
      'join cuenta_caja cta on cta.id_cuenta=dc.id_cta_caja'
      'where dc.id=:id')
    Left = 120
    Top = 456
    ParamData = <
    ...
    object QDepCabID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QDepCabID_CTA_CAJA: TIntegerField
      FieldName = 'ID_CTA_CAJA'
      Required = True
    end
    object QDepCabFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object QDepCabNUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 13
    end
    object QDepCabIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object QDepCabEFEC_CHEQ: TStringField
      FieldName = 'EFEC_CHEQ'
      Required = True
      FixedChar = True
      Size = 1
    end
    object QDepCabOBS: TStringField
      FieldName = 'OBS'
      Size = 50
    end
    object QDepCabMUESTRACTACAJA: TStringField
      FieldName = 'MUESTRACTACAJA'
      ProviderFlags = []
      Size = 25
    end
    object QDepCabMUESTRANROCTA: TStringField
      FieldName = 'MUESTRANROCTA'
      ProviderFlags = []
      Size = 15
    end
    object QDepCabSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Required = True
    end
  end
  object CDSDepCab: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPDepCab'
    OnNewRecord = CDSDepCabNewRecord
    Left = 256
    Top = 456
    object CDSDepCabID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSDepCabID_CTA_CAJA: TIntegerField
      FieldName = 'ID_CTA_CAJA'
      Required = True
      OnSetText = CDSDepCabID_CTA_CAJASetText
    end
    object CDSDepCabFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object CDSDepCabNUMERO: TStringField
      FieldName = 'NUMERO'
      OnSetText = CDSDepCabNUMEROSetText
      Size = 13
    end
    object CDSDepCabIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      DisplayFormat = ',0.00'
    end
    object CDSDepCabEFEC_CHEQ: TStringField
      FieldName = 'EFEC_CHEQ'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CDSDepCabOBS: TStringField
      FieldName = 'OBS'
      Size = 50
    end
    object CDSDepCabMUESTRACTACAJA: TStringField
      FieldName = 'MUESTRACTACAJA'
      ProviderFlags = []
      Size = 25
    end
    object CDSDepCabMUESTRANROCTA: TStringField
      FieldName = 'MUESTRANROCTA'
      ProviderFlags = []
      Size = 15
    end
    object CDSDepCabSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Required = True
    end
  end
  ...
  object spModificaFecha: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'MODIFICA_FECHA_DEPOSITO'
    Left = 616
    Top = 440
    ParamData = <
      item
  ...
  object PopupMenu1: TPopupMenu
    Left = 368
    Top = 320
    object ForzarBorrado1: TMenuItem
      Action = ForzarBorrado
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object AplicarSuma1: TMenuItem
      Action = AplicarSuma
    end
  end
