inherited FormControlOTrabajo: TFormControlOTrabajo
  Caption = 'Control Ordenes de Trabajo'
  ClientHeight = 611
  ClientWidth = 1022
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnCabecera: TPanel
      ...
      object Label1: TLabel
        ...
        Width = 300
        Height = 25
        Caption = 'Control de Ordenes de Trabajo'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -20
        Font.Name = 'MS Sans Serif'
    ...
    object dbgOrdenes: TJvDBGrid
      ...
      TitleButtons = True
      OnTitleBtnClick = dbgOrdenesTitleBtnClick
  ...
  inherited ActionList1: TActionList
    object ModificarFechaFinalizacion: TAction
      Caption = 'Modificar Fecha Finalizacion'
      OnExecute = ModificarFechaFinalizacionExecute
    end
    object LimpiarFecha: TAction
      Caption = 'Limpiar Fecha de Finalizacion'
      OnExecute = LimpiarFechaExecute
    end
  end
  ...
  object CDSOrdenes: TClientDataSet
    ...
    OnCalcFields = CDSOrdenesCalcFields
    Left = 288
    Top = 160
    object CDSOrdenesNROCPBTE: TStringField
    ...
    object CDSOrdenesFECHAINICIO: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHAINICIO'
      Origin = 'FECHAINICIO'
      Required = True
    end
    object CDSOrdenesCODIGO: TStringField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      Size = 6
    end
    object CDSOrdenesNOMBRE: TStringField
      DisplayLabel = 'Nombre'
      FieldName = 'NOMBRE'
      Origin = 'NOMBRE'
      Size = 35
    end
    object CDSOrdenesFACTURANRO: TStringField
    ...
    object CDSOrdenesDESCRIPCION: TStringField
    ...
    object CDSOrdenesNRO_TARJETA_C: TStringField
      DisplayLabel = 'Nro.Tarjeta'
      FieldName = 'NRO_TARJETA_C'
      Origin = 'NRO_TARJETA_C'
      ProviderFlags = []
      EditMask = '0000-0000-0000-0000;0'
    end
    object CDSOrdenesDETALLE: TStringField
      DisplayLabel = 'Abono'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      ProviderFlags = []
    ...
    object CDSOrdenesESTADO: TIntegerField
      DisplayLabel = 'Estado'
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
      Required = True
    end
    object CDSOrdenesFECHAFINAL: TSQLTimeStampField
      DisplayLabel = 'F.Finalizacion'
      FieldName = 'FECHAFINAL'
      Origin = 'FECHAFINAL'
    end
    object CDSOrdenesMOTIVO: TStringField
      DisplayLabel = 'Motivo'
      FieldName = 'MOTIVO'
      Origin = 'DETALLE'
      ProviderFlags = []
    ...
    object CDSOrdenesLOCALIDAD: TStringField
    ...
    object CDSOrdenesMUESTRAESTADO: TStringField
      DisplayLabel = 'Estado'
    ...
    object CDSOrdenesMORA: TIntegerField
      DisplayLabel = 'Mora'
      FieldKind = fkCalculated
      FieldName = 'MORA'
      Calculated = True
    end
    object CDSOrdenesID_OT: TIntegerField
      FieldName = 'ID_OT'
      Origin = 'ID_OT'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSOrdenesTOTAL: TFloatField
      DisplayLabel = 'Valor'
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
  ...
  object PopupMenu1: TPopupMenu
    Left = 448
    Top = 160
    object ModificarFechaFinalizacion1: TMenuItem
      Action = ModificarFechaFinalizacion
    end
    object LimpiarFecha1: TMenuItem
      Action = LimpiarFecha
    end
  end
  object QOredenes: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select ot.id_ot, ot.nrocpbte,ot.fechainicio,ot.fechafinal, ot.co' +
        'digo,ot.nombre,ot.facturanro,'
      'tc.descripcion , c.nro_tarjeta_c,'
      
        'cg.detalle,ot.estado,mo.detalle as Motivo,c.localidad,ot.total f' +
        'rom ordentrabajocab ot'
      'left join clientes c on c.codigo=ot.codigo'
      'left join t_credito tc on tc.id_tc=c.id_tarjetacredito'
      'left join cupon_abonos_grilla ca on ca.cliente=ot.codigo'
      'left join cupon_abonos_grupos cg on cg.id=ca.id_cupon_grupo'
      'left join ordentrabajo_motivo mo on mo.id=ot.motivo_otrabajo'
      
        'where (ot.clasecpbte= :tipo ) and ( ot.fechainicio between :desd' +
        'e and :hasta )')
    Left = 144
    Top = 112
    ParamData = <
  ...
  object QComprobante: TFDQuery
    ...
    SQL.Strings = (
      ...
      '       sucursal,letra from comprobantes '
      'where tipo_comprob in ('#39'OT'#39') and compra_venta='#39'V'#39
      'order by'
      'sucursal,tipo_comprob,clase_comprob ,letra')
    Left = 456
    Top = 376
  end
  object QCambioFecha: TFDQuery
    SQL.Strings = (
      
        'update ordentrabajocab ot set ot.fechafinal = :fecha where ot.id' +
        '_ot = :id')
    Left = 152
    Top = 208
    ParamData = <
