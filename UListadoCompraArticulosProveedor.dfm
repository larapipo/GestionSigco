inherited FormLisCompraArt_Proveedor: TFormLisCompraArt_Proveedor
  Left = 238
  Top = 75
  Caption = 'Compras de Articulos por Prorveedor'
  ClientHeight = 687
  ClientWidth = 1138
  ExplicitWidth = 1156
  ExplicitHeight = 728
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnCabecera: TPanel
      ...
      object JvLabel2: TJvLabel
        ...
        Width = 273
        Height = 16
        Caption = 'Detalle de Articulos Comprados al Proveedor'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
      ...
      object JvLabel3: TJvLabel
        ...
        Width = 243
        Height = 16
        Caption = 'Detalle de Comprobantes que Interviene'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
    ...
    object pnArticulosComprados: TPanel
      Left = 0
      Top = 73
      Width = 383
      Height = 561
      ...
      object pnPie: TPanel
        ...
        object chConMov: TCheckBox
          Left = 7
          Top = 39
          Width = 170
          Height = 17
          Caption = 'Ver solo Con Movimientos'
          TabOrder = 2
          OnClick = cds1Click
        end
      end
    ...
    object pnDetalles: TPanel
      ...
      Align = alClient
      TabOrder = 2
      OnMouseMove = pnDetallesMouseMove
      object PageControl1: TPageControl
        ...
        object TabSheet2: TTabSheet
          ...
          object cxDBPivotGrid1: TcxDBPivotGrid
            ...
            OptionsView.ColumnGrandTotalText = 'Agrupacion'
  ...
  object CDSArticulos: TClientDataSet
    ...
    object CDSArticulosCOUNT: TIntegerField
      FieldName = 'COUNT'
      Origin = '"COUNT"'
      ProviderFlags = []
      Required = True
  ...
  object CDSMov: TClientDataSet
    ...
    Left = 696
    Top = 344
    object CDSMovCODIGOARTICULO: TStringField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGOARTICULO'
      Origin = 'CODIGOARTICULO'
      Required = True
    ...
    object CDSMovUNITARIO_EXENTO: TFloatField
      DisplayLabel = 'U.Exento'
      FieldName = 'UNITARIO_EXENTO'
      Origin = 'UNITARIO_EXENTO'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
    object CDSMovUNITARIO_GRAVADO: TFloatField
      DisplayLabel = 'U.Gravado'
      FieldName = 'UNITARIO_GRAVADO'
      Origin = 'UNITARIO_GRAVADO'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
    object CDSMovUNITARIO_TOTAL: TFloatField
      DisplayLabel = 'Uni.Total Neto'
      FieldName = 'UNITARIO_TOTAL'
      Origin = 'UNITARIO_TOTAL'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
    object CDSMovID_CABFAC: TIntegerField
      FieldName = 'ID_CABFAC'
      Origin = 'ID_CABFAC'
      Required = True
    end
    ...
    object CDSMovFECHACOMPRA: TSQLTimeStampField
  ...
  object frxReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 40785.572274409720000000
    ReportOptions.LastChange = 40785.572274409720000000
  ...
  object frDBMov: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      'CODIGOARTICULO=CODIGOARTICULO'
      'DETALLE=DETALLE'
      'UNITARIO_EXENTO=UNITARIO_EXENTO'
      'UNITARIO_GRAVADO=UNITARIO_GRAVADO'
      'UNITARIO_TOTAL=UNITARIO_TOTAL'
      'CANTIDAD=CANTIDAD'
  ...
  object QProveedor: TFDQuery
    ...
    object QProveedorN_DE_CUENTA: TStringField
      FieldName = 'N_DE_CUENTA'
      Origin = 'N_DE_CUENTA'
      Size = 14
    end
    object QProveedorID_COD_POSTAL: TIntegerField
    ...
    object QProveedorTELEFONO_2: TStringField
      FieldName = 'TELEFONO_2'
      Origin = 'TELEFONO_2'
      Size = 10
    end
    object QProveedorCONDICION_IVA: TIntegerField
      FieldName = 'CONDICION_IVA'
      Origin = 'CONDICION_IVA'
      Required = True
    end
    object QProveedorN_DE_CUIT: TStringField
      FieldName = 'N_DE_CUIT'
      Origin = 'N_DE_CUIT'
      Size = 13
    end
    object QProveedorACTIVO: TStringField
      FieldName = 'ACTIVO'
      Origin = 'ACTIVO'
      Size = 1
    end
  ...
  object QMov: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select d.codigoarticulo,d.detalle,d.cantidad,d.unitario_exento,d' +
        '.unitario_gravado,d.unitario_total,'
      
        '       d.fechacompra,d.id_cabfac,d.tipocpbte,d.clasecpbte,d.nroc' +
        'pbte'
      
        'from fccompdet d where ( d.codigoproveedor = :codigo ) and ( d.c' +
        'odigoarticulo = :CodArticulo ) and'
      
        '( d.fechacompra between :desde and :hasta ) and (d.tipocpbte='#39'FC' +
        #39' or d.tipocpbte='#39'FO'#39')'
      'order by d.fechacompra')
    Left = 579
    Top = 385
    ParamData = <
      item
  ...
  object QArticulos: TFDQuery
    ...
    SQL.Strings = (
      'select d.codigoarticulo,d.detalle, count(fd.id) from fccompdet d'
      
        'left join fccompdet fd on fd.codigoarticulo = d.codigoarticulo a' +
        'nd'
      '                    fd.codigoproveedor      =:codigo '
      
        'where d.codigoproveedor = :codigo and d.codigoarticulo<>'#39'0000000' +
        '0'#39' and fd.fechacompra between :desde and :hasta'
  ...
  object QMovGr: TFDQuery
    ...
    SQL.Strings = (
      'select d.codigoarticulo,d.detalle,d.detalle,'
      
        '       Sum(d.cantidad) as Cantidad, (sum(d.unitario_exento)/SUm(' +
        'd.cantidad)) as Unitario_Exento, '
      
        '       Sum(d.unitario_gravado)/Sum(d.cantidad) as Unitario_Grava' +
        'do,'
      '       Sum(d.unitario_total)/SUm(d.cantidad) as Unitario_Total,'
      
        '       d.fechacompra,extract(month from d.fechacompra) as Mes,ex' +
        'tract(year from d.fechacompra) as Anio'
      
        'from fccompdet d where ( d.codigoproveedor = :codigo ) and ( d.c' +
        'odigoarticulo = :CodArticulo ) and'
      
        '     ( d.fechacompra between :desde and :hasta ) and (d.tipocpbt' +
        'e='#39'FC'#39' or d.tipocpbte='#39'FO'#39')'
      'group by d.codigoarticulo,d.detalle, d.fechacompra'
      'order by d.fechacompra')
    Left = 595
    Top = 217
    ParamData = <
  ...
  object DSMovGr: TDataSource
    DataSet = CDSMovGr
    Left = 795
    Top = 225
  end
  object CDSMovGr: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'DSPMovGr'
    OnCalcFields = CDSMovGrCalcFields
    Left = 715
    Top = 217
    object CDSMovGrCODIGOARTICULO: TStringField
      DisplayLabel = 'Codigo'
      FieldName = 'CODIGOARTICULO'
      Required = True
      Size = 8
    end
    object CDSMovGrDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Size = 45
    end
    object CDSMovGrDETALLE_1: TStringField
      FieldName = 'DETALLE_1'
      Size = 45
    end
    object CDSMovGrCANTIDAD: TFloatField
      DisplayLabel = 'Cant.'
      FieldName = 'CANTIDAD'
      ReadOnly = True
    end
    object CDSMovGrUNITARIO_EXENTO: TFloatField
      FieldName = 'UNITARIO_EXENTO'
      ReadOnly = True
    end
    object CDSMovGrUNITARIO_GRAVADO: TFloatField
      FieldName = 'UNITARIO_GRAVADO'
      ReadOnly = True
    end
    object CDSMovGrUNITARIO_TOTAL: TFloatField
      DisplayLabel = 'Unit.'
      FieldName = 'UNITARIO_TOTAL'
      ReadOnly = True
    end
    object CDSMovGrFECHACOMPRA: TDateField
      FieldName = 'FECHACOMPRA'
      Required = True
    end
    object CDSMovGrMES: TSmallintField
      DisplayLabel = 'Mes'
      FieldName = 'MES'
      ReadOnly = True
      OnGetText = CDSMovGrMESGetText
    end
    object CDSMovGrANIO: TSmallintField
      DisplayLabel = 'A'#241'o'
      FieldName = 'ANIO'
      ReadOnly = True
    end
    object CDSMovGrMesNombre: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'MesNombre'
    end
  end
  object DSPMovGr: TDataSetProvider
    DataSet = QMovGr
    Options = []
    Left = 659
    Top = 217
