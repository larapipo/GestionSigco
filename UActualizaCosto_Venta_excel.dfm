inherited FormActualizaCostoVta_excel: TFormActualizaCostoVta_excel
  Left = 344
  Top = 118
  Caption = 'Actuliza Costo/Vta desde Excel'
  ClientHeight = 587
  ClientWidth = 672
  ...
  inherited pnPrincipal: TPanel
    ...
    object chActualizaPrecioVta: TCheckBox
      Left = 190
      Top = 476
      Width = 120
      Height = 17
      Anchors = [akLeft, akBottom]
      Caption = 'Actualiza Precio Vta'
      TabOrder = 2
    end
    ...
    object edFecha: TDateTimePicker
      ...
      Height = 21
      Anchors = [akLeft, akBottom]
      Date = 40785.000000000000000000
      Time = 0.424566122688702300
      TabOrder = 4
    end
    object chExcel2013: TCheckBox
      Left = 519
      Top = 15
      Width = 97
      Height = 17
    ...
    object pnAviso: TPanel
      ...
      object Label1: TLabel
        ...
        Height = 91
        Caption = 
          'Establecer este formato para la planilla de Stock'#13#10'en Excel, res' +
          'petando los nombre de las '#13#10'columnas. Las Columnas Celestes no s' +
          'on obligatorias.'#13#10'En nombre de la hoja dejar que diga Hoja1, '#13#10'e' +
          'l que deja por defecto el Excel'#13#10'Los Importes son sin IVA.'#13#10'Si e' +
          'l Codigo no corresoponde no dejarlo vacio, ponerle un * '
      end
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            Title.Caption = 'preciovta'
            Visible = True
          end
          item
            Color = clAqua
            Expanded = False
            Title.Caption = 'codigo_alternativo'
            Width = 106
            Visible = True
          end
          item
    ...
    object stStockXLS: TAdvStringGrid
      Left = 218
      Top = 263
      Width = 337
      Height = 130
    ...
    object chUsaCodigoALternativo: TCheckBox
      Left = 485
      Top = 489
      Width = 196
      Height = 15
      Anchors = [akLeft, akBottom]
      Caption = 'Usar Cod.Alternativo Para Buscar'
      TabOrder = 8
      WordWrap = True
      OnClick = chUsaCodigoALternativoClick
    end
    object chBuscaPorEAN: TCheckBox
      Left = 485
      Top = 504
      Width = 164
      Height = 23
      Anchors = [akLeft, akBottom]
      Caption = 'Buscar por Cod.EAN'
      TabOrder = 9
      WordWrap = True
      OnClick = chBuscaPorEANClick
    end
  end
  ...
  object FDStoredProcPrueba: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'ACTULIZA_PRECIO_COSTOVTA'
    Left = 471
    Top = 323
  ...
  object QBuscaCodigoBarra: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select min(cb.codigo_stk) from codigobarra cb where cb.codigobar' +
        'ra=:codigoean')
    Left = 111
    Top = 411
    ParamData = <
    ...
    object QBuscaCodigoBarraMIN: TStringField
