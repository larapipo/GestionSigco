inherited FormResumenBco: TFormResumenBco
  Left = 284
  Top = 93
  HorzScrollBar.Smooth = True
  HorzScrollBar.Style = ssFlat
  HorzScrollBar.Tracking = True
  Caption = 'Resumen de Cta.Cte de Banco'
  ClientHeight = 726
  ClientWidth = 1044
  ...
  inherited pnPrincipal: TPanel
    ...
    object pcDetalles: TPageControl
      ...
      object TabSheet3: TTabSheet
        ...
        object pnTotales: TPanel
          ...
          object edDebe: TJvCalcEdit
            ...
            OnKeyPress = SaldoInicialKeyPress
          end
          ...
          object edConciliado: TJvCalcEdit
            Left = 792
            Top = 8
            Width = 97
            Height = 21
        ...
        object cxGridResumen: TcxGrid
          ...
          object cxGridResumenDBTableView1: TcxGridDBTableView
            PopupMenu = PopupMenu
            OnCellDblClick = cxGridResumenDBTableView1CellDblClick
            DataController.DataSource = DSBase
            DataController.Options = [dcoAssignGroupingValues, dcoAssignMasterDetailKeys, dcoSaveExpanding, dcoImmediatePost]
            OptionsData.Deleting = False
            OptionsData.Inserting = False
            OptionsView.GroupByBox = False
            object cxGridResumenDBTableView1FECHA_INGR: TcxGridDBColumn
              DataBinding.FieldName = 'FECHA_INGR'
              HeaderAlignmentHorz = taCenter
              Options.Editing = False
              Options.Focusing = False
              Width = 75
            end
            object cxGridResumenDBTableView1FECHA_COBRO: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1TIPO_ORIGEN: TcxGridDBColumn
              DataBinding.FieldName = 'TIPO_ORIGEN'
              HeaderAlignmentHorz = taCenter
              Options.Editing = False
              Options.Focusing = False
              Width = 30
            end
            object cxGridResumenDBTableView1NUMERO_BOLETA: TcxGridDBColumn
              DataBinding.FieldName = 'NUMERO_BOLETA'
              HeaderAlignmentHorz = taCenter
              Options.Editing = False
              Options.Focusing = False
              Width = 87
            end
            object cxGridResumenDBTableView1NUMERO_CHEQUE: TcxGridDBColumn
              DataBinding.FieldName = 'NUMERO_CHEQUE'
              HeaderAlignmentHorz = taCenter
              Options.Editing = False
              Options.Focusing = False
            end
            object cxGridResumenDBTableView1DETALLE: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1DEBE: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1HABER: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1SALDO: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1SALDOCALCULADO: TcxGridDBColumn
            ...
            object cxGridResumenDBTableView1PENDIENTE_COBRO: TcxGridDBColumn
              DataBinding.FieldName = 'PENDIENTE_COBRO'
              HeaderAlignmentHorz = taCenter
              Options.Editing = False
              Options.Focusing = False
              Width = 90
            end
            object cxGridResumenDBTableView1CONCILIADO: TcxGridDBColumn
          ...
          object cxGridResumenLevel1: TcxGridLevel
            GridView = cxGridResumenDBTableView1
          end
        end
      end
      object TabSheet1: TTabSheet
        Caption = 'Movimientos Sin Concilar'
        object dbgMovSinConcilar: TJvDBGrid
          Left = 0
          Top = 0
          Width = 1036
          Height = 409
      ...
      object TabSheet2: TTabSheet
        Caption = 'Comoposici'#243'n saldo Anterior'
        ImageIndex = 1
        object dbgAnterior: TJvDBGrid
          Left = 0
          Top = 0
          Width = 1036
          Height = 409
          Align = alTop
          DataSource = DSSaldoAnteriorMov
          DrawingStyle = gdsGradient
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          ...
          OnTitleBtnClick = dbgAnteriorTitleBtnClick
      ...
      object TabSheet4: TTabSheet
        ...
        object Label3: TLabel
          ...
          Width = 110
          Height = 13
          Caption = 'Archivo CSV a Importar'
        end
        object edPath: TEdit
          Left = 432
          Top = 512
        ...
        object sgResumen: TAdvStringGrid
          ...
          TabOrder = 2
          OnGetFormat = sgResumenGetFormat
          ...
          FilterDropDown.Width = 450
          FilterDropDownClear = '(Todos)'
          FilterDropDownCheck = True
          FilterDropDownCheckUnCheckAll = 'Select Todos'
    ...
    object pnCabecera: TPanel
      ...
      object spRecalcula: TSpeedButton
        Left = 895
        Top = 71
        Width = 23
        Height = 22
      ...
      object Label2: TLabel
        ...
        Width = 102
        Height = 26
        Caption = 'Saldo Por dife.'#13#10'entre e Debe y Haber'
      end
      ...
      object chbModificaInical: TCheckBox
        Left = 482
        Top = 70
        Width = 127
        Height = 17
        Caption = 'Modifica Saldo Inicial'
        TabOrder = 3
        OnClick = chbModificaInicalClick
      end
      object dbcTipos: TJvDBLookupCombo
        ...
        DisplayEmpty = '***'
        EmptyValue = '***'
        LookupField = 'TIPO_ORIGEN'
        LookupDisplay = 'TIPO_ORIGEN'
        LookupSource = DSResumenTipo
        TabOrder = 4
        OnClick = dbcTiposClick
      end
      object ceCtaBco: TJvComboEdit
        ...
        TabOrder = 5
        Text = ''
        OnButtonClick = BuscadorCtaExecute
      ...
      object SaldoInicial: TJvCalcEdit
        Left = 792
        Top = 71
        Width = 97
        Height = 21
      ...
      object rgTipoMov: TRadioGroup
        ...
        Caption = 'Condici'#243'n Busqueda de Movimientos'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object edFechaDebito: TJvDateEdit
        Left = 271
        Top = 66
        Width = 97
        Height = 21
      ...
      object chRecalcular: TCheckBox
        Left = 924
        Top = 1
        Width = 69
        Height = 43
        Caption = 'Recalcular al modificar'
        Checked = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  inherited ActionList1: TActionList
    ...
    object BuscadorCta: TAction
      Caption = 'BuscadorCta'
      OnExecute = BuscadorCtaExecute
    end
    object Recalcular: TAction
      Hint = 'Re Calcular saldos'
  ...
  object DSPResumenBco: TDataSetProvider
    DataSet = QResumenBco
  ...
  object frResumen: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.787711400470000000
    ReportOptions.LastChange = 39638.787711400470000000
  ...
  object frDSResumen: TfrxDBDataset
    UserName = 'frDSResumen'
    ...
    FieldDefs = <
      ...
      item
        FieldName = 'NUMERO_BOLETA'
        FieldAlias = 'NUMERO_BOLETA'
      end
      item
        FieldName = 'NUMERO_CHEQUE'
        FieldAlias = 'NUMERO_CHEQUE'
      end
      item
        FieldName = 'ID_CTA_BCO'
        FieldAlias = 'ID_CTA_BCO'
      end
      item
        FieldName = 'FECHA_INGR'
        FieldAlias = 'FECHA_INGR'
      end
      item
        FieldName = 'FECHA_COBRO'
  ...
  object DSMovSinConciliar: TDataSource
    DataSet = CDSMovSinConciliar
    Left = 304
    Top = 600
  end
  ...
  object DSResumenTipo: TDataSource
    DataSet = QTipos
    OnStateChange = DSBaseStateChange
    Left = 124
    Top = 413
  end
  object CDSResumenBco: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPResumenBco'
    Left = 216
    Top = 288
    object CDSResumenBcoID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSResumenBcoTIPO_ORIGEN: TStringField
      DisplayLabel = 'Tp'
      FieldName = 'TIPO_ORIGEN'
      Origin = 'TIPO_ORIGEN'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    ...
    object CDSResumenBcoID_ORIGEN: TIntegerField
      FieldName = 'ID_ORIGEN'
      Origin = 'ID_ORIGEN'
    end
    object CDSResumenBcoNUMERO_BOLETA: TStringField
      DisplayLabel = 'Nro.Boleta'
      FieldName = 'NUMERO_BOLETA'
      Origin = 'NUMERO_BOLETA'
      Size = 13
    end
    object CDSResumenBcoNUMERO_CHEQUE: TIntegerField
      DisplayLabel = 'Nro.Chq'
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'NUMERO_CHEQUE'
    end
    object CDSResumenBcoID_CTA_BCO: TIntegerField
      FieldName = 'ID_CTA_BCO'
      Origin = 'ID_CTA_BCO'
      Required = True
    end
    object CDSResumenBcoDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 50
    end
    object CDSResumenBcoSALDOCALCULADO: TFloatField
    ...
    object CDSResumenBcoCONCILIADO: TStringField
      DisplayLabel = 'V/B'
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      OnSetText = CDSResumenBcoCONCILIADOSetText
      FixedChar = True
      Size = 1
    end
    object CDSResumenBcoANULADO: TStringField
      FieldName = 'ANULADO'
      Origin = 'ANULADO'
      Required = True
      FixedChar = True
    ...
    object CDSResumenBcoDEBE: TFloatField
      DisplayLabel = 'Debe'
      FieldName = 'DEBE'
      Origin = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSResumenBcoHABER: TFloatField
      DisplayLabel = 'Haber'
      FieldName = 'HABER'
      Origin = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSResumenBcoSALDO: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      Origin = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSResumenBcoPENDIENTE_COBRO: TFloatField
      DisplayLabel = 'A Ingresar'
      FieldName = 'PENDIENTE_COBRO'
      Origin = 'PENDIENTE_COBRO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSResumenBcoFECHA_INGR: TSQLTimeStampField
      DisplayLabel = 'F.Ingreso'
      FieldName = 'FECHA_INGR'
      Origin = 'FECHA_INGR'
    end
    object CDSResumenBcoFECHA_COBRO: TSQLTimeStampField
  ...
  object CDSMovSinConciliar: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPMovSinConciliar'
    Left = 224
    Top = 568
    object CDSMovSinConciliarID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSMovSinConciliarTIPO_ORIGEN: TStringField
      FieldName = 'TIPO_ORIGEN'
      Origin = 'TIPO_ORIGEN'
      Required = True
      Size = 3
    end
    object CDSMovSinConciliarID_ORIGEN: TIntegerField
      FieldName = 'ID_ORIGEN'
      Origin = 'ID_ORIGEN'
    end
    object CDSMovSinConciliarNUMERO_BOLETA: TStringField
      FieldName = 'NUMERO_BOLETA'
      Origin = 'NUMERO_BOLETA'
      Size = 13
    end
    object CDSMovSinConciliarNUMERO_CHEQUE: TIntegerField
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'NUMERO_CHEQUE'
    end
    object CDSMovSinConciliarID_CTA_BCO: TIntegerField
      FieldName = 'ID_CTA_BCO'
      Origin = 'ID_CTA_BCO'
      Required = True
    end
    object CDSMovSinConciliarDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 50
    end
    object CDSMovSinConciliarCONCILIADO: TStringField
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      FixedChar = True
    ...
    object CDSMovSinConciliarANULADO: TStringField
      FieldName = 'ANULADO'
      Origin = 'ANULADO'
      Required = True
      FixedChar = True
    ...
    object CDSMovSinConciliarDEBE: TFloatField
      FieldName = 'DEBE'
      Origin = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovSinConciliarHABER: TFloatField
      FieldName = 'HABER'
      Origin = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovSinConciliarSALDO: TFloatField
      FieldName = 'SALDO'
      Origin = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovSinConciliarPENDIENTE_COBRO: TFloatField
      FieldName = 'PENDIENTE_COBRO'
      Origin = 'PENDIENTE_COBRO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovSinConciliarFECHA_INGR: TSQLTimeStampField
      FieldName = 'FECHA_INGR'
      Origin = 'FECHA_INGR'
    end
    object CDSMovSinConciliarFECHA_COBRO: TSQLTimeStampField
      FieldName = 'FECHA_COBRO'
      Origin = 'FECHA_COBRO'
    end
  end
  object DSPMovSinConciliar: TDataSetProvider
    DataSet = QMovSinConc
    Left = 120
    Top = 584
  end
  object CDSSaldoAnteriorMov: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPSaldoAnteriroMov'
    Left = 360
    Top = 368
    object CDSSaldoAnteriorMovID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSSaldoAnteriorMovTIPO_ORIGEN: TStringField
      FieldName = 'TIPO_ORIGEN'
      Origin = 'TIPO_ORIGEN'
      Required = True
      Size = 3
    end
    object CDSSaldoAnteriorMovID_ORIGEN: TIntegerField
      FieldName = 'ID_ORIGEN'
      Origin = 'ID_ORIGEN'
    end
    object CDSSaldoAnteriorMovNUMERO_BOLETA: TStringField
      DisplayLabel = 'Nro.Cpbte'
      FieldName = 'NUMERO_BOLETA'
      Origin = 'NUMERO_BOLETA'
      Size = 13
    end
    object CDSSaldoAnteriorMovNUMERO_CHEQUE: TIntegerField
      DisplayLabel = 'Nro.Che'
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'NUMERO_CHEQUE'
    end
    object CDSSaldoAnteriorMovID_CTA_BCO: TIntegerField
      FieldName = 'ID_CTA_BCO'
      Origin = 'ID_CTA_BCO'
      Required = True
    end
    object CDSSaldoAnteriorMovDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 50
    end
    object CDSSaldoAnteriorMovCONCILIADO: TStringField
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      FixedChar = True
    ...
    object CDSSaldoAnteriorMovANULADO: TStringField
      FieldName = 'ANULADO'
      Origin = 'ANULADO'
      Required = True
      FixedChar = True
    ...
    object CDSSaldoAnteriorMovSALDOCALCULADO: TFMTBCDField
      DisplayLabel = 'Saldo'
      FieldKind = fkInternalCalc
      FieldName = 'SALDOCALCULADO'
      DisplayFormat = ',0.00'
    ...
    object CDSSaldoAnteriorMovDEBE: TFloatField
      DisplayLabel = 'Debe'
      FieldName = 'DEBE'
      Origin = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSSaldoAnteriorMovHABER: TFloatField
      DisplayLabel = 'Haber'
      FieldName = 'HABER'
      Origin = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSSaldoAnteriorMovSALDO: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      Origin = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSSaldoAnteriorMovPENDIENTE_COBRO: TFloatField
      FieldName = 'PENDIENTE_COBRO'
      Origin = 'PENDIENTE_COBRO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSSaldoAnteriorMovFECHA_INGR: TSQLTimeStampField
      DisplayLabel = 'F.Ingreso'
      FieldName = 'FECHA_INGR'
      Origin = 'FECHA_INGR'
    end
    object CDSSaldoAnteriorMovFECHA_COBRO: TSQLTimeStampField
      DisplayLabel = 'F.Cobro'
      FieldName = 'FECHA_COBRO'
      Origin = 'FECHA_COBRO'
    end
  end
  object DSPSaldoAnteriroMov: TDataSetProvider
    DataSet = QSaldoAnteriorMov
    Options = [poAllowCommandText]
    Left = 456
    Top = 360
  end
  object DSSaldoAnteriorMov: TDataSource
    DataSet = CDSSaldoAnteriorMov
    Left = 648
    Top = 368
  end
  object ComBuscadorCta: TComBuscador
    Data = CDSBuscadorCta
    Campo = 'ID_CUENTA'
    Titulo = 'Ctas Bancarias'
    rOk = False
    Left = 112
    Top = 128
  end
  object QBusCta: TFDQuery
  ...
  object QResumenBco: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from resumen_bco_det'
      
        'where id_cta_bco=:id and fecha_Ingr>= :Desde and fecha_Ingr<= :h' +
        'asta and conciliado<>:conciliado'
    ...
    object QResumenBcoID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QResumenBcoTIPO_ORIGEN: TStringField
      FieldName = 'TIPO_ORIGEN'
      Origin = 'TIPO_ORIGEN'
      Required = True
      Size = 3
    end
    object QResumenBcoID_ORIGEN: TIntegerField
      FieldName = 'ID_ORIGEN'
      Origin = 'ID_ORIGEN'
    end
    object QResumenBcoNUMERO_BOLETA: TStringField
      FieldName = 'NUMERO_BOLETA'
      Origin = 'NUMERO_BOLETA'
      Size = 13
    end
    object QResumenBcoNUMERO_CHEQUE: TIntegerField
      FieldName = 'NUMERO_CHEQUE'
      Origin = 'NUMERO_CHEQUE'
    end
    object QResumenBcoID_CTA_BCO: TIntegerField
      FieldName = 'ID_CTA_BCO'
      Origin = 'ID_CTA_BCO'
      Required = True
    end
    object QResumenBcoDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 50
    end
    object QResumenBcoDEBE: TFloatField
      FieldName = 'DEBE'
      Origin = 'DEBE'
    end
    object QResumenBcoHABER: TFloatField
      FieldName = 'HABER'
      Origin = 'HABER'
    end
    object QResumenBcoSALDO: TFloatField
      FieldName = 'SALDO'
      Origin = 'SALDO'
    end
    object QResumenBcoPENDIENTE_COBRO: TFloatField
      FieldName = 'PENDIENTE_COBRO'
      Origin = 'PENDIENTE_COBRO'
    end
    object QResumenBcoCONCILIADO: TStringField
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      FixedChar = True
    ...
    object QResumenBcoANULADO: TStringField
      FieldName = 'ANULADO'
      Origin = 'ANULADO'
      Required = True
      FixedChar = True
    ...
    object QResumenBcoFECHA_INGR: TSQLTimeStampField
      FieldName = 'FECHA_INGR'
      Origin = 'FECHA_INGR'
    end
    object QResumenBcoFECHA_COBRO: TSQLTimeStampField
      FieldName = 'FECHA_COBRO'
      Origin = 'FECHA_COBRO'
    end
  end
  object QSaldoAnteriorMov: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select  b.*  from resumen_bco_det b'
      'where ((b.id_cta_bco = :id ) and (b.fecha_ingr < :Desde))'
      'and ( b.anulado='#39'N'#39' or b.anulado='#39'R'#39' )'
      'order by b.fecha_ingr')
    Left = 548
    Top = 365
    ParamData = <
      item
  ...
  object QTipos: TFDQuery
    ...
    object QTiposTIPO_ORIGEN: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'TIPO_ORIGEN'
      Origin = 'TIPO_ORIGEN'
      ProviderFlags = []
  ...
  object QSaldoAnterior: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select ( Sum ( b.debe ) - Sum ( b.haber )) as Saldo  from resume' +
        'n_bco_det b'
      'where ((b.id_cta_bco = :id ) and (b.fecha_ingr < :Desde))'
      'and ( b.anulado='#39'N'#39' or b.anulado='#39'R'#39' ) and b.conciliado='#39'S'#39)
    Left = 308
    Top = 429
    ParamData = <
      item
    ...
    object QSaldoAnteriorSALDO: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'SALDO'
      Origin = 'SALDO'
      ProviderFlags = []
  ...
  object QMovSinConc: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from resumen_bco_det'
      'where id_cta_bco=:id and conciliado<>'#39'S'#39
      'order by fecha_Ingr,id')
    Left = 52
    Top = 589
    ParamData = <
