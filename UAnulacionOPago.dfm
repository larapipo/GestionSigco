inherited FormAnulacionOPago: TFormAnulacionOPago
  Left = 376
  Top = 86
  Caption = 'Formulario de Anulaci'#243'n Orden de Pago'
  ClientHeight = 669
  ClientWidth = 740
    ...
    object pcDetalle: TPageControl
      ...
      object tsVlores: TTabSheet
        ...
        inline FrameMovValoresIngreso1: TFrameMovValoresIngreso
          ...
          inherited IBGId_Efectivo: TIBGenerator
            Left = 472
            Top = 184
          end
      ...
      object tsRetencionesGanacia: TTabSheet
        Caption = 'Retenciones de Ganancia'
        ImageIndex = 1
        object btBuscarRetGan: TBitBtn
          Left = 424
          Top = 128
          Width = 75
          Height = 25
        ...
        object btCancelarRetGan: TBitBtn
          Left = 344
          Top = 128
          Width = 75
          Height = 25
          Action = CancelarRetGan
          Cancel = True
          Caption = 'C&ancela'
          Glyph.Data = {
        ...
        object btOkRetGan: TBitBtn
          Left = 264
          Top = 128
          Width = 75
          Height = 25
          Action = ConfirmaRetGan
          Caption = 'OK'
          Default = True
          Glyph.Data = {
            DE010000424DDE01000000000000760000002800000024000000120000000100
        ...
        object pnRetGanancia: TPanel
          ...
          object Label5: TLabel
            ...
            Width = 65
            Height = 13
            Caption = 'Min.Imponible'
            FocusControl = dbeMinImpoRetG
          end
          object Label6: TLabel
            ...
            Width = 74
            Height = 13
            Caption = 'Impus.Retenido'
            FocusControl = dbeImpRetG
          end
          object Label7: TLabel
            ...
            Width = 84
            Height = 13
            Caption = 'Nro de Retencion'
            FocusControl = dbeNroRetG
          end
          object dbeConceptoRetG: TDBEdit
            Left = 136
            Top = 24
            Width = 157
            Height = 21
            DataField = 'CONCEPTO'
            DataSource = DatosAnulacionOPago.DSAnulacionRetGanancia
            TabOrder = 0
          end
          object dbeTasaRetG: TDBEdit
            Left = 136
            Top = 72
            Width = 64
            Height = 21
          ...
          object dbeFechaRetG: TJvDBDateEdit
            Left = 8
            Top = 24
            Width = 121
            Height = 21
      ...
      object tsRetencionesIIBB: TTabSheet
        Caption = 'Ret. de Ingresos Brutos'
        ImageIndex = 2
        object pnRetIngBru: TPanel
          Left = 8
          Top = 0
          Width = 433
          Height = 113
          ...
          object Label11: TLabel
            ...
            Width = 69
            Height = 13
            Caption = 'Nro.Retenci'#243'n'
            FocusControl = dbeNroRet
          end
          ...
          object dbeImpRet: TDBEdit
            Left = 296
            Top = 68
            Width = 112
            Height = 24
            DataField = 'TOTAL'
            DataSource = DatosAnulacionOPago.DSAnulacionRetIB
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -13
            Font.Name = 'MS Sans Serif'
          ...
          object dbeNroRet: TDBEdit
            Left = 8
            Top = 72
            Width = 193
            Height = 24
            DataField = 'NROCPBTE_RET'
            DataSource = DatosAnulacionOPago.DSAnulacionRetIB
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlue
            Font.Height = -13
  ...
  inherited ActionList1: TActionList
    ...
    object BuscarRetGan: TAction
      Caption = 'Buscar'
      OnExecute = BuscarRetGanExecute
    end
    object ConfirmaRetGan: TAction
      Caption = '&Confirma'
      OnExecute = ConfirmaRetGanExecute
    end
    object CancelarRetGan: TAction
      Caption = 'C&ancela'
      OnExecute = CancelarRetGanExecute
    end
    object BuscarRetIIBB: TAction
      Caption = '&Buscar'
      OnExecute = BuscarRetIIBBExecute
    end
    object ConfirmaRetIIBB: TAction
      Caption = 'ConfirmaRetIIBB'
      OnExecute = ConfirmaRetIIBBExecute
    end
    object CancelaRetIIBB: TAction
      Caption = 'C&ancela'
      OnExecute = CancelaRetIIBBExecute
    end
  end
  inherited DSBase: TDataSource
    DataSet = DatosAnulacionOPago.CDSAnulacionOPago
    Left = 400
    Top = 104
  end
  ...
  object frAnulacionOPago: TfrxReport
    Version = '2022.2.3'
    ...
    ReportOptions.CreateDate = 39638.743457569440000000
    ReportOptions.LastChange = 39638.743457569440000000
  ...
  object frDBDSAnulacion: TfrxDBDataset
    UserName = 'frDBDSAnulacion'
    ...
    FieldAliases.Strings = (
      ...
      'SUCURSAL=SUCURSAL'
      'USUARIO=USUARIO'
      'MUESTRASUCURSAL=MUESTRASUCURSAL'
      'MUESTRACOMPROBANTE=MUESTRACOMPROBANTE'
  ...
  object frDBDSMovCaja: TfrxDBDataset
    UserName = 'frDBDSMovCaja'
    CloseDataSource = False
    FieldAliases.Strings = (
      ...
      'ID_CUENTA_CAJA=ID_CUENTA_CAJA'
      'MONEDA=MONEDA'
      'ID_FPAGOOLD=ID_FPAGOOLD'
      'MUESTRAFORMAPAGO=MUESTRAFORMAPAGO'
      'MUESTRAIDCTACAJA=MUESTRAIDCTACAJA'
      'MUESTRACAJA=MUESTRACAJA'
      'MUESTRANROCAJA=MUESTRANROCAJA')
