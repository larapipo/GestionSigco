inherited FormRemitoObra: TFormRemitoObra
  Left = 351
  Top = 133
  Caption = 'Remito de Obra'
  ClientHeight = 598
  ClientWidth = 732
  ...
  inherited pnPrincipal: TPanel
    ...
    ExplicitWidth = 732
    ExplicitHeight = 545
    object pcDetalleRto: TPageControl
      Left = 0
      Top = 105
      Width = 732
      Height = 440
      ...
      object PagDetalles: TTabSheet
        ...
        object DBText1: TDBText
          ...
          DataSource = DatosRemitosObra.DSRetDet
          ExplicitTop = 253
        end
        ...
        object dbgExitencias: TDBGrid
          ...
          Anchors = [akLeft, akBottom]
          Color = clWhite
          DataSource = DatosRemitosObra.DSExistencia
  ...
  object gbLista: TGroupBox [3]
    ...
    object dbcLista: TDBLookupComboBox
      ...
      KeyField = 'ID'
      ListField = 'ID;nombre'
      ListSource = DatosRemitosObra.DSListaPrecios
      ParentFont = False
      TabOrder = 0
  ...
  inherited DSBase: TDataSource
    DataSet = DatosRemitosObra.CDSRtoCab
  end
  ...
  object ComBuscadorSucursal: TComBuscador
    Data = DatosRemitosObra.CDSBuscaSucursal
    Campo = 'CODIGO'
    Titulo = 'Sucursal'
    rOk = False
    Left = 148
  ...
  object ComBuscadorDeposito: TComBuscador
    Data = DatosRemitosObra.CDSBuscaDeposito
    Campo = 'ID'
    Titulo = 'Depositos'
    rOk = False
    Left = 204
