inherited FormImportacionCompraGral: TFormImportacionCompraGral
  Left = 84
  Top = 83
  Caption = 'Importacion de Comprobantes de Compra General'
  ClientHeight = 617
  ClientWidth = 1138
  ...
  inherited pnPrincipal: TPanel
    ...
    object dbgClientesXLS: TDBAdvGrid
      Left = 7
      Top = 48
      Width = 879
      Height = 267
      ...
      object pnAviso_: TPanel
        ...
        object Label5: TLabel
          ...
          Caption = 
            ...
            '  FO= Fc.Ctdo'#13#10'       NC= N.Cred.'#13#10'       ND= N.Deb'
        end
  ...
  object DSCtroCosto: TDataSource
    DataSet = CDSCtroCosto
    Left = 592
    Top = 544
  end
  object QAplicCCosto: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'insert into aplica_ctro_costo (id,id_cpbte,tipocpbte,ctro_costo,'
      '                               imputado,total,porcentaje,tipo)'
      
        '  values (gen_id(next_id_ctro_costo,1),:id_cpbte,:tipo,:ctrocost' +
        'o,'
      '          :imputado,:imputado,100,'#39'E'#39')'
      '')
    Left = 640
    Top = 544
    ParamData = <
  ...
  object QComproba: TFDQuery
    ...
    SQL.Strings = (
      ...
      'where tipo_comprob in ('#39'FC'#39','#39'NC'#39','#39'ND'#39','#39'FO'#39') and'
  ...
  object QBuscaProveeCuit: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select Max(p.codigo) as Codigo from poveedor p where p.n_de_cuit' +
        ' = :cuit')
    Left = 128
    Top = 544
    ParamData = <
    ...
    object QBuscaProveeCuitCODIGO: TStringField
      FieldName = 'CODIGO'
      Size = 6
    end
  end
  ...
  object spPercecpciones: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'PROVEEDOR_PERCEP'
    Left = 768
    Top = 552
    ParamData = <
      item
  ...
  object spAltaCompra: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    ...
    StoredProcName = 'GENERAR_FCCOMPRA_GENERICO'
    Left = 528
    Top = 480
    ParamData = <
      item
