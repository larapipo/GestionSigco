inherited FormDespachoImpo: TFormDespachoImpo
  Left = 329
  Top = 110
  Caption = 'Despacho de Importacion'
  ClientHeight = 588
  ClientWidth = 948
  ...
  inherited pnPrincipal: TPanel
    ...
    object pcdetalle: TPageControl
      ...
      Width = 948
      Height = 244
      ActivePage = PagConceptos
      Align = alTop
      TabOrder = 1
      object PagConceptos: TTabSheet
        Caption = 'Conceptos'
      ...
      object PagRetenciones: TTabSheet
        Caption = 'Retenciones'
        ImageIndex = 1
        ...
        object ceTotalRetenciones: TDBEdit
          Left = 555
          Top = 129
          Width = 97
          Height = 21
      ...
      object pagABMConceptos: TTabSheet
    ...
    object pnCabecera: TPanel
      ...
      object JvLabel7: TJvLabel
        ...
        Width = 124
        Height = 13
        Caption = 'Valor en Aduana en Dolar'
        ShadowSize = 1
        ShadowPos = spLeftTop
        Transparent = True
      end
      ...
      object ceMonedaFOB: TJvDBLookupCombo
        Left = 110
        Top = 72
        Width = 91
        Height = 21
        DataField = 'FOB_DIVISA'
        DataSource = DSBase
        LookupField = 'ID'
      ...
      object ceMonedaSeg: TJvDBLookupCombo
        Left = 323
        Top = 72
        Width = 91
        Height = 21
        DataField = 'SEGURO_DIVISA'
        DataSource = DSBase
        LookupField = 'ID'
        LookupDisplay = 'MONEDA'
        LookupSource = DSMoneda
      ...
      object ceMonedaFlete: TJvDBLookupCombo
        Left = 110
        Top = 115
        Width = 91
        Height = 21
        DataField = 'FLETE_DIVISA'
        DataSource = DSBase
        LookupField = 'ID'
        LookupDisplay = 'MONEDA'
        LookupSource = DSMoneda
      ...
      object edBaseIva: TDBEdit
        Left = 809
        Top = 139
        Width = 121
        Height = 21
        DataField = 'BASEIVA_GANC'
        DataSource = DSBase
        TabOrder = 12
      end
      ...
      object edValorAduana: TDBEdit
        Left = 658
        Top = 139
        Width = 121
        Height = 21
        DataField = 'VALOR_ADUANA_DOLAR'
        DataSource = DSBase
        TabOrder = 11
      end
  ...
  inherited ActionList1: TActionList
    Left = 608
    Top = 240
    object BuscaConcepto: TAction
      Caption = 'BuscaConcepto'
      ShortCut = 16397
      OnExecute = BuscaConceptoExecute
    end
  end
  ...
  object CDSDespacho: TClientDataSet
    ...
    OnNewRecord = CDSDespachoNewRecord
    Left = 608
    Top = 96
  ...
  object CDSDetalle: TClientDataSet
    ...
    AfterDelete = CDSDetalleAfterDelete
    ...
    object CDSDetalleIMPORTE: TFloatField
      ...
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      OnChange = CDSDetalleIMPORTEChange
      OnSetText = CDSDetalleIMPORTESetText
      DisplayFormat = ',0.00'
    end
    object CDSDetalleTASA: TFloatField
      ...
      FieldName = 'TASA'
      Origin = 'TASA'
      OnSetText = CDSDetalleTASASetText
      DisplayFormat = ',0.00'
    end
    object CDSDetalleIMPORTE_PESOS: TFloatField
      DisplayLabel = 'Impo.en Pesos'
      FieldName = 'IMPORTE_PESOS'
  ...
  object ibgCab: TIBGenerator
    ...
    GeneratorName = 'NEXT_ID_DESPACHO_IMPO'
  ...
  object ibgDet: TIBGenerator
    DatabaseFD = DMMain_FD.fdcGestion
    GeneratorName = 'NEXT_ID_DESP_IMPO_DET'
    SystemGenerators = False
    Left = 652
    Top = 161
  end
  object QConceptos: TFDQuery
    ...
    SQL.Strings = (
      'select c.* from DESPACHO_IMPO_CONCEP c where c.id = :id')
    Left = 236
    Top = 105
    ParamData = <
      item
    ...
    object QConceptosDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 45
    end
  ...
  object QDespacho: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select d.* from despacho_impo d where d.id= :id')
    Left = 376
    Top = 96
    ParamData = <
      item
    ...
    object QDespachoID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QDespachoNRO: TStringField
      FieldName = 'NRO'
      Origin = 'NRO'
      Size = 45
    end
    object QDespachoCOTIZACION: TFloatField
      FieldName = 'COTIZACION'
      Origin = 'COTIZACION'
    end
    object QDespachoFOB: TFloatField
      FieldName = 'FOB'
      Origin = 'FOB'
    end
    object QDespachoFOB_DIVISA: TIntegerField
      FieldName = 'FOB_DIVISA'
      Origin = 'FOB_DIVISA'
    end
    object QDespachoFLETE: TFloatField
      FieldName = 'FLETE'
      Origin = 'FLETE'
    end
    object QDespachoFLETE_DIVISA: TIntegerField
      FieldName = 'FLETE_DIVISA'
      Origin = 'FLETE_DIVISA'
    end
    object QDespachoSEGURO: TFloatField
      FieldName = 'SEGURO'
      Origin = 'SEGURO'
    end
    object QDespachoSEGURO_DIVISA: TIntegerField
      FieldName = 'SEGURO_DIVISA'
      Origin = 'SEGURO_DIVISA'
    end
    object QDespachoBASEIVA_GANC: TFloatField
      FieldName = 'BASEIVA_GANC'
      Origin = 'BASEIVA_GANC'
    end
    object QDespachoVALOR_ADUANA_DOLAR: TFloatField
      FieldName = 'VALOR_ADUANA_DOLAR'
      Origin = 'VALOR_ADUANA_DOLAR'
    end
    object QDespachoTOTAL: TFloatField
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
    end
    object QDespachoTOTAL_PESOS: TFloatField
      FieldName = 'TOTAL_PESOS'
      Origin = 'TOTAL_PESOS'
    end
    object QDespachoVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      Origin = 'VENDEDOR'
      Size = 60
    end
    object QDespachoFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object QDespachoFECHA_FISCAL: TSQLTimeStampField
      FieldName = 'FECHA_FISCAL'
      Origin = 'FECHA_FISCAL'
    end
  end
  object QDetalle: TFDQuery
    ...
    object QDetalleCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
    end
    ...
    object QDetalleBASE_IMPONIBLE: TFloatField
      FieldName = 'BASE_IMPONIBLE'
      Origin = 'BASE_IMPONIBLE'
    end
    object QDetalleTASA: TFloatField
      FieldName = 'TASA'
      Origin = 'TASA'
    end
    ...
    object QDetalleIMPORTE_PESOS: TFloatField
      FieldName = 'IMPORTE_PESOS'
      Origin = 'IMPORTE_PESOS'
    end
    object QDetalleMUESTRADETALLE: TStringField
  ...
  object QABMConceptos: TFDQuery
    AfterPost = QABMConceptosAfterPost
    AfterDelete = QABMConceptosAfterDelete
    CachedUpdates = True
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select c.* from DESPACHO_IMPO_CONCEP c ')
    Left = 340
    Top = 265
  ...
  object DSABMConceptos: TDataSource
    DataSet = QABMConceptos
    Left = 324
    Top = 201
  end
  ...
  object QBuscadorConceptos: TFDQuery
    ...
    Left = 284
    Top = 329
    object QBuscadorConceptosDETALLE: TStringField
      DisplayLabel = 'Detalle'
      DisplayWidth = 50
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    ...
    object QBuscadorConceptosID: TIntegerField
      DisplayLabel = 'Cod.'
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
