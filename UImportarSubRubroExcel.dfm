inherited FormImportarSubRubroExcel: TFormImportarSubRubroExcel
  Left = 315
  Top = 112
  Caption = 'Importar SubRubro desde Excel'
  ClientHeight = 622
  ClientWidth = 567
  ...
  inherited pnPrincipal: TPanel
    ...
    object chArmarCodigo: TCheckBox
      Left = 364
      Top = 524
      Width = 97
      Height = 32
      Anchors = [akLeft, akBottom]
      Caption = 'Armar Codigo'
      TabOrder = 4
    end
    object dbgrdStock: TDBAdvGrid
      Left = 7
      Top = 37
      Width = 553
      Height = 476
    ...
    object pnAviso: TPanel
      ...
      object lbl1: TLabel
        ...
        Caption = 
          ...
          'los nombre de las '#13#10'columnas.'#13#10'En nombre de la hoja dejar que di' +
          'ga Hoja1, '#13#10'el codigo no es obligatorio'
      end
  ...
  object stgSubRubros: TAdvStringGrid [3]
    Left = 40
    Top = 110
    Width = 57
    Height = 93
  ...
  inherited QUltimoCodigo: TSQLQuery
    object QUltimoCodigoMAX: TStringField
      FieldName = 'MAX'
      Size = 5
    end
  end
  ...
  object DSSubRubrosXLS: TDataSource
    DataSet = mtSubRubroXLS
    Left = 264
    Top = 304
  end
  ...
  object QBuscadorSubRubro: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
    ...
    object QBuscadorSubRubroFUERA_PROMO: TStringField
  ...
  object mtSubRubroXLS: TFDMemTable
