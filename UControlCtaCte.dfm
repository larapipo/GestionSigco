inherited FormControlCC: TFormControlCC
  Left = 246
  Top = 93
  Caption = 'Control de Cta.Cte'
  ClientHeight = 698
  ClientWidth = 864
  KeyPreview = False
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object dbgMovVta: TJvDBGrid
          ...
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnDrawDataCell = dbgMovVtaDrawDataCell
        ...
        object dbgAplicacionesVta: TDBGrid
          Left = 2
          Top = 421
          Width = 562
          Height = 148
      ...
      object TabSheet2: TTabSheet
        ...
        object dbgAplicacionesCompra: TDBGrid
          Left = 0
          Top = 441
          Width = 541
          Height = 129
        ...
        object dbgMovComp: TDBGrid
          Left = 3
          Top = 195
          Width = 833
          Height = 221
          Anchors = [akLeft, akTop, akBottom]
          DataSource = DSMovComp
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnDrawDataCell = dbgMovCompDrawDataCell
          Columns = <
            item
              Expanded = False
              FieldName = 'TIPOCPBTE'
  ...
  object CDSMovimientos: TClientDataSet
    ...
    object CDSMovimientosFECHAVTA: TSQLTimeStampField
      DisplayLabel = 'Fecha Vta.'
      DisplayWidth = 16
      FieldName = 'FECHAVTA'
    end
    object CDSMovimientosFECHAVTO: TSQLTimeStampField
  ...
  object CDSAplicaciones: TClientDataSet
    ...
    AfterDelete = CDSAplicacionesAfterDelete
    Left = 549
    Top = 593
  ...
  object CDSProvee: TClientDataSet
    ...
    object CDSProveeN_DE_CUENTA: TStringField
  ...
  object CDSFcComp: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'DSPFcComp'
    ReadOnly = True
    Left = 541
    Top = 529
    object CDSFcCompID_FC: TIntegerField
      FieldName = 'ID_FC'
      Origin = 'ID_FC'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSFcCompTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object CDSFcCompCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Required = True
      Size = 2
    end
    object CDSFcCompNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Origin = 'NROCPBTE'
      Size = 13
    end
    object CDSFcCompCODIGO: TStringField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
      Required = True
      Size = 6
    end
    object CDSFcCompLETRAFAC: TStringField
      FieldName = 'LETRAFAC'
      Origin = 'LETRAFAC'
      FixedChar = True
      Size = 1
    end
    object CDSFcCompSUCFAC: TStringField
      FieldName = 'SUCFAC'
      Origin = 'SUCFAC'
      Size = 4
    end
    object CDSFcCompNUMEROFAC: TStringField
      FieldName = 'NUMEROFAC'
      Origin = 'NUMEROFAC'
      Size = 8
    end
    object CDSFcCompNOMBRE: TStringField
      FieldName = 'NOMBRE'
      Origin = 'NOMBRE'
      Size = 35
    end
    object CDSFcCompRAZONSOCIAL: TStringField
      FieldName = 'RAZONSOCIAL'
      Origin = 'RAZONSOCIAL'
      Size = 35
    end
    object CDSFcCompDIRECCION: TStringField
      FieldName = 'DIRECCION'
      Origin = 'DIRECCION'
      Size = 35
    end
    object CDSFcCompCPOSTAL: TStringField
      FieldName = 'CPOSTAL'
      Origin = 'CPOSTAL'
      Size = 8
    end
    object CDSFcCompLOCALIDAD: TStringField
      FieldName = 'LOCALIDAD'
      Origin = 'LOCALIDAD'
      Size = 15
    end
    object CDSFcCompTIPOIVA: TIntegerField
      FieldName = 'TIPOIVA'
      Origin = 'TIPOIVA'
    end
    object CDSFcCompCUIT: TStringField
      FieldName = 'CUIT'
      Origin = 'CUIT'
      Size = 13
    end
    object CDSFcCompFECHACOMPRA: TSQLTimeStampField
      FieldName = 'FECHACOMPRA'
      Origin = 'FECHACOMPRA'
      Required = True
    end
    object CDSFcCompFECHAVTO: TSQLTimeStampField
      FieldName = 'FECHAVTO'
      Origin = 'FECHAVTO'
    end
    object CDSFcCompCONDICIONCOMPRA: TIntegerField
      FieldName = 'CONDICIONCOMPRA'
      Origin = 'CONDICIONCOMPRA'
      Required = True
    end
    object CDSFcCompANULADO: TStringField
      FieldName = 'ANULADO'
      Origin = 'ANULADO'
      Required = True
      FixedChar = True
    ...
    object CDSFcCompORDENCOMPRA: TStringField
      FieldName = 'ORDENCOMPRA'
      Origin = 'ORDENCOMPRA'
      Size = 8
    end
    object CDSFcCompAPLICA: TStringField
      FieldName = 'APLICA'
      Origin = 'APLICA'
      Size = 13
    end
    object CDSFcCompOBSERVACION1: TStringField
      FieldName = 'OBSERVACION1'
      Origin = 'OBSERVACION1'
      Size = 60
    end
    object CDSFcCompOBSERVACION2: TStringField
      FieldName = 'OBSERVACION2'
      Origin = 'OBSERVACION2'
      Size = 60
    end
    object CDSFcCompSUCURSALCOMPRA: TIntegerField
      FieldName = 'SUCURSALCOMPRA'
      Origin = 'SUCURSALCOMPRA'
      Required = True
    end
    object CDSFcCompZONA: TIntegerField
      FieldName = 'ZONA'
      Origin = 'ZONA'
    end
    object CDSFcCompDEPOSITO: TIntegerField
      FieldName = 'DEPOSITO'
      Origin = 'DEPOSITO'
      Required = True
    end
    object CDSFcCompDESGLOZAIVA: TStringField
    ...
    object CDSFcCompCALCULA_SOBRETASA: TStringField
    ...
    object CDSFcCompFECHAFISCAL: TSQLTimeStampField
      FieldName = 'FECHAFISCAL'
      Origin = 'FECHAFISCAL'
      Required = True
    end
    object CDSFcCompCPBTE_INTERNO: TStringField
    ...
    object CDSFcCompINGRESA_A_CTACTE: TStringField
    ...
    object CDSFcCompINGRESA_LIBRO_IVA: TStringField
    ...
    object CDSFcCompREDUCIDA: TStringField
      FieldName = 'REDUCIDA'
      Origin = 'REDUCIDA'
      FixedChar = True
      Size = 1
    end
    object CDSFcCompTIPO_PROVEEDOR: TStringField
      FieldName = 'TIPO_PROVEEDOR'
      Origin = 'TIPO_PROVEEDOR'
      FixedChar = True
      Size = 1
    end
    object CDSFcCompJURIDICCION: TIntegerField
      FieldName = 'JURIDICCION'
      Origin = 'JURIDICCION'
    end
    object CDSFcCompFECHA_HORA: TSQLTimeStampField
      FieldName = 'FECHA_HORA'
      Origin = 'FECHA_HORA'
    end
    object CDSFcCompUSUARIO: TStringField
      FieldName = 'USUARIO'
      Origin = 'USUARIO'
      Size = 50
    end
    object CDSFcCompTOTAL: TFloatField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      DisplayFormat = ',0.00'
    end
    object CDSFcCompDEBE: TFloatField
      DisplayLabel = 'Debe'
      FieldName = 'DEBE'
      Origin = 'DEBE'
    end
  end
  object CDSMovComp: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'ID_CPBTE'
    MasterFields = 'ID_FC'
    MasterSource = DSFcComp
    PacketRecords = 0
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPMovComp'
    Left = 541
    Top = 473
    object CDSMovCompID_MOVCCCOMPRA: TIntegerField
      FieldName = 'ID_MOVCCCOMPRA'
      Required = True
    end
    object CDSMovCompID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Required = True
    end
    object CDSMovCompPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Size = 6
    end
    object CDSMovCompFECHACOMPRA: TSQLTimeStampField
      DisplayLabel = 'Fecha Comp'
      FieldName = 'FECHACOMPRA'
    end
    object CDSMovCompFECHAVTO: TSQLTimeStampField
      DisplayLabel = 'Fecha Vto.'
      FieldName = 'FECHAVTO'
    end
    object CDSMovCompTIPOCPBTE: TStringField
      DisplayLabel = 'Tp'
      FieldName = 'TIPOCPBTE'
      Size = 2
    end
    object CDSMovCompCLASECPBTE: TStringField
      DisplayLabel = 'Cl'
      FieldName = 'CLASECPBTE'
      Size = 2
    end
    object CDSMovCompNROCPBTE: TStringField
      DisplayLabel = 'Nro.Cpbte'
      FieldName = 'NROCPBTE'
      Size = 13
    end
    object CDSMovCompDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
    end
    object CDSMovCompDEBE: TFloatField
      DisplayLabel = 'Debe'
      FieldName = 'DEBE'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovCompHABER: TFloatField
      DisplayLabel = 'Haber'
      FieldName = 'HABER'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSMovCompSALDO: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      DisplayFormat = ',0.00;-,0.00;-'
    end
  end
  object CDSAplCompra: TClientDataSet
    Aggregates = <>
    IndexFieldNames = 'ID_MOVCCCOMPRA'
    MasterFields = 'ID_MOVCCCOMPRA'
    MasterSource = DSMovComp
    PacketRecords = 0
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPAplCompra'
    AfterDelete = CDSAplCompraAfterDelete
    Left = 541
    Top = 417
    object CDSAplCompraID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSAplCompraID_MOVCCCOMPRA: TIntegerField
      FieldName = 'ID_MOVCCCOMPRA'
      Origin = 'ID_MOVCCCOMPRA'
      Required = True
    end
    object CDSAplCompraFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object CDSAplCompraPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Origin = 'PROVEEDOR'
      Required = True
      Size = 6
    end
    object CDSAplCompraID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object CDSAplCompraTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object CDSAplCompraCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object CDSAplCompraNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object CDSAplCompraAPLICA_ID_CPBTE: TIntegerField
      FieldName = 'APLICA_ID_CPBTE'
      Origin = 'APLICA_ID_CPBTE'
      Required = True
    end
    object CDSAplCompraAPLICA_TIPOCPBTE: TStringField
      FieldName = 'APLICA_TIPOCPBTE'
      Origin = 'APLICA_TIPOCPBTE'
      Size = 2
    end
    object CDSAplCompraAPLICA_CLASECPBTE: TStringField
      FieldName = 'APLICA_CLASECPBTE'
      Origin = 'APLICA_CLASECPBTE'
      Size = 2
    end
    object CDSAplCompraAPLICA_NROCPBTE: TStringField
      FieldName = 'APLICA_NROCPBTE'
      Origin = 'APLICA_NROCPBTE'
      Size = 13
    end
    object CDSAplCompraDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object CDSAplCompraCONCILIADO: TStringField
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      FixedChar = True
    ...
    object CDSAplCompraIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
    end
    object CDSAplCompraAPLICA_NETO: TFloatField
      DisplayLabel = 'Apl.Neto'
      FieldName = 'APLICA_NETO'
      Origin = 'APLICA_NETO'
      DisplayFormat = ',0.00'
    end
  end
  object DSPFcComp: TDataSetProvider
    DataSet = QFcComp
    Options = []
    Left = 477
    Top = 521
  end
  object DSPMovComp: TDataSetProvider
    DataSet = QMovComp
    Options = []
    Left = 477
    Top = 473
  end
  object DSPAplCompra: TDataSetProvider
    DataSet = QAplCompra
    Options = []
    Left = 485
    Top = 417
  ...
  object DSMovComp: TDataSource
    DataSet = CDSMovComp
    Left = 629
    Top = 473
  end
  object DSAplCompra: TDataSource
    DataSet = CDSAplCompra
    Left = 613
    Top = 417
  end
  object CDSACtaVta: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'DSPACtaVta'
    Left = 200
    Top = 584
    object CDSACtaVtaID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSACtaVtaFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object CDSACtaVtaCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Origin = 'CLIENTE'
      Required = True
      Size = 6
    end
    object CDSACtaVtaID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object CDSACtaVtaTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object CDSACtaVtaCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object CDSACtaVtaNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object CDSACtaVtaDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object CDSACtaVtaIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      DisplayFormat = ',0.00'
  ...
  object DSPACtaVta: TDataSetProvider
    DataSet = QACtaVta
    Options = []
  ...
  object DSACtaVta: TDataSource
    DataSet = CDSACtaVta
    Left = 272
    Top = 584
  end
  object CDSACtaComp: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'DSPACtaComp'
    Left = 200
    Top = 528
    object CDSACtaCompID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSACtaCompFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object CDSACtaCompPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Origin = 'PROVEEDOR'
      Required = True
      Size = 6
    end
    object CDSACtaCompID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object CDSACtaCompTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object CDSACtaCompCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object CDSACtaCompNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object CDSACtaCompDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object CDSACtaCompIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      DisplayFormat = ',0.00'
  ...
  object DSPACtaComp: TDataSetProvider
    DataSet = QACtaComp
    Options = []
    UpdateMode = upWhereKeyOnly
    Left = 120
  ...
  object spReAsignaSaldos: TSQLStoredProc
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
  ...
  object QMovimientos: TFDQuery
    ...
    object QMovimientosFECHAVTA: TSQLTimeStampField
      FieldName = 'FECHAVTA'
      Origin = 'FECHAVTA'
    end
    object QMovimientosFECHAVTO: TSQLTimeStampField
      FieldName = 'FECHAVTO'
      Origin = 'FECHAVTO'
    end
    ...
    object QMovimientosNRO_CUOTA: TIntegerField
      FieldName = 'NRO_CUOTA'
      Origin = 'NRO_CUOTA'
      Required = True
    end
    object QMovimientosID_MONEDA: TIntegerField
      FieldName = 'ID_MONEDA'
      Origin = 'ID_MONEDA'
    end
    object QMovimientosCOTIZACION: TFloatField
  ...
  object QFacturas: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from fcvtacab where codigo=:codigo and anulado<>'#39'S'#39)
    Left = 36
    Top = 464
    ParamData = <
      item
  ...
  object QACtaComp: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from movactacccompra where '
      'proveedor=:codigo')
    Left = 36
    Top = 536
    ParamData = <
    ...
    object QACtaCompID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QACtaCompFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object QACtaCompPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Origin = 'PROVEEDOR'
      Required = True
      Size = 6
    end
    object QACtaCompID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object QACtaCompTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object QACtaCompCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object QACtaCompNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object QACtaCompIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
    end
    object QACtaCompDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
  end
  object QACtaVta: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from movactaccvta where '
      'cliente=:codigo')
    Left = 40
    Top = 585
    ParamData = <
    ...
    object QACtaVtaID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QACtaVtaFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object QACtaVtaCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Origin = 'CLIENTE'
      Required = True
      Size = 6
    end
    object QACtaVtaID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object QACtaVtaTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object QACtaVtaCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object QACtaVtaNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object QACtaVtaIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
    end
    object QACtaVtaDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
  end
  object QAplCompra: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
    ...
    object QAplCompraID_MOV: TIntegerField
      FieldName = 'ID_MOV'
      Origin = 'ID_MOV'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QAplCompraID_MOVCCCOMPRA: TIntegerField
      FieldName = 'ID_MOVCCCOMPRA'
      Origin = 'ID_MOVCCCOMPRA'
      Required = True
    end
    object QAplCompraFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Origin = 'FECHA'
    end
    object QAplCompraPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Origin = 'PROVEEDOR'
      Required = True
      Size = 6
    end
    object QAplCompraID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object QAplCompraTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Required = True
      Size = 2
    end
    object QAplCompraCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object QAplCompraNUMEROCPBTE: TStringField
      FieldName = 'NUMEROCPBTE'
      Origin = 'NUMEROCPBTE'
      Required = True
      Size = 13
    end
    object QAplCompraIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
    end
    object QAplCompraAPLICA_ID_CPBTE: TIntegerField
      FieldName = 'APLICA_ID_CPBTE'
      Origin = 'APLICA_ID_CPBTE'
      Required = True
    end
    object QAplCompraAPLICA_TIPOCPBTE: TStringField
      FieldName = 'APLICA_TIPOCPBTE'
      Origin = 'APLICA_TIPOCPBTE'
      Size = 2
    end
    object QAplCompraAPLICA_CLASECPBTE: TStringField
      FieldName = 'APLICA_CLASECPBTE'
      Origin = 'APLICA_CLASECPBTE'
      Size = 2
    end
    object QAplCompraAPLICA_NROCPBTE: TStringField
      FieldName = 'APLICA_NROCPBTE'
      Origin = 'APLICA_NROCPBTE'
      Size = 13
    end
    object QAplCompraDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object QAplCompraAPLICA_NETO: TFloatField
      FieldName = 'APLICA_NETO'
      Origin = 'APLICA_NETO'
    end
    object QAplCompraCONCILIADO: TStringField
      FieldName = 'CONCILIADO'
      Origin = 'CONCILIADO'
      Required = True
      FixedChar = True
    ...
    object QAplCompraAPLICA_IVA: TFloatField
      FieldName = 'APLICA_IVA'
      Origin = 'APLICA_IVA'
      Required = True
    end
  end
  object QMovComp: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select *  from MovCCcompra where id_cpbte=:id'
      'and tipoCpbte=:tipo')
    Left = 396
    Top = 464
    ParamData = <
    ...
    object QMovCompID_MOVCCCOMPRA: TIntegerField
      FieldName = 'ID_MOVCCCOMPRA'
      Origin = 'ID_MOVCCCOMPRA'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QMovCompID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
      Required = True
    end
    object QMovCompPROVEEDOR: TStringField
      FieldName = 'PROVEEDOR'
      Origin = 'PROVEEDOR'
      Size = 6
    end
    object QMovCompFECHACOMPRA: TSQLTimeStampField
      FieldName = 'FECHACOMPRA'
      Origin = 'FECHACOMPRA'
    end
    object QMovCompFECHAVTO: TSQLTimeStampField
      FieldName = 'FECHAVTO'
      Origin = 'FECHAVTO'
    end
    object QMovCompTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Size = 2
    end
    object QMovCompCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object QMovCompNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Origin = 'NROCPBTE'
      Size = 13
    end
    object QMovCompDEBE: TFloatField
      FieldName = 'DEBE'
      Origin = 'DEBE'
    end
    object QMovCompHABER: TFloatField
      FieldName = 'HABER'
      Origin = 'HABER'
    end
    object QMovCompSALDO: TFloatField
      FieldName = 'SALDO'
      Origin = 'SALDO'
    end
    object QMovCompDETALLE: TStringField
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object QMovCompID_MONEDA: TIntegerField
      FieldName = 'ID_MONEDA'
      Origin = 'ID_MONEDA'
    end
    object QMovCompCOTIZACION: TFloatField
      FieldName = 'COTIZACION'
      Origin = 'COTIZACION'
    end
  end
  object QFcComp: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from fccompcab where codigo=:codigo')
    Left = 404
    Top = 520
    ParamData = <
      item
  ...
  object QSuma: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select sum(importe) from movaplicaccvta where id_movccvta=:id')
    Left = 716
    Top = 40
    ParamData = <
      item
  ...
  object QSumaComp: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select sum(importe) from movaplicacccompra  where id_movcccompra' +
        '=:id')
    Left = 716
    Top = 104
    ParamData = <
    ...
    object QSumaCompSUM: TFloatField
      AutoGenerateValue = arDefault
      FieldName = 'SUM'
      Origin = 'SUM'
      ProviderFlags = []
