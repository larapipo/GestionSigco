inherited FormVtaRubro_SubRubro: TFormVtaRubro_SubRubro
  Left = 195
  Top = 86
  Caption = 'Listado de Ventas por Rubro / SubRubro'
  ClientHeight = 708
  ClientWidth = 1310
  ExplicitWidth = 1328
  ExplicitHeight = 749
    ...
    object pcVentas: TPageControl
      ...
      object TabSheet2: TTabSheet
        ...
        object dbgGrafico: TDBChart
          ...
          Legend.Symbol.Pen.EndStyle = esSquare
          ...
          object Series1: TPieSeries
            ...
            Marks.Emboss.HorizSize = 1
            Marks.Emboss.VertSize = 1
            Marks.Emboss.Visible = True
            Marks.Font.Color = 2434341
            Marks.Font.DefaultFont = True
            Marks.Frame.Visible = False
            Marks.Shadow.Color = 8487297
            Marks.Transparent = True
            Marks.Style = smsLabelValue
            Marks.Arrow.Color = 5855577
            Marks.BackColor = clBlack
            Marks.Callout.DarkPen = -37
            Marks.Callout.HorizSize = 1
            Marks.Callout.Pen.EndStyle = esSquare
            Marks.Callout.Pen.JoinStyle = jsBevel
            Marks.Callout.Style = psCircle
            Marks.Callout.VertSize = 1
            Marks.Callout.Visible = True
            Marks.Callout.Arrow.Color = 5855577
            Marks.Callout.ArrowHead = ahLine
            Marks.Callout.ArrowHeadSize = 1
            Marks.Callout.Distance = 41
            Marks.Callout.Length = 2
            Marks.MultiLine = True
            Marks.Symbol.Frame.EndStyle = esFlat
            Marks.Symbol.Frame.JoinStyle = jsBevel
            Marks.Symbol.Frame.Visible = False
            Marks.Symbol.Pen.EndStyle = esFlat
            Marks.Symbol.Pen.JoinStyle = jsBevel
            Marks.Symbol.Pen.Visible = False
            Marks.Tail.Margin = 2
            Marks.Color = clBlack
            DataSource = CDSVta
            PercentFormat = '0.00 %'
            Title = 'Ventas por Rub'
            ValueFormat = ',0.00'
            XLabelsSource = 'MUESTRASUBRUBRO'
            ...
            Dark3D = False
            EdgeStyle = edFlat
            OtherSlice.Legend.HorizMargin = 1
            OtherSlice.Legend.Symbol.Height = 90
            OtherSlice.Legend.Visible = False
            PieMarks.EmptySlice = True
            PieMarks.LegSize = 66
            PieMarks.VertCenter = True
            PiePen.Color = 4473924
            PiePen.SmallDots = True
          end
        end
        object pnPieGrafico: TPanel
          Left = 0
          Top = 503
          Width = 1302
          Height = 32
      ...
      object TabSheet3: TTabSheet
        ...
        object cxGrid1: TcxGrid
          ...
          Align = alClient
          TabOrder = 0
          LockedStateImageOptions.Text = 'Espere...'
          object cxGrid1DBTableView1: TcxGridDBTableView
            DataController.DataSource = DSVta
      ...
      object ProyeccionVtas: TTabSheet
        Caption = 'Proyecciones de Vtas'
        ImageIndex = 3
        object cxDBPivotGrid1: TcxDBPivotGrid
          ...
          OptionsView.ColumnGrandTotalText = 'Acumulado'
          OptionsView.FilterFields = False
          OptionsView.RowGrandTotals = False
          OptionsView.RowGrandTotalWidth = 159
          OptionsView.RowTotals = False
          PopupMenu = PopupMenu1
          TabOrder = 0
          object cxDBPivotGrid1SUCURSAL: TcxDBPivotGridField
            AreaIndex = 0
          ...
          object cxDBPivotGrid1RUBRO_STK: TcxDBPivotGridField
            AreaIndex = 3
          ...
          object cxDBPivotGrid1SUBRUBRO_STK: TcxDBPivotGridField
            AreaIndex = 4
            DataBinding.FieldName = 'SUBRUBRO_STK'
            GroupIndex = 0
            GroupExpanded = False
            Visible = True
            UniqueName = 'Cod.SubRub'
          end
      ...
      object TabSheet4: TTabSheet
        ...
        object cxGrid2: TcxGrid
          ...
          object cxGrid2DBTableView1: TcxGridDBTableView
            DataController.DataSource = DSProyecionVtas
            object cxGrid2DBTableView1SUCURSAL: TcxGridDBColumn
              DataBinding.FieldName = 'SUCURSAL'
            end
            ...
            object cxGrid2DBTableView1RUBRO_STK: TcxGridDBColumn
              DataBinding.FieldName = 'RUBRO_STK'
            end
            object cxGrid2DBTableView1SUBRUBRO_STK: TcxGridDBColumn
              DataBinding.FieldName = 'SUBRUBRO_STK'
            end
            object cxGrid2DBTableView1DETALLE_RUBRO: TcxGridDBColumn
              DataBinding.FieldName = 'DETALLE_RUBRO'
            end
            object cxGrid2DBTableView1DETALLE_SUBRUBRO: TcxGridDBColumn
              DataBinding.FieldName = 'DETALLE_SUBRUBRO'
            end
          ...
          object cxGrid2DBTableView2: TcxGridDBTableView
            DataController.DataSource = DSProyecionVtas
            object cxGrid2DBTableView2MES: TcxGridDBColumn
              DataBinding.FieldName = 'MES'
              Visible = False
              GroupIndex = 2
            end
            object cxGrid2DBTableView2ANIO: TcxGridDBColumn
              DataBinding.FieldName = 'ANIO'
              Visible = False
              GroupIndex = 3
            end
            ...
            object cxGrid2DBTableView2DETALLE_STK: TcxGridDBColumn
              DataBinding.FieldName = 'DETALLE_STK'
              Width = 172
            end
            object cxGrid2DBTableView2DETALLE_RUBRO: TcxGridDBColumn
              DataBinding.FieldName = 'DETALLE_RUBRO'
              Visible = False
              GroupIndex = 0
            end
          ...
          object cxGrid2DBChartView2: TcxGridDBChartView
            ...
            object cxGrid2DBChartView2Series2: TcxGridDBChartSeries
              DataBinding.FieldName = 'MES'
            end
          end
  ...
  object frxReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.859588576390000000
    ReportOptions.LastChange = 39638.859588576390000000
  ...
  object DSBuscaRubros: TDataSource
  ...
  object CDSVta: TClientDataSet
    ...
    Left = 304
    Top = 288
    object CDSVtaRUBRO: TStringField
      FieldName = 'RUBRO'
      Origin = 'RUBRO'
      Size = 3
    end
    object CDSVtaSUBRUBRO: TStringField
      FieldName = 'SUBRUBRO'
      Origin = 'SUBRUBRO'
      Size = 5
    end
    object CDSVtaCANTIDAD: TFloatField
      DisplayLabel = 'Cantidad'
      FieldName = 'CANTIDAD'
      Origin = 'CANTIDAD'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSVtaMUESTRARUBRO: TStringField
      DisplayLabel = 'Detalle Rubro'
      FieldName = 'MUESTRARUBRO'
      Origin = 'MUESTRARUBRO'
      Size = 35
    end
    object CDSVtaMUESTRASUBRUBRO: TStringField
      DisplayLabel = 'Detalle Sub Rub.'
      FieldName = 'MUESTRASUBRUBRO'
      Origin = 'MUESTRASUBRUBRO'
      Size = 45
    end
    object CDSVtaTOTAL: TFloatField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      DisplayFormat = ',0.00;-,0.00;-'
  ...
  object DSPVta: TDataSetProvider
    DataSet = QVta
    Left = 232
    Top = 288
  end
  ...
  object QVta: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select V.* from VENTA_POR_RUBRO_SUBRUBRO(:codigo_rubro,:desde,:h' +
        'asta,:sucursal) V'
      'order by v.rubro,v.subrubro')
    Left = 172
    Top = 284
    ParamData = <
      item
  ...
  object QProyecionVtas: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select c.sucursal, c.fechavta,extract(month from c.fechavta) as ' +
        'Mes,extract(year from c.fechavta) as Anio, d.codigoarticulo,s.de' +
        'talle_stk,'
      
        's.rubro_stk,s.subrubro_stk,r.detalle_rubro,sr.detalle_subrubro,(' +
        'case c.tipocpbte when '#39'NC'#39' then (d.cantidad * -1)'
      
        '                                                                ' +
        'else d.cantidad end ) as cantidad from fcvtacab c'
      ...
      'left join subrubros sr on sr.codigo_subrubro=s.subrubro_stk'
        ...
        'where ((c.sucursal=:sucursal) or (:sucursal=-1)) and (c.fechavta' +
        ' between :desde and :hasta) and c.anulado='#39'N'#39)
    Left = 692
    Top = 508
    ParamData = <
      item
  ...
  object DSProyecionVtas: TDataSource
    DataSet = CDSProyecionVtas
    Left = 1004
    Top = 444
  end
  object CDSProyecionVtas: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPProyecionVtas'
    OnCalcFields = CDSProyecionVtasCalcFields
    Left = 900
    Top = 484
    object CDSProyecionVtasSUCURSAL: TIntegerField
      DisplayLabel = 'Sucursal'
      FieldName = 'SUCURSAL'
      Origin = 'SUCURSAL'
      Required = True
    end
    object CDSProyecionVtasFECHAVTA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHAVTA'
      Origin = 'FECHAVTA'
      Required = True
    end
    object CDSProyecionVtasMES: TSmallintField
      DisplayLabel = 'Mes'
      FieldName = 'MES'
      Origin = 'MES'
      ProviderFlags = []
    ...
    object CDSProyecionVtasANIO: TSmallintField
    ...
    object CDSProyecionVtasCODIGOARTICULO: TStringField
      DisplayLabel = 'Codigo'
    ...
    object CDSProyecionVtasDETALLE_STK: TStringField
    ...
    object CDSProyecionVtasRUBRO_STK: TStringField
    ...
    object CDSProyecionVtasSUBRUBRO_STK: TStringField
    ...
    object CDSProyecionVtasDETALLE_RUBRO: TStringField
      DisplayLabel = 'Rubro '
      FieldName = 'DETALLE_RUBRO'
      Origin = 'DETALLE_RUBRO'
      ProviderFlags = []
    ...
    object CDSProyecionVtasDETALLE_SUBRUBRO: TStringField
    ...
    object CDSProyecionVtasCANTIDAD: TFloatField
      DisplayLabel = 'Cantidad'
      FieldName = 'CANTIDAD'
      Origin = 'CANTIDAD'
      ProviderFlags = []
    ...
    object CDSProyecionVtasMESSTR: TStringField
      DisplayLabel = 'Mes'
  ...
  object DSPProyecionVtas: TDataSetProvider
    DataSet = QProyecionVtas
    Left = 788
    Top = 516
  end
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TcxPivotGridReportLink
      ...
      ReportDocument.CreationDate = 45488.422091585650000000
  ...
  object QBuscaRubro: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select r.detalle_rubro,r.codigo_rubro from rubros r order by r.d' +
        'etalle_rubro')
    Left = 36
    Top = 236
  end
