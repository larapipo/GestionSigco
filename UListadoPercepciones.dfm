inherited FormListaPercepciones: TFormListaPercepciones
  Left = 156
  Top = 96
  Caption = 'Listado de Percepciones en las Fc. de Compra'
  ClientHeight = 631
  ClientWidth = 1027
  ...
  inherited pnPrincipal: TPanel
    ...
    object pcPercepciones: TPageControl
      Left = 0
      Top = 63
      Width = 1027
      Height = 515
      ...
      object pgDetalles: TTabSheet
        ...
        object cxGrid1: TcxGrid
          ...
          object cxGrid1DBTableView1: TcxGridDBTableView
            ...
            DataController.DataSource = DSPercepciones
            ...
            object cxGrid1DBTableView1TIPOPERCEPCION: TcxGridDBColumn
              DataBinding.FieldName = 'TIPOPERCEPCION'
              Visible = False
              GroupIndex = 1
              HeaderAlignmentHorz = taCenter
            ...
            object cxGrid1DBTableView1TASA: TcxGridDBColumn
    ...
    object cbSucursales: TJvDBLookupCombo
      Left = 10
      Top = 20
      Width = 201
      Height = 21
  ...
  inherited ActionList1: TActionList
    ...
    object ExportarIB_MensualTxt: TAction
      Caption = 'Exportar Percepcione de IIBB regimen Bimestral a Archivo Txt'
      OnExecute = ExportarIB_MensualTxtExecute
    end
    object ExportaIBMultiTxt: TAction
      Caption = 'Exportar Percepcione de IIBB a Archivo Txt Multiconvenio'
      OnExecute = ExportaIBMultiTxtExecute
    end
  ...
  object frConsulta: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.796917673610000000
    ReportOptions.LastChange = 39638.796917673610000000
  ...
  object frDBDPercepciones: TfrxDBDataset
    UserName = 'frDBDPercepciones'
  ...
  object PopupMenu1: TPopupMenu
    Left = 80
    Top = 128
    object ExportarPercepcionedeIIBBaArchivoTxt1: TMenuItem
      Action = ExportarIB_MensualTxt
    end
    object ExportarPercepcionedeIIBBaArchivoTxtMulticonvenio1: TMenuItem
      Action = ExportaIBMultiTxt
    end
  ...
  object CDSPercepciones: TClientDataSet
    ...
    Left = 352
    Top = 128
    object CDSPercepcionesTIPOPERCEPCION: TStringField
      DisplayLabel = 'Tp.Percep.'
      FieldName = 'TIPOPERCEPCION'
      Origin = 'TIPOPERCEPCION'
      Size = 4
    end
    object CDSPercepcionesDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object CDSPercepcionesIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      DisplayFormat = ',0.00'
    end
    object CDSPercepcionesTASA: TFloatField
      DisplayLabel = '% Tasa'
      FieldName = 'TASA'
      Origin = 'TASA'
      DisplayFormat = '0.00'
    ...
    object CDSPercepcionesID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
    end
    ...
    object CDSPercepcionesRAZON_SOCIAL: TStringField
      DisplayLabel = 'Razon Social'
      FieldName = 'RAZON_SOCIAL'
      Origin = 'RAZON_SOCIAL'
      Size = 35
    end
    object CDSPercepcionesJURIDICCION: TStringField
      FieldName = 'JURIDICCION'
      Origin = 'JURIDICCION'
      Size = 3
    end
    object CDSPercepcionesCODSUC: TIntegerField
      FieldName = 'CODSUC'
      Origin = 'CODSUC'
    end
    object CDSPercepcionesSUCURSAL: TStringField
      DisplayLabel = 'Sucursal'
      FieldName = 'SUCURSAL'
      Origin = 'SUCURSAL'
      Size = 35
    end
    object CDSPercepcionesNETO: TFloatField
      DisplayLabel = 'Neto'
      FieldName = 'NETO'
      Origin = 'NETO'
      DisplayFormat = ',0.00'
    end
    object CDSPercepcionesFECHA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
    end
    object CDSPercepcionesFECHAFISCAL: TSQLTimeStampField
  ...
  object DSPPercepTC: TDataSetProvider
    DataSet = QPercepTC
    Left = 608
    Top = 120
  end
  object CDSPercepTC: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftDate
    ...
    ProviderName = 'DSPPercepTC'
    Left = 664
    Top = 128
    object CDSPercepTCTIPOPERCEPCION: TStringField
      DisplayLabel = 'Tipo Perc.'
      FieldName = 'TIPOPERCEPCION'
      Origin = 'TIPOPERCEPCION'
      Size = 4
    end
    object CDSPercepTCDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
    end
    object CDSPercepTCNROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Origin = 'NROCPBTE'
      Size = 13
    end
    object CDSPercepTCID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
    end
    object CDSPercepTCTIPOCPBTE: TStringField
      FieldName = 'TIPOCPBTE'
      Origin = 'TIPOCPBTE'
      Size = 2
    end
    object CDSPercepTCCLASECPBTE: TStringField
      FieldName = 'CLASECPBTE'
      Origin = 'CLASECPBTE'
      Size = 2
    end
    object CDSPercepTCCUIT: TStringField
      FieldName = 'CUIT'
      Origin = 'CUIT'
      Size = 13
    end
    object CDSPercepTCRAZON_SOCIAL: TStringField
      DisplayLabel = 'R.Social'
      FieldName = 'RAZON_SOCIAL'
      Origin = 'RAZON_SOCIAL'
      Size = 35
    end
    object CDSPercepTCJURIDICCION: TStringField
      FieldName = 'JURIDICCION'
      Origin = 'JURIDICCION'
      Size = 3
    end
    object CDSPercepTCCODSUC: TIntegerField
      FieldName = 'CODSUC'
      Origin = 'CODSUC'
    end
    object CDSPercepTCSUCURSAL: TStringField
      FieldName = 'SUCURSAL'
      Origin = 'SUCURSAL'
      Size = 35
    end
    object CDSPercepTCIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      DisplayFormat = ',0.00'
    end
    object CDSPercepTCNETO: TFloatField
      DisplayLabel = 'Neto'
      FieldName = 'NETO'
      Origin = 'NETO'
      DisplayFormat = ',0.00'
    end
    object CDSPercepTCTASA: TFloatField
      FieldName = 'TASA'
      Origin = 'TASA'
    end
    object CDSPercepTCFECHA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHA'
    end
    object CDSPercepTCFECHAFISCAL: TSQLTimeStampField
      DisplayLabel = 'Fecha Fiscal'
      FieldName = 'FECHAFISCAL'
    end
  end
  object DSPercepTC: TDataSource
    DataSet = CDSPercepTC
    Left = 744
    Top = 136
  end
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TdxGridReportLink
      ...
      PrinterPage.Footer = 3228
      PrinterPage.GrayShading = True
      PrinterPage.Header = 3228
      PrinterPage.Margins.Bottom = 3228
      PrinterPage.Margins.Left = 4065
      PrinterPage.Margins.Right = 4065
      PrinterPage.Margins.Top = 3228
      PrinterPage.Orientation = poLandscape
      PrinterPage.PageSize.X = 210000
      PrinterPage.PageSize.Y = 297000
      PrinterPage._dxMeasurementUnits_ = 0
      PrinterPage._dxLastMU_ = 2
      ReportDocument.CreationDate = 45086.427669548610000000
  ...
  object QPercep: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from lista_percepciones( :Desde, :hasta,:suc)'
      'where importe>0'
      '')
    Left = 204
    Top = 119
  ...
  object QPercepTC: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from lista_percepciones( :Desde, :hasta,:suc)'
      'where importe>0 and tipocpbte='#39'LQ'#39)
    Left = 524
    Top = 119
    ParamData = <
      item
