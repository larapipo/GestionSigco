inherited FormAnulacionDepositoBancario: TFormAnulacionDepositoBancario
  Left = 206
  Top = 73
  Caption = 'Anulaci'#243'n Dep'#243'sitos Bancarios'
  ClientHeight = 649
  ClientWidth = 769
  ...
  inherited ComBuscadorBase: TComBuscador
    Data = CDSBuscadorDepositosAnulados
    Campo = 'ID'
    Titulo = 'Listados Depositos Anulados'
    Left = 392
    Top = 56
  end
  object DSPAnuDepCab: TDataSetProvider
    DataSet = QAnuDepCab
    Options = []
  ...
  object ibgId_cab: TIBGenerator
    ...
    GeneratorName = 'NEXT_ID_ANULACION_DEPOSITO_BCO'
    SystemGenerators = False
    Left = 504
    Top = 208
  end
  object QAnuDepCab: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select dc.* ,'
      '  cta.nombre as MuestraCtaCaja,'
      
        '  cta.Nro_cuenta as MuestraNroCta from Anulacion_dep_banco_cab d' +
        'c'
    ...
    object QAnuDepCabID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QAnuDepCabID_CTA_CAJA: TIntegerField
      FieldName = 'ID_CTA_CAJA'
      Required = True
    end
    object QAnuDepCabFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object QAnuDepCabNUMERO: TStringField
      FieldName = 'NUMERO'
      Size = 13
    end
    object QAnuDepCabIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object QAnuDepCabEFEC_CHEQ: TStringField
      FieldName = 'EFEC_CHEQ'
      Required = True
      FixedChar = True
      Size = 1
    end
    object QAnuDepCabOBS: TStringField
      FieldName = 'OBS'
      Size = 50
    end
    object QAnuDepCabMUESTRACTACAJA: TStringField
      FieldName = 'MUESTRACTACAJA'
      ProviderFlags = []
      Size = 25
    end
    object QAnuDepCabMUESTRANROCTA: TStringField
      FieldName = 'MUESTRANROCTA'
      ProviderFlags = []
      Size = 15
    end
  end
  object CDSAnuDepCab: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPAnuDepCab'
    OnNewRecord = CDSAnuDepCabNewRecord
    Left = 272
    Top = 496
    object CDSAnuDepCabID: TIntegerField
      FieldName = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSAnuDepCabID_CTA_CAJA: TIntegerField
      FieldName = 'ID_CTA_CAJA'
      Required = True
      OnSetText = CDSAnuDepCabID_CTA_CAJASetText
    end
    object CDSAnuDepCabFECHA: TSQLTimeStampField
      FieldName = 'FECHA'
      Required = True
    end
    object CDSAnuDepCabNUMERO: TStringField
      FieldName = 'NUMERO'
      OnSetText = CDSAnuDepCabNUMEROSetText
      Size = 13
    end
    object CDSAnuDepCabIMPORTE: TFloatField
      FieldName = 'IMPORTE'
    end
    object CDSAnuDepCabEFEC_CHEQ: TStringField
      FieldName = 'EFEC_CHEQ'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CDSAnuDepCabOBS: TStringField
      FieldName = 'OBS'
      Size = 50
    end
    object CDSAnuDepCabMUESTRACTACAJA: TStringField
      FieldName = 'MUESTRACTACAJA'
      ProviderFlags = []
      Size = 25
    end
    object CDSAnuDepCabMUESTRANROCTA: TStringField
      FieldName = 'MUESTRANROCTA'
      ProviderFlags = []
      Size = 15
    end
  ...
  object QBuscadorDepositoAnulados: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select id,Numero,Importe from anulacion_dep_banco_cab')
    Left = 488
    Top = 536
  end
  ...
  object DSPBuscadorCta: TDataSetProvider
    DataSet = QBuscadorCta
    Options = []
    Left = 565
    Top = 480
  end
  object CDSBuscadorDepositosAnulados: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSPBuscadorDepositosAnulados'
    Left = 572
    Top = 584
    object CDSBuscadorDepositosAnuladosID: TIntegerField
      DisplayLabel = 'Id'
      FieldName = 'ID'
      Required = True
    end
    object CDSBuscadorDepositosAnuladosNUMERO: TStringField
      DisplayLabel = 'Numero'
      FieldName = 'NUMERO'
      Size = 13
    end
    object CDSBuscadorDepositosAnuladosIMPORTE: TFloatField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
    end
  end
  object DSPBuscadorDepositosAnulados: TDataSetProvider
    DataSet = QBuscadorDepositoAnulados
    Options = []
    Left = 556
    Top = 528
  end
