...
namespace Demo_QR
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            mllib.MPService mp = new mllib.MPService();
            mp.CloseDialogOnConfirm = false;
            double Amount2Decimals = 50.15; 
            string ExternalReference = mp.newUuid();
            bool PrintOnTerminal = true;
            string TicketNumber = "12345";
  
  
            if (mp.CreatePaymentIntent(mp.DefaultPoint, Amount2Decimals, ExternalReference, PrintOnTerminal, TicketNumber)) {
                if (mp.WaitPaymentIntent())
                {
                ...
                {
                    MessageBox.Show("El pago no se realizó");
                }
            } 
        }
