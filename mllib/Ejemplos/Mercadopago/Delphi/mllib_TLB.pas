...
// $Rev: 52393 $
// File generated on 5/3/2024 15:36:50 from Type Library described below.
...
//   Hint: Parameter 'type' of IRWService.posStartPayment changed to 'type_'
// ************************************************************************ //
...
const
  ...
  IID_IRWService: TGUID = '{972ECAA8-B8C0-4C6E-97F7-64EF98155629}';
  CLASS_RWService: TGUID = '{B9EC13DA-C7BB-4759-8378-F83FC088B7F6}';
  IID_IRWGetPaymentStatusResponse: TGUID = '{E90968CA-1605-4245-8364-BD29E1818DC7}';
  CLASS_RWGetPaymentStatusResponse: TGUID = '{293AB2D0-4C91-4DFD-80E0-27C88269C4AB}';
  IID_IRWStartPaymentResponse: TGUID = '{77AE84B6-6BAD-42EE-A74B-351BFC41FB43}';
  CLASS_RWStartPaymentResponse: TGUID = '{1119D193-F7F7-4D02-9E1C-40F673A7DD9E}';
  IID_ICardInfo: TGUID = '{292AA04B-55E8-4E76-A082-6A7699D92069}';
  CLASS_CardInfo: TGUID = '{A16F14CE-BFCC-43FB-BDDC-94358A5DADB8}';
type
...
// *********************************************************************//
  ...
  IRWService = interface;
  IRWServiceDisp = dispinterface;
  IRWGetPaymentStatusResponse = interface;
  IRWGetPaymentStatusResponseDisp = dispinterface;
  IRWStartPaymentResponse = interface;
  IRWStartPaymentResponseDisp = dispinterface;
  ICardInfo = interface;
  ICardInfoDisp = dispinterface;
...
// *********************************************************************//
  ...
  RWService = IRWService;
  RWGetPaymentStatusResponse = IRWGetPaymentStatusResponse;
  RWStartPaymentResponse = IRWStartPaymentResponse;
  CardInfo = ICardInfo;
...
// *********************************************************************//
  IMPService = interface(IDispatch)
    ...
    function WaitNextPayment: OLE_CANCELBOOL; safecall;
    function GetPayments(const Filter: IJsonObject): OLE_CANCELBOOL; safecall;
    function Get_GetPaymentsResponse: IJsonObject; safecall;
    ...
    property GetPaymentsResponse: IJsonObject read Get_GetPaymentsResponse;
  end;
...
// *********************************************************************//
  IMPServiceDisp = dispinterface
    ...
    function WaitNextPayment: OLE_CANCELBOOL; dispid 251;
    function GetPayments(const Filter: IJsonObject): OLE_CANCELBOOL; dispid 252;
    property GetPaymentsResponse: IJsonObject readonly dispid 253;
  end;
...
// *********************************************************************//
  IMLService = interface(IDispatch)
    ...
    function Get_GetUsersMeResponse: IJsonObject; safecall;
    function Logout: OLE_CANCELBOOL; safecall;
    function GetShipments(const ShippingId: WideString): OLE_CANCELBOOL; safecall;
    function Get_GetShipmentsResponse: IJsonObject; safecall;
    function GetPendantOrders(const Filter: IJsonObject): OLE_CANCELBOOL; safecall;
    function Get_GetPendantOrdersResponse: IJsonObject; safecall;
    ...
    property GetUsersMeResponse: IJsonObject read Get_GetUsersMeResponse;
    property GetShipmentsResponse: IJsonObject read Get_GetShipmentsResponse;
    property GetPendantOrdersResponse: IJsonObject read Get_GetPendantOrdersResponse;
  end;
...
// *********************************************************************//
  IMLServiceDisp = dispinterface
    ...
    function GetShipments(const ShippingId: WideString): OLE_CANCELBOOL; dispid 221;
    property GetShipmentsResponse: IJsonObject readonly dispid 224;
    function GetPendantOrders(const Filter: IJsonObject): OLE_CANCELBOOL; dispid 225;
    property GetPendantOrdersResponse: IJsonObject readonly dispid 226;
  end;
...
// *********************************************************************//
// Interface: IRWService
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {972ECAA8-B8C0-4C6E-97F7-64EF98155629}
// *********************************************************************//
  IRWService = interface(IDispatch)
    ['{972ECAA8-B8C0-4C6E-97F7-64EF98155629}']
    function posStartPayment(amount: Double; const reference: WideString; const type_: WideString): OLE_CANCELBOOL; safecall;
    procedure posDeviceConfigure; safecall;
    function posGetPaymentStatus(const id: WideString): OLE_CANCELBOOL; safecall;
    function posStartRefund(const remoteId: WideString; amount: Double): OLE_CANCELBOOL; safecall;
    function posStartRefundUserConfirmation(const remoteId: WideString): OLE_CANCELBOOL; safecall;
    function posCancelPayment(const remoteId: WideString): OLE_CANCELBOOL; safecall;
    function Get_posGetPaymentStatusResponse: IRWGetPaymentStatusResponse; safecall;
    function Get_error: WideString; safecall;
    function Get_errorDesc: WideString; safecall;
    function waitPayment: OLE_CANCELBOOL; safecall;
    property posGetPaymentStatusResponse: IRWGetPaymentStatusResponse read Get_posGetPaymentStatusResponse;
    property error: WideString read Get_error;
    property errorDesc: WideString read Get_errorDesc;
  end;

// *********************************************************************//
// DispIntf:  IRWServiceDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {972ECAA8-B8C0-4C6E-97F7-64EF98155629}
// *********************************************************************//
  IRWServiceDisp = dispinterface
    ['{972ECAA8-B8C0-4C6E-97F7-64EF98155629}']
    function posStartPayment(amount: Double; const reference: WideString; const type_: WideString): OLE_CANCELBOOL; dispid 201;
    procedure posDeviceConfigure; dispid 202;
    function posGetPaymentStatus(const id: WideString): OLE_CANCELBOOL; dispid 203;
    function posStartRefund(const remoteId: WideString; amount: Double): OLE_CANCELBOOL; dispid 204;
    function posStartRefundUserConfirmation(const remoteId: WideString): OLE_CANCELBOOL; dispid 205;
    function posCancelPayment(const remoteId: WideString): OLE_CANCELBOOL; dispid 206;
    property posGetPaymentStatusResponse: IRWGetPaymentStatusResponse readonly dispid 207;
    property error: WideString readonly dispid 208;
    property errorDesc: WideString readonly dispid 209;
    function waitPayment: OLE_CANCELBOOL; dispid 210;
  end;

// *********************************************************************//
// Interface: IRWGetPaymentStatusResponse
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {E90968CA-1605-4245-8364-BD29E1818DC7}
// *********************************************************************//
  IRWGetPaymentStatusResponse = interface(IDispatch)
    ['{E90968CA-1605-4245-8364-BD29E1818DC7}']
    function Get_status: Integer; safecall;
    function Get_txe: WideString; safecall;
    function Get_message: WideString; safecall;
    function Get_cardInfo: ICardInfo; safecall;
    function Get_productName: WideString; safecall;
    property status: Integer read Get_status;
    property txe: WideString read Get_txe;
    property message: WideString read Get_message;
    property cardInfo: ICardInfo read Get_cardInfo;
    property productName: WideString read Get_productName;
  end;

// *********************************************************************//
// DispIntf:  IRWGetPaymentStatusResponseDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {E90968CA-1605-4245-8364-BD29E1818DC7}
// *********************************************************************//
  IRWGetPaymentStatusResponseDisp = dispinterface
    ['{E90968CA-1605-4245-8364-BD29E1818DC7}']
    property status: Integer readonly dispid 201;
    property txe: WideString readonly dispid 202;
    property message: WideString readonly dispid 203;
    property cardInfo: ICardInfo readonly dispid 204;
    property productName: WideString readonly dispid 205;
  end;

// *********************************************************************//
// Interface: IRWStartPaymentResponse
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {77AE84B6-6BAD-42EE-A74B-351BFC41FB43}
// *********************************************************************//
  IRWStartPaymentResponse = interface(IDispatch)
    ['{77AE84B6-6BAD-42EE-A74B-351BFC41FB43}']
    function Get_remoteId: WideString; safecall;
    property remoteId: WideString read Get_remoteId;
  end;

// *********************************************************************//
// DispIntf:  IRWStartPaymentResponseDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {77AE84B6-6BAD-42EE-A74B-351BFC41FB43}
// *********************************************************************//
  IRWStartPaymentResponseDisp = dispinterface
    ['{77AE84B6-6BAD-42EE-A74B-351BFC41FB43}']
    property remoteId: WideString readonly dispid 201;
  end;

// *********************************************************************//
// Interface: ICardInfo
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {292AA04B-55E8-4E76-A082-6A7699D92069}
// *********************************************************************//
  ICardInfo = interface(IDispatch)
    ['{292AA04B-55E8-4E76-A082-6A7699D92069}']
    function Get_CardNumber: WideString; safecall;
    ...
    property OwnerId: WideString read Get_OwnerId;
    property OwnerName: WideString read Get_OwnerName;
    property CardType: WideString read Get_CardType;
  end;

// *********************************************************************//
// DispIntf:  ICardInfoDisp
// Flags:     (4416) Dual OleAutomation Dispatchable
// GUID:      {292AA04B-55E8-4E76-A082-6A7699D92069}
// *********************************************************************//
  ICardInfoDisp = dispinterface
    ['{292AA04B-55E8-4E76-A082-6A7699D92069}']
    property CardNumber: WideString readonly dispid 202;
    property OwnerId: WideString readonly dispid 203;
    property OwnerName: WideString readonly dispid 204;
    property CardType: WideString readonly dispid 205;
  end;
...
// *********************************************************************//
// The Class CoRWService provides a Create and CreateRemote method to
// create instances of the default interface IRWService exposed by
// the CoClass RWService. The functions are intended to be used by
// clients wishing to automate the CoClass objects exposed by the
// server of this typelibrary.
// *********************************************************************//
  CoRWService = class
    class function Create: IRWService;
    class function CreateRemote(const MachineName: string): IRWService;
  end;

// *********************************************************************//
// The Class CoRWGetPaymentStatusResponse provides a Create and CreateRemote method to
// create instances of the default interface IRWGetPaymentStatusResponse exposed by
// the CoClass RWGetPaymentStatusResponse. The functions are intended to be used by
// clients wishing to automate the CoClass objects exposed by the
// server of this typelibrary.
// *********************************************************************//
  CoRWGetPaymentStatusResponse = class
    class function Create: IRWGetPaymentStatusResponse;
    class function CreateRemote(const MachineName: string): IRWGetPaymentStatusResponse;
  end;

// *********************************************************************//
// The Class CoRWStartPaymentResponse provides a Create and CreateRemote method to
// create instances of the default interface IRWStartPaymentResponse exposed by
// the CoClass RWStartPaymentResponse. The functions are intended to be used by
// clients wishing to automate the CoClass objects exposed by the
// server of this typelibrary.
// *********************************************************************//
  CoRWStartPaymentResponse = class
    class function Create: IRWStartPaymentResponse;
    class function CreateRemote(const MachineName: string): IRWStartPaymentResponse;
  end;

// *********************************************************************//
// The Class CoCardInfo provides a Create and CreateRemote method to
// create instances of the default interface ICardInfo exposed by
// the CoClass CardInfo. The functions are intended to be used by
// clients wishing to automate the CoClass objects exposed by the
// server of this typelibrary.
// *********************************************************************//
  CoCardInfo = class
    class function Create: ICardInfo;
    class function CreateRemote(const MachineName: string): ICardInfo;
  end;
...
class function CoRWService.Create: IRWService;
begin
  Result := CreateComObject(CLASS_RWService) as IRWService;
end;

class function CoRWService.CreateRemote(const MachineName: string): IRWService;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_RWService) as IRWService;
end;

class function CoRWGetPaymentStatusResponse.Create: IRWGetPaymentStatusResponse;
begin
  Result := CreateComObject(CLASS_RWGetPaymentStatusResponse) as IRWGetPaymentStatusResponse;
end;

class function CoRWGetPaymentStatusResponse.CreateRemote(const MachineName: string): IRWGetPaymentStatusResponse;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_RWGetPaymentStatusResponse) as IRWGetPaymentStatusResponse;
end;

class function CoRWStartPaymentResponse.Create: IRWStartPaymentResponse;
begin
  Result := CreateComObject(CLASS_RWStartPaymentResponse) as IRWStartPaymentResponse;
end;

class function CoRWStartPaymentResponse.CreateRemote(const MachineName: string): IRWStartPaymentResponse;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_RWStartPaymentResponse) as IRWStartPaymentResponse;
end;

class function CoCardInfo.Create: ICardInfo;
begin
  Result := CreateComObject(CLASS_CardInfo) as ICardInfo;
end;

class function CoCardInfo.CreateRemote(const MachineName: string): ICardInfo;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_CardInfo) as ICardInfo;
end;
