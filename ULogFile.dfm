inherited FormLog: TFormLog
  ...
  inherited ActionList1: TActionList
    ...
    object MarcarLog: TAction
      Caption = 'Marcar Linea'
      OnExecute = MarcarLogExecute
    end
    object ExportaXLS: TAction
      Caption = 'Exporta XLS'
    end
    object Depurar: TAction
      Caption = 'Depurar'
      OnExecute = DepurarExecute
    end
  end
  ...
  object PopupMenu1: TPopupMenu
    Left = 160
    Top = 272
    object MarcarLinea1: TMenuItem
      Action = MarcarLog
    end
    object BorrarLinea1: TMenuItem
      Action = BorrarUna
    end
    object N1: TMenuItem
      Caption = '-'
  ...
  object spBorrar: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'BORRAR_LOG'
    Left = 648
    Top = 232
    ParamData = <
      item
  ...
  object spMarcar: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'MARCAR_LINEA_LOG'
    Left = 664
    Top = 304
    ParamData = <
      item
  ...
  object QLogin: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select l.* from log_file l where l.revisado <> :revisado order b' +
        'y'
      ' l.fecha desc')
    Left = 232
    Top = 344
  ...
  object CDSLog: TClientDataSet
    ...
    object CDSLogDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 254
    end
    object CDSLogTIPOLOG: TSmallintField
      DisplayLabel = 'Tipo'
      FieldName = 'TIPOLOG'
      Origin = 'TIPOLOG'
    end
    object CDSLogORIGEN: TStringField
      DisplayLabel = 'Origen'
      FieldName = 'ORIGEN'
      Origin = 'ORIGEN'
      Size = 25
    ...
    object CDSLogREVISADO: TStringField
      DisplayLabel = 'V B'
      FieldName = 'REVISADO'
      Origin = 'REVISADO'
      Required = True
    ...
    object CDSLogNIVEL: TIntegerField
      FieldName = 'NIVEL'
      Origin = 'NIVEL'
      Required = True
    end
