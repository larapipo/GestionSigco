inherited FormSaldoProveedorAlDia: TFormSaldoProveedorAlDia
  Left = 252
  Top = 106
  Caption = 'Saldo de Deuda Proveedores a la Fecha de Vencimiento Factura'
  ClientHeight = 664
  ClientWidth = 1034
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet2: TTabSheet
        ...
        object cxDBPivotGrid1: TcxDBPivotGrid
          ...
          OptionsView.RowGrandTotalWidth = 435
  ...
  object CDSFiltroDet: TClientDataSet
    ...
    object CDSFiltroDetSUCURSAL: TIntegerField
      FieldName = 'SUCURSAL'
      Origin = 'SUCURSAL'
      ProviderFlags = []
    end
  ...
  object CDSSaldos: TClientDataSet
    ...
    object CDSSaldosNOMBRECOMPLETO: TStringField
  ...
  object QSaldos: TFDQuery
    ...
    SQL.Strings = (
      ...
      '   sum(vencido_1+vencido_2+vencido_3+revencido) as Total,'
        ...
        'from SALDO_MENSUALESPROVEEDOR_ALDIA(:desde1,:desde2,:desde3,:suc' +
        '  )'
  ...
  object spAplicarMovFD: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    StoredProcName = 'APLICA_MOV_CCCOMP_TEMPORAL'
    Left = 740
    Top = 367
    ParamData = <
      item
