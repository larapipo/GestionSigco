inherited FormComposicionCobranza: TFormComposicionCobranza
  Left = 270
  Top = 83
  Caption = 'Composicion de Cobranza'
  ClientHeight = 654
  ClientWidth = 895
  ...
  inherited pnPrincipal: TPanel
    ...
    object Label6: TLabel
      ...
      Width = 152
      Height = 32
      Caption = 'Promedio Dias '#13#10'Vencidos de Facturas'
    ...
    object Label7: TLabel
      ...
      Width = 90
      Height = 32
      Caption = 'Total Pagos '#13#10'No Diferidos'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object Label8: TLabel
      ...
      Width = 150
      Height = 32
      Caption = 'Total Pagos'#13#10'Diferidos en Cheques'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object Label9: TLabel
      ...
      Width = 155
      Height = 32
      Caption = 'Dias '#13#10'Diferimiento Promedio'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object dbgMovRecibos: TJvDBGrid
      Left = 6
      Top = 359
      Width = 646
      Height = 98
    ...
    object chRetenciones: TCheckBox
      ...
      Height = 17
      TabStop = False
      Caption = 'Considerar Retenciones '
      Checked = True
      State = cbChecked
      TabOrder = 10
    end
    object edEfectivo: TJvEdit
      Left = 707
      Top = 311
      Width = 121
      Height = 28
    ...
    object chClientesTodos: TCheckBox
      Left = 361
      Top = 21
      Width = 136
      Height = 17
    ...
    object chFechaVta: TCheckBox
      Left = 456
      Top = 476
      Width = 185
      Height = 17
      Caption = 'Calculo en Base a F.de Factura'
      TabOrder = 19
      OnClick = chFiltroClick
    end
  end
  ...
  object dbcGrupo: TJvDBLookupCombo [3]
    Left = 637
    Top = 66
    Width = 171
    Height = 21
  ...
  object DSMovRecibos: TDataSource
    DataSet = CDSMovRecibos
    Left = 272
    Top = 376
  end
  object CDSMovRecibos: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'DSPMovRecibos'
    OnCalcFields = CDSMovRecibosCalcFields
    Left = 200
    Top = 376
    object CDSMovRecibosID_TPAGO: TIntegerField
      FieldName = 'ID_TPAGO'
    end
    object CDSMovRecibosID_FPAGO: TIntegerField
      FieldName = 'ID_FPAGO'
    end
    object CDSMovRecibosDIASCOBRO: TIntegerField
      DisplayWidth = 5
      FieldKind = fkCalculated
      FieldName = 'DIASCOBRO'
      Calculated = True
    end
    object CDSMovRecibosMUESTRAFORMAPAGO: TStringField
      FieldName = 'MUESTRAFORMAPAGO'
    end
    object CDSMovRecibosID_COMPROBANTE: TIntegerField
      FieldName = 'ID_COMPROBANTE'
    end
    object CDSMovRecibosTIPO_COMPROB: TStringField
      FieldName = 'TIPO_COMPROB'
      Size = 2
    end
    object CDSMovRecibosNOMBRE: TStringField
      FieldName = 'NOMBRE'
    end
    object CDSMovRecibosFACTOR_P: TFloatField
      FieldKind = fkCalculated
      FieldName = 'FACTOR_P'
      Calculated = True
    end
    object CDSMovRecibosFECHA_COBRO: TSQLTimeStampField
      FieldName = 'FECHA_COBRO'
    end
    object CDSMovRecibosFECHA_EMISION: TSQLTimeStampField
      FieldName = 'FECHA_EMISION'
    end
    object CDSMovRecibosFECHA_ENTRADA: TSQLTimeStampField
      FieldName = 'FECHA_ENTRADA'
    end
    object CDSMovRecibosIMPORTE: TFloatField
      FieldName = 'IMPORTE'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
    object CDSMovRecibosDEBE: TFloatField
      FieldName = 'DEBE'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
  end
  object DSPMovRecibos: TDataSetProvider
    DataSet = QMovRecibos
    Left = 128
    Top = 376
  end
  ...
  object CDSAplicaciones: TClientDataSet
    ...
    object CDSAplicacionesMORA: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'MORA'
      Calculated = True
    end
    object CDSAplicacionesFACTOR_F: TFloatField
      FieldKind = fkCalculated
      FieldName = 'FACTOR_F'
      Calculated = True
    end
    ...
    object CDSAplicacionesFECHAFACTURA: TSQLTimeStampField
      FieldName = 'FECHAFACTURA'
    end
    object CDSAplicacionesFECHAVTOFACTURA: TSQLTimeStampField
      FieldName = 'FECHAVTOFACTURA'
    end
    object CDSAplicacionesIMPORTEFACTURA: TFloatField
      DisplayLabel = 'Imp.Factura'
      FieldName = 'IMPORTEFACTURA'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    end
  ...
  object frxReporte: TfrxReport
    ...
    ReportOptions.CreateDate = 39820.037735636570000000
    ReportOptions.LastChange = 39820.037779942130000000
  ...
  object frDBMovimientos: TfrxDBDataset
    UserName = 'frDBMovimientos'
    CloseDataSource = False
    DataSource = DSMovRecibos
    BCDToCurrency = False
    DataSetOptions = []
  ...
  object QRecibos: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select r.id_rc, r.tipocpbte,r.clasecpbte, r.fecha, r.nrocpbte, r' +
        '.codigo, r.nombre, r.zona, r.sucursal,'
      'r.vendedor,r.total,c.id_comprobante from recibos r'
      'left join comprobantes c on c.sucursal=r.sucursal and'
      '                            c.tipo_comprob=r.tipocpbte and'
      '                            c.clase_comprob=r.clasecpbte and'
      '                            c.letra=r.letrarc'
      ''
      'where r.fecha between :desde and :hasta and r.total>0 and'
      '      ( r.zona = :zona or :zona = -1 ) and'
      '      ( r.sucursal = :sucursal or :sucursal = -1 ) and'
      '      ( r.vendedor = :vendedor or :vendedor = '#39'******'#39' ) and'
      '      ( r.codigo = :codigo or :codigo = '#39'******'#39' )'
      ''
      
        'group by  r.id_rc, r.tipocpbte, r.clasecpbte, r.fecha, r.nrocpbt' +
        'e, r.codigo,r.nombre, r.zona,r.sucursal,r.vendedor,r.total,c.id_' +
        'comprobante'
      'ORDER BY r.codigo,r.id_rc')
    Left = 64
    Top = 120
    ParamData = <
      item
  ...
  object QAplicaciones: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from aplicacion_pagos(:id)')
    Left = 120
    Top = 208
    ParamData = <
      item
  ...
  object QMovRecibos: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select cm.id_comprobante,cm.tipo_comprob, cm.id_tpago,cm.id_fpag' +
        'o, fp.descripcion as MuestraFormaPago,'
      
        'ch.fecha_cobro,ch.fecha_emision,ch.fecha_entrada,b.nombre,ch.imp' +
        'orte,cm.debe from caja_mov cm'
      'left join cheque_tercero ch on ch.id_mov_caja=cm.id_mov_caja'
      'left join formapago fp on fp.id_fpago=cm.id_fpago'
      'left join bancos b on b.id_banco=ch.id_banco'
      'where cm.id_comprobante = :ID and cm.tipo_operacion='#39'I'#39
      'and cm.tipo_comprob='#39'RC'#39
      ''
      'ORDER BY cm.id_comprobante,cm.id_tpago')
    Left = 64
    Top = 376
    ParamData = <
      item
