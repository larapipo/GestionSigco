inherited FormImportarRubroExcel: TFormImportarRubroExcel
  Left = 289
  Top = 118
  Caption = 'Importar Rubros desde Excel'
  ClientHeight = 629
  ClientWidth = 573
  ...
  object QCodigoFree: TFDQuery
    ...
    SQL.Strings = (
      'select * from buscar_codigorubro_free')
    Left = 144
    Top = 472
  ...
  object QBuscadorRubro: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select r.* from rubros r where r.detalle_rubro= :descripcion')
    Left = 232
    Top = 472
    ParamData = <
      item
