inherited FormListadoRecibos: TFormListadoRecibos
  Left = 259
  Top = 78
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object RxLabel5: TJvLabel
          ...
          Width = 132
          Height = 13
          Caption = 'Retenciones/Percepciones'
        ...
        object chTodosLosClientes: TCheckBox
          Left = 417
          Top = 440
          Width = 97
          Height = 17
      ...
      object TabSheet2: TTabSheet
        ...
        object cxGrid1: TcxGrid
          ...
          object cxGrid1DBTableView1: TcxGridDBTableView
            DataController.DataSource = DSRecibos
            DataController.Summary.FooterSummaryItems = <
              item
                Format = ',0.00'
                Kind = skSum
                Column = cxGrid1DBTableView1TOTAL_NETO
              end
              item
                Format = ',0.00'
                Kind = skSum
            ...
            object cxGrid1DBTableView1TOTAL_NETO: TcxGridDBColumn
              DataBinding.FieldName = 'TOTAL_NETO'
              HeaderAlignmentHorz = taCenter
              Width = 80
            end
            object cxGrid1DBTableView1IMPORTE_DSCTO: TcxGridDBColumn
              DataBinding.FieldName = 'IMPORTE_DSCTO'
              HeaderAlignmentHorz = taCenter
              Width = 80
            end
            ...
            object cxGrid1DBTableView1ID_RC: TcxGridDBColumn
              DataBinding.FieldName = 'ID_RC'
              Visible = False
              HeaderAlignmentHorz = taCenter
            end
  ...
  object frConsulta: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.807731481480000000
    ReportOptions.LastChange = 39638.807731481480000000
  ...
  object CDSRecibos: TClientDataSet
    ...
    object CDSRecibosSALDO: TFloatField
      DisplayLabel = 'Saldo'
      FieldName = 'SALDO'
      Origin = 'SALDO'
      ProviderFlags = []
  ...
  object CDSCajaMov: TClientDataSet
    ...
    object CDSCajaMovDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      ProviderFlags = []
  ...
  object CDSValores: TClientDataSet
    ...
    Left = 712
    Top = 624
    object CDSValoresID_CAJA_MOV: TIntegerField
    ...
    object CDSValoresNUMERO: TStringField
      DisplayLabel = 'Numero'
      FieldName = 'NUMERO'
      Origin = 'NUMERO'
      Size = 10
    end
    object CDSValoresTIPO_COMPROB: TStringField
      FieldName = 'TIPO_COMPROB'
      Origin = 'TIPO_COMPROB'
      Size = 2
    end
    object CDSValoresCLASE_COMPROB: TStringField
      FieldName = 'CLASE_COMPROB'
      Origin = 'CLASE_COMPROB'
      Size = 2
    end
    object CDSValoresDETALLE: TStringField
      DisplayLabel = 'Detalle'
      FieldName = 'DETALLE'
      Origin = 'DETALLE'
      Size = 40
    end
    object CDSValoresIMPORTE: TFMTBCDField
      DisplayLabel = 'Importe'
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
      DisplayFormat = ',0.00'
    ...
    object CDSValoresID_TPAGO: TIntegerField
      FieldName = 'ID_TPAGO'
      Origin = 'ID_TPAGO'
    end
    object CDSValoresTIPO: TStringField
      DisplayLabel = 'Tipo'
      FieldName = 'TIPO'
      Origin = 'TIPO'
      Size = 3
  ...
  object dxComponentPrinter1: TdxComponentPrinter
    ...
    object dxComponentPrinter1Link1: TcxPivotGridReportLink
      ...
      ReportDocument.CreationDate = 42554.960871180560000000
    ...
    object dxComponentPrinter1Link2: TdxGridReportLink
      ...
      PrinterPage.Header = 6350
      PrinterPage.Margins.Bottom = 12700
      PrinterPage.Margins.Left = 8000
      PrinterPage.Margins.Right = 8000
      PrinterPage.Margins.Top = 12700
      PrinterPage.Orientation = poLandscape
      PrinterPage.PageSize.X = 210000
      PrinterPage.PageSize.Y = 297000
      PrinterPage._dxMeasurementUnits_ = 0
      PrinterPage._dxLastMU_ = 2
      ReportDocument.CreationDate = 45940.589517372680000000
  ...
  object QCajaMov: TFDQuery
    ...
    SQL.Strings = (
      'select cm.id_tpago,cm.debe,tp.detalle from caja_mov cm'
  ...
  object QRetenciones: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select detalle,nro_retencion,importe,fecha_retencion from mov_re' +
        'tenciones'
      'where id_cpbte=:id')
    Left = 70
    Top = 210
  ...
  object QRecibos: TFDQuery
    ...
    SQL.Strings = (
      'select r.fecha,r.id_rc,r.tipocpbte,r.clasecpbte,r.nrocpbte,'
      
        '       r.vendedor,r.importe_dscto,r.total_neto,r.nombre,r.total,' +
        'c.denominacion,'
      
        '(select (sum(m.debe)-Sum(m.haber)) as Saldo from movccvta m wher' +
        'e m.cliente=r.codigo) from recibos r'
      'left join comprobantes c on c.letra=r.letrarc and'
      ...
      '      ( r.sucursal = :suc ) and'
      '      ( r.codigo = :codigo or :codigo = '#39'******'#39' ) and'
      '      ( r.clasecpbte = :clase or :clase = '#39'**'#39' ) and '
      '      ( r.letrarc = :letra or :letra = '#39'*'#39' )'
      'order by r.fecha,r.tipocpbte,r.clasecpbte,r.nrocpbte')
    Left = 70
    Top = 130
    ParamData = <
      item
  ...
  object QComprobante: TFDQuery
    ...
    SQL.Strings = (
      ...
      'from comprobantes'
        ...
        'where  sucursal=:Suc and tipo_comprob in ('#39'RC'#39') and compra_venta' +
        '='#39'V'#39
      ' ')
    Left = 352
    Top = 584
