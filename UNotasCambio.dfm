inherited FormNotas_Cambio: TFormNotas_Cambio
  Left = 268
  Top = 100
  Caption = 'Notas de Cambio de Mercaderia'
  ClientHeight = 618
  ClientWidth = 690
  ...
  inherited pnPrincipal: TPanel [2]
    Width = 690
    Height = 409
    StyleElements = [seFont, seClient, seBorder]
    ExplicitWidth = 690
    ...
    object Label5: TLabel
      ...
      Width = 154
      Height = 26
      Caption = 'El producto que va a Descontar '#13#10'la cantidad va en Negativo (-)'
      FocusControl = cxDBTextEdit1
    end
    ...
    object dbgDetalle: TDBGrid
      ...
      Width = 674
      Height = 189
      DataSource = DatosNotasCambio.DSNotaDet
    ...
    object gbLista: TGroupBox
      ...
      object dbcLista: TDBLookupComboBox
        ...
        KeyField = 'ID'
        ListField = 'ID;NOMBRE'
        ListSource = DatosNotasCambio.DSListaPrecios
        NullValueKey = 46
        ParentFont = False
        TabOrder = 0
        TabStop = False
        OnClick = RecalcularExecute
      end
    end
    ...
    object dbgExitencias: TDBGrid
      ...
      Height = 83
      Color = clWhite
      DataSource = DatosNotasCambio.DSExistencia
      DrawingStyle = gdsClassic
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -11
  ...
  object pnComprobantes: TPanel [3]
    Left = 6
    Top = 378
    Width = 482
    Height = 27
  ...
  inherited ActionList1: TActionList
    ...
    object ConfiguraIni: TAction
      Caption = 'ConfiguraIni'
      OnExecute = ConfiguraIniExecute
    end
    ...
    object GenerarAjuste: TAction
      Caption = 'Generar Ajuste'
      OnExecute = GenerarAjusteExecute
    end
    object GenerarFcCC: TAction
      Caption = 'Generar Fc de CC'
      OnExecute = GenerarFcCCExecute
    end
    object GenerarTk: TAction
      Caption = 'Generar Tk de Contado'
    ...
    object GenerarNC: TAction
      Caption = 'GenerarNC'
      OnExecute = GenerarNCExecute
    end
    object GenerarNCCtdo: TAction
      Caption = 'GenerarNCCtdo'
      OnExecute = GenerarNCCtdoExecute
    end
    object VerAjuste: TAction
      Caption = 'Ajuste'
      OnExecute = VerAjusteExecute
    end
  ...
  inherited DSBase: TDataSource
    DataSet = DatosNotasCambio.CDSNotaCab
    Left = 504
    Top = 0
  end
  ...
  inherited QUltimoCodigo2: TFDQuery
    SQL.Strings = (
      'select max(numero) from Nota_cambio_cab'
      '')
    Left = 152
    Top = 496
  end
  object ComBuscadorSucursal: TComBuscador
    Data = DatosNotasCambio.CDSBuscaSucursal
    Campo = 'CODIGO'
    Titulo = 'Sucursales'
    rOk = False
    Left = 144
  ...
  object ComBuscadorDeposito: TComBuscador
    Data = DatosNotasCambio.CDSBuscaDeposito
    Campo = 'ID'
    Titulo = 'Depositos'
    rOk = False
    Left = 56
  ...
  object PopupMenu1: TPopupMenu
    Left = 320
    Top = 224
    object GenerarFcdeCC2: TMenuItem
      Action = GenerarFcCC
    end
    object GenerarFcdeCtdo2: TMenuItem
      Action = GenerarFcCtdo
    end
    object GenerarTkdeContado2: TMenuItem
      Action = GenerarTk
    end
    object N3: TMenuItem
      Caption = '-'
    end
    object GenerarNC2: TMenuItem
      Action = GenerarNC
    end
    object GenerarNCCtdo2: TMenuItem
      Action = GenerarNCCtdo
    end
    object N4: TMenuItem
      Caption = '-'
    end
    object GenerarAjuste2: TMenuItem
      Action = GenerarAjuste
    end
    object VerCodigoAlternativo: TMenuItem
      Caption = 'VerCodigoAlternativo'
