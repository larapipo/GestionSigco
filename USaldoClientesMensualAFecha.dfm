inherited FormSaldoClientesAlDia: TFormSaldoClientesAlDia
  Left = 189
  Top = 74
  Caption = 'Saldo de Deuda Clientes a la Fecha de Vencimiento Factura'
  ClientHeight = 663
  ClientWidth = 1069
  ...
  inherited pnPrincipal: TPanel
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            ...
            Column = cxGrid1DBTableView1MUYVENCIDO
          end
          item
            Format = ',0.00'
            Kind = skSum
            FieldName = 'VENCIDO90'
            Column = cxGrid1DBTableView1VENCIDO90
          end
          item
            Format = ',0.00'
            Kind = skSum
            FieldName = 'VENCIDO60'
            Column = cxGrid1DBTableView1VENCIDO60
          end
          item
            Format = ',0.00'
            Kind = skSum
            FieldName = 'VENCIDO30'
            Column = cxGrid1DBTableView1VENCIDO30
          end
          item
            Format = ',0.00'
            Kind = skSum
        ...
        object cxGrid1DBTableView1MUYVENCIDO: TcxGridDBColumn
          DataBinding.FieldName = 'MUYVENCIDO'
          HeaderAlignmentHorz = taCenter
          Width = 95
        end
        object cxGrid1DBTableView1VENCIDO90: TcxGridDBColumn
          DataBinding.FieldName = 'VENCIDO90'
          HeaderAlignmentHorz = taCenter
          Width = 95
        end
        object cxGrid1DBTableView1VENCIDO60: TcxGridDBColumn
          DataBinding.FieldName = 'VENCIDO60'
          HeaderAlignmentHorz = taCenter
          Width = 95
        end
        object cxGrid1DBTableView1VENCIDO30: TcxGridDBColumn
          DataBinding.FieldName = 'VENCIDO30'
          HeaderAlignmentHorz = taCenter
          Width = 95
        end
        ...
        object cxGrid1DBTableView1ANTICIPOS: TcxGridDBColumn
          DataBinding.FieldName = 'ANTICIPOS'
          HeaderAlignmentHorz = taCenter
          Width = 71
        end
        object cxGrid1DBTableView1IMPORTEULTIMOPAGO: TcxGridDBColumn
          DataBinding.FieldName = 'IMPORTEULTIMOPAGO'
          HeaderAlignmentHorz = taCenter
          Width = 114
        end
        object cxGrid1DBTableView1ULTIMOPAGO: TcxGridDBColumn
    ...
    object jvCpbte: TJvRollOut
      Left = 548
      Top = 70
      Width = 339
      Height = 22
      ButtonFont.Charset = DEFAULT_CHARSET
      ButtonFont.Color = clYellow
      ButtonFont.Height = -9
      ButtonFont.Name = 'Verdana'
      ButtonFont.Style = [fsBold]
      Caption = 'Composici'#243'n Filtro'
      Collapsed = True
      Colors.ButtonBottom = clActiveCaption
      Colors.ButtonTop = clGradientInactiveCaption
      Colors.ButtonColor = clActiveCaption
      TabOrder = 8
      Visible = False
      FAWidth = 145
      FAHeight = 110
    ...
    object chFiltro: TAdvOfficeCheckBox
      Left = 709
      Top = 25
      Width = 97
      Height = 17
  ...
  object CDSSaldos: TClientDataSet
    ...
    Left = 280
    Top = 272
    object CDSSaldosCODIGO: TStringField
      DisplayLabel = 'Codigo'
      DisplayWidth = 7
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
    ...
    object CDSSaldosNOMBRE: TStringField
      DisplayLabel = 'Nombre'
      FieldName = 'NOMBRE'
      Origin = 'NOMBRE'
      ProviderFlags = []
    ...
    object CDSSaldosTOTAL: TFloatField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      Origin = 'TOTAL'
      ProviderFlags = []
    ...
    object CDSSaldosMUYVENCIDO: TFloatField
      DisplayLabel = 'Vencido +90'
      FieldName = 'MUYVENCIDO'
      Origin = 'MUYVENCIDO'
      ProviderFlags = []
      ReadOnly = True
    ...
    object CDSSaldosVENCIDO90: TFloatField
      DisplayLabel = 'Vencido 90'
      FieldName = 'VENCIDO90'
      Origin = 'VENCIDO90'
      ProviderFlags = []
    ...
    object CDSSaldosVENCIDO60: TFloatField
      DisplayLabel = 'Vencido 60'
      FieldName = 'VENCIDO60'
      Origin = 'VENCIDO60'
      ProviderFlags = []
      ReadOnly = True
    ...
    object CDSSaldosVENCIDO30: TFloatField
      DisplayLabel = 'Vencido 30'
      FieldName = 'VENCIDO30'
      Origin = 'VENCIDO30'
      ProviderFlags = []
      ReadOnly = True
    ...
    object CDSSaldosANTICIPOS: TFloatField
      DisplayLabel = 'Anticipos'
      FieldName = 'ANTICIPOS'
      Origin = 'ANTICIPOS'
      ProviderFlags = []
      ReadOnly = True
    ...
    object CDSSaldosIMPORTEULTIMOPAGO: TFloatField
      DisplayLabel = 'Imp.Ult.Pago'
    ...
    object CDSSaldosULTIMOPAGO: TSQLTimeStampField
  ...
  object frDBSaldos: TfrxDBDataset
    ...
    FieldDefs = <
      ...
      item
        FieldName = 'ULTIMOPAGO_C'
        FieldAlias = 'ULTIMOPAGO_C'
      end
      item
        FieldName = 'ULTIMOPAGO'
      ...
      item
        FieldName = 'VENCIDO30'
        FieldAlias = 'VENCIDO30'
      end
      item
        FieldName = 'VENCIDO60'
        FieldAlias = 'VENCIDO60'
      end
      item
        FieldName = 'VENCIDO90'
        FieldAlias = 'VENCIDO90'
      end
      item
        FieldName = 'MUYVENCIDO'
        FieldAlias = 'MUYVENCIDO'
      end
      item
        FieldName = 'ANTICIPOS'
        FieldAlias = 'ANTICIPOS'
      end
      item
        FieldName = 'TOTAL'
        FieldAlias = 'TOTAL'
      ...
      item
        FieldName = 'IMPORTEULTIMOPAGO'
        FieldAlias = 'IMPORTEULTIMOPAGO'
      end
      item
        FieldName = 'IMPORTEULTIMOPAGO_C'
        FieldAlias = 'IMPORTEULTIMOPAGO_C'
      end>
  end
  object frSaldos: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.795298032400000000
    ReportOptions.LastChange = 39638.795298032400000000
  ...
  object CDSEmpresa: TClientDataSet
    ...
    FieldDefs = <
      ...
      item
        Name = 'NRO_AGTE_RET_GANANCIA'
        DataType = ftString
        Size = 15
      end
      item
        Name = 'AG_RET_GANANCIA'
        Attributes = [faRequired, faFixed]
        DataType = ftString
        Size = 1
      end
      item
        Name = 'AG_RET_ING_BRUTOS'
        Attributes = [faRequired, faFixed]
        DataType = ftString
        Size = 1
      end
      item
        Name = 'AG_PERCEPCION_ING_BRUTOS'
        Attributes = [faRequired, faFixed]
        DataType = ftString
        Size = 1
      end
      item
        Name = 'TASA_PERCEPCION_IB'
        DataType = ftFloat
      end
      item
        Name = 'MINO_IMP_PERCEP_IB'
        DataType = ftFloat
      end
      item
        Name = 'PROVINCIA'
      ...
      item
        Name = 'AG_PERCEPCION_IVA'
        Attributes = [faRequired, faFixed]
        DataType = ftString
        Size = 1
      end
      item
        Name = 'MIN_IMP_PERCEPCION_IVA'
        Attributes = [faRequired]
        DataType = ftFloat
      end
      item
  ...
  object JvThread: TJvThread
    ...
    OnFinish = JvThreadFinish
    Left = 884
    Top = 344
  end
  object JvThreadTemp: TJvThread
    Exclusive = False
    MaxCount = 0
    RunOnCreate = True
    FreeOnTerminate = True
    OnExecute = JvThreadTempExecute
    Left = 876
    Top = 288
  end
  ...
  object QFiltroDet: TFDQuery
    ...
    object QFiltroDetSUCURSAL: TIntegerField
  ...
  object QArmaDatosFiltrados: TFDQuery
    Connection = FDConnThreads
    Left = 152
    Top = 168
  end
  object QSaldos: TFDQuery
    ...
    SQL.Strings = (
      ...
      '   sum(vencido_1+vencido_2+vencido_3+revencido) as Total,'
        ...
        'from SALDO_MENSUALESCLIENTES_aldia(:desde1,:desde2,:desde3,:suc,' +
        ' :vendedor, :zona,:Categoria )'
      'where (vencido_1+vencido_2+vencido_3+revencido-anticipo)<>0'
  ...
  object FDConnThreads: TFDConnection
    Params.Strings = (
      
        'Database=localhost:C:\Proyectos Delphi\GestionComercial\Tablas I' +
        'B\GESTIONV3.LAR'
      'User_Name=sysdba'
      'Password=regulador'
      'SQLDialect=1'
  ...
  object spAplicarMov: TFDStoredProc
    Connection = FDConnThreads
    StoredProcName = 'APLICA_MOV_CTACTE_TEMPORAL'
    Left = 736
    Top = 336
    ParamData = <
      item
  ...
  object QCategorias: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select  * from clientes_categorias')
    Left = 504
    Top = 488
    ...
    object QCategoriasHABILITADA: TStringField
