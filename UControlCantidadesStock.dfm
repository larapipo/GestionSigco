inherited FormControlCantidadesStock: TFormControlCantidadesStock
  Left = 311
  Top = 122
  Caption = 'Control de Min/Maximos Cantidades de Stock'
  ClientHeight = 595
  ClientWidth = 638
  ...
  inherited pnPrincipal: TPanel
    ...
    object PNcABECERA: TPanel
      ...
      object cbDepositos: TJvDBLookupCombo
        Left = 11
        Top = 26
        Width = 282
        Height = 21
  ...
  object CDSDepositoStk: TClientDataSet
    ...
    object CDSDepositoStkMUESTRADETALLE: TStringField
  ...
  object QDepos: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select Nombre,id from depositos')
    Left = 120
    Top = 440
  end
  object QDepositosStk: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      
        'select d.id_deposito,d.codigo_stk,s.detalle_stk as MuestraDetall' +
        'e,d.minimo,d.medio,d.recargo from depositostk d'
      '  left join stock s on s.codigo_stk=d.codigo_stk'
      '  where d.codigo_deposito=:CodigoDeposito and'
    ...
    object QDepositosStkID_DEPOSITO: TIntegerField
      FieldName = 'ID_DEPOSITO'
      Origin = 'ID_DEPOSITO'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QDepositosStkCODIGO_STK: TStringField
      FieldName = 'CODIGO_STK'
      Origin = 'CODIGO_STK'
      Required = True
      Size = 8
    end
    object QDepositosStkMUESTRADETALLE: TStringField
    ...
    object QDepositosStkMINIMO: TFloatField
      FieldName = 'MINIMO'
      Origin = 'MINIMO'
    end
    object QDepositosStkMEDIO: TFloatField
      FieldName = 'MEDIO'
      Origin = 'MEDIO'
    end
    object QDepositosStkRECARGO: TFloatField
      FieldName = 'RECARGO'
      Origin = 'RECARGO'
      Required = True
    end
