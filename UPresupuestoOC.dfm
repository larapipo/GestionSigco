inherited FormPresupuestoOC: TFormPresupuestoOC
  Left = 175
  Top = 90
  Caption = 'Presupuesto de Orden de Compra'
  ClientHeight = 738
  ClientWidth = 994
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnCabecera: TPanel
      ...
      object DBEdit2: TDBEdit
        ...
        Width = 90
        Height = 21
        DataField = 'FECHA_LISTA_PROVEEDOR'
        DataSource = DSBase
        Enabled = False
        TabOrder = 9
      end
      ...
      object RxDBECodigo: TJvDBComboEdit
        ...
        ButtonWidth = 16
        TabOrder = 1
        OnButtonClick = BuscaProveedorExecute
      ...
      object RxDBECondCompra: TJvDBComboEdit
        ...
        ButtonWidth = 16
        TabOrder = 3
        OnButtonClick = BuscaCondicionCompraExecute
      ...
      object RxDBRealizo: TJvDBComboEdit
        ...
        ButtonWidth = 16
        TabOrder = 6
        OnButtonClick = BuscadorEmpleadoExecute
      end
    end
    object Panel4: TPanel
      ...
      object dbgDetalle: TDBGrid
        ...
        DataSource = DatosPresupuestoOC.DSPresOC_Det
      ...
      object dbgcostos: TDBGrid
        ...
        Columns = <
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Unit. c/Dsctos. Facturables'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'MS Sans Serif'
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Unit. c/Costos Facturables'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'MS Sans Serif'
          ...
          item
            ...
            FieldName = 'UNITARIO_NETO_TOTAL_2'
            Title.Alignment = taCenter
            Title.Caption = 'Total Uni. Facturable'
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Unit.c/Dsctos. No Fac.'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'MS Sans Serif'
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Unit.c/Gastos No Fact.'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'MS Sans Serif'
          ...
          item
            ...
            FieldName = 'UNITARIO_FINAL_TOTAL_2'
            Title.Alignment = taCenter
            Title.Caption = 'Valor '#13#10'Final'
            Title.Color = 16776176
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
    ...
    object pnPieForm: TPanel
      ...
      object Label5: TLabel
        ...
        Width = 106
        Height = 13
        Caption = 'Nro. Orden de Compra'
        FocusControl = DBEdit3
      end
      object sbNoFacturables: TScrollBox
        Left = 311
        Top = 6
        Width = 306
        Height = 254
        ...
        ParentColor = False
        TabOrder = 0
        object dbgDescuentosNoFac: TDBGrid
          Left = 0
          Top = 18
          Width = 302
          Height = 90
          Align = alTop
          DataSource = DatosPresupuestoOC.DSDsctoNoFac
          TabOrder = 0
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnColEnter = dbgDescuentosNoFacColEnter
          OnKeyPress = dbgDescuentosNoFacKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'TIPO'
        ...
        object dbgOtrosGastos: TDBGrid
          Left = 0
          Top = 126
          Width = 302
          Height = 117
          Align = alTop
          DataSource = DatosPresupuestoOC.DSCostoNoFac
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnColEnter = dbgOtrosGastosColEnter
          OnKeyPress = dbgOtrosGastosKeyPress
          Columns = <
            item
              Expanded = False
              FieldName = 'TIPO'
        ...
        object pnDsctoNoFacturable: TPanel
          Left = 0
          Top = 0
          Width = 302
          Height = 18
          ...
          object Label9: TLabel
            ...
            Width = 155
            Height = 13
            Caption = 'Descuentos No Facturabes'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
      ...
      object sbFacturables: TScrollBox
        Left = 4
        Top = 6
        Width = 306
        Height = 254
        ...
        ParentColor = False
        TabOrder = 1
        object dbgDsctoFacturables: TDBGrid
          Left = 0
          Top = 18
          Width = 302
          Height = 91
          Align = alTop
          DataSource = DatosPresupuestoOC.DSDesctoFacturables
          TabOrder = 0
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnColEnter = dbgDsctoFacturablesColEnter
          OnKeyPress = dbgDsctoFacturablesKeyPress
          Columns = <
            item
              ButtonStyle = cbsEllipsis
              Expanded = False
        ...
        object dbgCostosFacturables: TDBGrid
          Left = 0
          Top = 127
          Width = 302
          Height = 118
          Align = alTop
          DataSource = DatosPresupuestoOC.DSCostosFacturables
          TabOrder = 1
          TitleFont.Charset = DEFAULT_CHARSET
          TitleFont.Color = clWindowText
          TitleFont.Height = -11
          TitleFont.Name = 'MS Sans Serif'
          TitleFont.Style = []
          OnColEnter = dbgCostosFacturablesColEnter
          OnKeyPress = dbgCostosFacturablesKeyPress
          Columns = <
            item
              ButtonStyle = cbsEllipsis
              Expanded = False
        ...
        object pnDsctoFacturable: TPanel
          Left = 0
          Top = 0
          Width = 302
          Height = 18
  ...
  inherited ActionList1: TActionList
    ...
    object BuscaCondicionCompra: TAction
      Caption = 'BuscaCondicionCompra'
      OnExecute = BuscaCondicionCompraExecute
    end
    object BuscadorEmpleado: TAction
      Caption = 'BuscadorEmpleado'
      OnExecute = BuscadorEmpleadoExecute
    end
    object BuscarArticulo: TAction
      Caption = 'BuscarArticulo'
      OnExecute = BuscarArticuloExecute
    end
    object GenerarOC: TAction
      Caption = 'Generar O de C.'
      OnExecute = GenerarOCExecute
    end
    object BuscarDscto: TAction
      Caption = 'BuscarDscto'
      OnExecute = BuscarDsctoExecute
    end
    object BuscarRec: TAction
      Caption = 'BuscarRec'
      OnExecute = BuscarRecExecute
    end
  end
  inherited DSBase: TDataSource
    DataSet = DatosPresupuestoOC.CDSPresOC_Cab
    Left = 408
  end
  ...
  inherited QUltimoCodigo: TSQLQuery
    SQL.Strings = (
      'select max(numero) from OC_CAB_EXT')
    Left = 32
    Top = 160
  end
  ...
  object CDSBuscador: TClientDataSet
    ...
    object CDSBuscadorID_OC: TIntegerField
      DisplayLabel = 'Id'
      FieldName = 'ID_OC'
      Origin = 'ID_OC'
  ...
  object ComBuscadorCondCompra: TComBuscador
    Data = DatosPresupuestoOC.CDSBuscaCondCompra
    Campo = 'codigopago'
  ...
  object ComBuscadorDescuento: TComBuscador
    Data = DatosPresupuestoOC.CDSBuscadorDscto
    Campo = 'ID'
    Titulo = 'Descuentos'
    rOk = False
    Left = 264
  ...
  object ComBuscadorVendedor: TComBuscador
    Data = DatosPresupuestoOC.CDSBuscaVendedor
    Campo = 'codigo'
    Titulo = 'Vendedores'
    rOk = False
    Left = 216
  ...
  object ComBuscadorRecargos: TComBuscador
    Data = DatosPresupuestoOC.CDSBuscadorRecargo
    Campo = 'ID'
    Titulo = 'Recargos'
    rOk = False
    Left = 208
