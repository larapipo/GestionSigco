inherited FormExportarFcComp: TFormExportarFcComp
  Left = 673
  Top = 73
  Caption = 'Exportaci'#243'n de Facturas de Compra '
  ClientHeight = 602
  ClientWidth = 658
  ...
  inherited pnPrincipal: TPanel
    ...
    object dbgFcCompCab: TDBGrid
      Left = 3
      Top = 59
      Width = 638
      Height = 97
      DataSource = DSFcCompCab
      TabOrder = 0
    ...
    object dbgFcCompDet: TDBGrid
      Left = 3
      Top = 175
      Width = 637
      Height = 105
      DataSource = DSFcCompDet
      TabOrder = 1
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
      TitleFont.Height = -11
    ...
    object dbgFcCompImpuesto: TDBGrid
      Left = 3
      Top = 299
      Width = 276
      Height = 81
      DataSource = DSFcCompImp
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object dbgRetIIBB: TDBGrid
      Left = 3
      Top = 399
      Width = 276
      Height = 64
      DataSource = DSFcCompPerIB
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object dbgRetIVA: TDBGrid
      Left = 295
      Top = 396
      Width = 271
      Height = 64
      DataSource = DSFcCompPerIva
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object CDSFcCompCab: TClientDataSet
    ...
    object CDSFcCompCabRETENCION_IVA: TFloatField
    ...
    object CDSFcCompCabCAE: TStringField
      FieldName = 'CAE'
      Required = True
      Size = 50
    end
    object CDSFcCompCabCAE_VENCIMIENTO: TSQLTimeStampField
      FieldName = 'CAE_VENCIMIENTO'
    end
    object CDSFcCompCabFACTURA_ELECTRONICA: TStringField
      FieldName = 'FACTURA_ELECTRONICA'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CDSFcCompCabCOD_OPERACION_AFIP: TSingleField
      FieldName = 'COD_OPERACION_AFIP'
    end
    object CDSFcCompCabTIPOCOMP_AFIP: TStringField
      FieldName = 'TIPOCOMP_AFIP'
      Size = 3
    end
    object CDSFcCompCabCOD_CARACT_RECP_AFIP: TIntegerField
      FieldName = 'COD_CARACT_RECP_AFIP'
    end
    object CDSFcCompCabCOD_CARACT_EMIS_AFIP: TIntegerField
      FieldName = 'COD_CARACT_EMIS_AFIP'
    end
    object CDSFcCompCabNRO_IIBB_RECEP: TStringField
      FieldName = 'NRO_IIBB_RECEP'
    end
    object CDSFcCompCabNRO_RENSPA_EMISOR: TStringField
      FieldName = 'NRO_RENSPA_EMISOR'
    end
    object CDSFcCompCabNRO_RENSPA_RECEP: TStringField
      FieldName = 'NRO_RENSPA_RECEP'
    end
    object CDSFcCompCabFECHA_OPERACION: TSQLTimeStampField
      FieldName = 'FECHA_OPERACION'
    end
    object CDSFcCompCabLUGAR_REALIZA_AFIP: TStringField
      FieldName = 'LUGAR_REALIZA_AFIP'
      Size = 30
    end
    object CDSFcCompCabCOD_MOTIVO_AFIP: TIntegerField
      FieldName = 'COD_MOTIVO_AFIP'
    end
    object CDSFcCompCabNRO_RUCA_EMISOR_AFIP: TSingleField
      FieldName = 'NRO_RUCA_EMISOR_AFIP'
    end
    object CDSFcCompCabNRO_RUCA_RECEPTOR_AFIP: TSingleField
      FieldName = 'NRO_RUCA_RECEPTOR_AFIP'
    end
    object CDSFcCompCabFECHA_FAENA_AFIP: TSQLTimeStampField
      FieldName = 'FECHA_FAENA_AFIP'
    end
    object CDSFcCompCabFECHA_RECEP_AFIP: TSQLTimeStampField
      FieldName = 'FECHA_RECEP_AFIP'
    end
    object CDSFcCompCabDATOS_ADIC_AFIP: TStringField
      FieldName = 'DATOS_ADIC_AFIP'
      Size = 100
    end
    object CDSFcCompCabFECHA_INCIO_ACTIV: TSQLTimeStampField
      FieldName = 'FECHA_INCIO_ACTIV'
    end
    object CDSFcCompCabCODIGOBARRA_AFIP: TStringField
      FieldName = 'CODIGOBARRA_AFIP'
      Size = 40
    end
    object CDSFcCompCabCUIT_AUTORIZADO: TStringField
      FieldName = 'CUIT_AUTORIZADO'
      Size = 13
    end
    object CDSFcCompCabNOMBRE_AUTORIZADO: TStringField
      FieldName = 'NOMBRE_AUTORIZADO'
      Size = 50
    end
    object CDSFcCompCabTIPO_LIQUIDACION: TStringField
      FieldName = 'TIPO_LIQUIDACION'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CDSFcCompCabCUIT_AUTORIZADO_RECEP: TStringField
      FieldName = 'CUIT_AUTORIZADO_RECEP'
      Size = 13
    end
    object CDSFcCompCabID_CPBTE_ANULADO_LIQ: TIntegerField
  ...
  object CDSFcCompDet: TClientDataSet
    ...
    object CDSFcCompDetDETALLE_ADICIONAL: TStringField
    ...
    object CDSFcCompDetCONTROL_TRAZABILIDAD: TStringField
      FieldName = 'CONTROL_TRAZABILIDAD'
      Required = True
      FixedChar = True
      Size = 1
    end
    object CDSFcCompDetCANTIDAD_UNIDADES: TFloatField
      FieldName = 'CANTIDAD_UNIDADES'
      Required = True
    end
    object CDSFcCompDetPRESENTACION_CANT: TFloatField
      FieldName = 'PRESENTACION_CANT'
      Required = True
    end
    object CDSFcCompDetTIPO_LIQUI: TIntegerField
      FieldName = 'TIPO_LIQUI'
    end
    object CDSFcCompDetCODIGO_RAZA: TIntegerField
      FieldName = 'CODIGO_RAZA'
    end
    object CDSFcCompDetDETALLE_RAZA: TStringField
      FieldName = 'DETALLE_RAZA'
      Size = 40
    end
    object CDSFcCompDetTROPA: TIntegerField
      FieldName = 'TROPA'
    end
    object CDSFcCompDetCABEZAS: TIntegerField
      FieldName = 'CABEZAS'
    end
    object CDSFcCompDetRUBRO: TStringField
      FieldName = 'RUBRO'
      ReadOnly = True
      Size = 3
    end
    object CDSFcCompDetSUBRUBRO: TStringField
      FieldName = 'SUBRUBRO'
      ReadOnly = True
      Size = 5
    end
    object CDSFcCompDetMARCA_STK: TStringField
      FieldName = 'MARCA_STK'
      ReadOnly = True
      Size = 4
    end
    object CDSFcCompDetMUESTRARUBRO: TStringField
      FieldName = 'MUESTRARUBRO'
      ReadOnly = True
      Size = 35
    end
    object CDSFcCompDetMUESTRASUBRUBRO: TStringField
      FieldName = 'MUESTRASUBRUBRO'
      ReadOnly = True
      Size = 45
    end
    object CDSFcCompDetMUESTRAMARCA: TStringField
  ...
  object QFcCompDet: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select d.*, s.rubro_stk as rubro, s.subrubro_stk as subrubro, s.' +
        'marca_stk, '
      ...
      'where id_cabfac between :id_desde and :id_hasta')
    Left = 40
    Top = 192
    ParamData = <
      item
