inherited FormListadoCpbteCompPorTipo: TFormListadoCpbteCompPorTipo
  Left = 431
  Top = 170
  Caption = 'Listado Cpbte de Compra Por Tipo de Comprobante'
  ClientHeight = 628
  ClientWidth = 718
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnCabecera: TPanel
      ...
      object chbTodosLosProv: TAdvOfficeCheckBox
        Left = 424
        Top = 70
        Width = 145
        Height = 17
  ...
  object frDBFcPerIva: TfrxDBDataset
    UserName = 'frDBFcPerIva'
    CloseDataSource = False
  ...
  object frDBFcIIBB: TfrxDBDataset
    UserName = 'frDBFcIIBB'
    CloseDataSource = False
  ...
  object CDSFacCab: TClientDataSet
    ...
    object CDSFacCabCONDICIONCOMPRA: TIntegerField
      FieldName = 'CONDICIONCOMPRA'
    ...
    object CDSFacCabORDENCOMPRA: TStringField
      FieldName = 'ORDENCOMPRA'
      Origin = 'ORDENCOMPRA'
      Size = 8
    end
    object CDSFacCabAPLICA: TStringField
      FieldName = 'APLICA'
      Origin = 'APLICA'
      Size = 13
    end
    ...
    object CDSFacCabSUCURSALCOMPRA: TIntegerField
      FieldName = 'SUCURSALCOMPRA'
    ...
    object CDSFacCabCPBTE_INTERNO: TStringField
      FieldName = 'CPBTE_INTERNO'
    ...
    object CDSFacCabTIPO_PROVEEDOR: TStringField
      FieldName = 'TIPO_PROVEEDOR'
      Origin = 'TIPO_PROVEEDOR'
      FixedChar = True
      Size = 1
    end
    object CDSFacCabJURIDICCION: TIntegerField
      FieldName = 'JURIDICCION'
      Origin = 'JURIDICCION'
    end
    ...
    object CDSFacCabIMPORTEEXCLUIDO2: TFloatField
      FieldName = 'IMPORTEEXCLUIDO2'
      Origin = 'IMPORTEEXCLUIDO2'
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSFacCabIMPORTEEXCLUIDO1: TFloatField
      FieldName = 'IMPORTEEXCLUIDO1'
    ...
    object CDSFacCabNETOMONOTRIBUTO1: TFloatField
      FieldName = 'NETOMONOTRIBUTO1'
      Origin = 'NETOMONOTRIBUTO1'
      DisplayFormat = ';-,0.00;-'
    end
    object CDSFacCabNETOMONOTRIBUTO2: TFloatField
      FieldName = 'NETOMONOTRIBUTO2'
    ...
    object CDSFacCabRETENCION_IVA: TFloatField
      FieldName = 'RETENCION_IVA'
      Origin = 'RETENCION_IVA'
      Required = True
      DisplayFormat = ',0.00;-,0.00;-'
    end
    object CDSFacCabTOTAL_UNIDADES: TFloatField
      FieldName = 'TOTAL_UNIDADES'
    ...
    object CDSFacCabFECHACOMPRA: TSQLTimeStampField
      DisplayLabel = 'Fecha'
      FieldName = 'FECHACOMPRA'
      Origin = 'FECHACOMPRA'
      Required = True
    ...
    object CDSFacCabFECHAFISCAL: TSQLTimeStampField
      FieldName = 'FECHAFISCAL'
      Origin = 'FECHAFISCAL'
      Required = True
    end
  ...
  object CDSFacDet: TClientDataSet
    ...
    object CDSFacDetFECHACOMPRA: TSQLTimeStampField
      FieldName = 'FECHACOMPRA'
      Required = True
    end
    ...
    object CDSFacDetCODIGOPROVEEDOR: TStringField
      FieldName = 'CODIGOPROVEEDOR'
      Required = True
      Size = 6
    end
    object CDSFacDetRENGLON: TFMTBCDField
      FieldName = 'RENGLON'
      Precision = 15
      Size = 3
    end
    ...
    object CDSFacDetCANTIDAD: TFMTBCDField
      DisplayLabel = 'Cant.'
      FieldName = 'CANTIDAD'
      Required = True
      Precision = 15
    ...
    object CDSFacDetIVA_TASA: TFMTBCDField
      FieldName = 'IVA_TASA'
      Precision = 15
      Size = 3
    end
    ...
    object CDSFacDetIVA_SOBRETASA: TFMTBCDField
      FieldName = 'IVA_SOBRETASA'
      Precision = 15
      Size = 3
    end
    ...
    object CDSFacDetDESCUENTO: TFMTBCDField
      DisplayLabel = 'Dscto.'
      FieldName = 'DESCUENTO'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    ...
    object CDSFacDetTOTAL: TFMTBCDField
      DisplayLabel = 'Total'
      FieldName = 'TOTAL'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
    ...
    object CDSFacDetMARGEN: TFMTBCDField
      FieldName = 'MARGEN'
      Precision = 15
      Size = 3
    end
    ...
    object CDSFacDetCOSTO_IMP_INTERNO: TFMTBCDField
      FieldName = 'COSTO_IMP_INTERNO'
      Precision = 15
      Size = 3
    end
    object CDSFacDetUNIDADES_IMP_INTERNOS: TFMTBCDField
      FieldName = 'UNIDADES_IMP_INTERNOS'
      Precision = 15
      Size = 3
    end
    object CDSFacDetUNITARIO_IMP_INTERNO: TFMTBCDField
      FieldName = 'UNITARIO_IMP_INTERNO'
      Precision = 15
      Size = 3
    end
    ...
    object CDSFacDetID_RECEPCION_CAB: TIntegerField
      FieldName = 'ID_RECEPCION_CAB'
    end
    object CDSFacDetID_RECEPCION_DET: TIntegerField
      FieldName = 'ID_RECEPCION_DET'
    end
    object CDSFacDetNRORECEPCION: TStringField
      FieldName = 'NRORECEPCION'
      Size = 13
    end
    ...
    object CDSFacDetCOTIZACION: TFMTBCDField
      FieldName = 'COTIZACION'
      Precision = 15
      Size = 3
    end
    object CDSFacDetMUESTRAMONEDA: TStringField
      FieldName = 'MUESTRAMONEDA'
      Size = 5
    end
  ...
  object CDSFcImpuesto: TClientDataSet
    ...
    object CDSFcImpuestoID_FCCOMPCAB: TIntegerField
      FieldName = 'ID_FCCOMPCAB'
      Required = True
    end
    object CDSFcImpuestoNETO: TFMTBCDField
      FieldName = 'NETO'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
      Precision = 15
    ...
    object CDSFcImpuestoTASA: TFMTBCDField
      FieldName = 'TASA'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
      Precision = 15
    ...
    object CDSFcImpuestoIMPORTE: TFMTBCDField
      FieldName = 'IMPORTE'
      DisplayFormat = ',0.00'
      EditFormat = ',0.00'
      Precision = 15
  ...
  object DSPFcImpuestos: TDataSetProvider
  ...
  object QFacCab: TFDQuery
    ...
    SQL.Strings = (
      'select f.*,s.detalle as MuestraSucursal from fcCompCab f'
      ...
      '       ( f.sucursalcompra = :sucursal or :sucursal = -1 ) and'
      
        '        f.fechaCompra between :desde and :hasta and f.anulado<>'#39 +
        'S'#39
      
        'order by f.sucursalcompra,f.tipocpbte,f.clasecpbte, f.letrafac,f' +
        '.sucfac,f.numerofac')
    Left = 256
    Top = 168
    ParamData = <
  ...
  object QProveedor: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'select * from poveedor p where p.codigo=:codigo')
    Left = 216
    Top = 40
    ParamData = <
      item
    ...
    object QProveedorCOD_POSTAL: TStringField
      FieldName = 'COD_POSTAL'
      Origin = 'COD_POSTAL'
      Size = 8
    end
    object QProveedorLOCALIDAD: TStringField
      FieldName = 'LOCALIDAD'
      Origin = 'LOCALIDAD'
      Size = 15
    end
    object QProveedorDIRECCION: TStringField
      FieldName = 'DIRECCION'
      Origin = 'DIRECCION'
      Size = 35
    end
    object QProveedorTELEFONO_1: TStringField
