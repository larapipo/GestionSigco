inherited FormListadoRetencionesGanancias: TFormListadoRetencionesGanancias
  Left = 202
  Top = 120
  Caption = 'Listado Retenciones de Ganancias a Proveedores'
  ClientHeight = 610
  ClientWidth = 936
  ...
  inherited pnPrincipal: TPanel
    ...
    object rgEstado: TAdvOfficeRadioGroup
      Left = 472
      Top = 0
      Width = 185
      Height = 73
  ...
  inherited ToolBar1: TToolBar
    ...
    object BitBtn1: TBitBtn
      ...
      Width = 128
      Height = 29
      Action = MaracarLiquidadas
      Caption = 'Liq. Retenciones'
      Glyph.Data = {
  ...
  inherited ActionList1: TActionList
    ...
    object ExportarTxt: TAction
      Caption = 'Exportar en Txt'
      OnExecute = ExportarTxtExecute
    end
    object MaracarLiquidadas: TAction
      Caption = 'Liq. Retenciones'
      Hint = 'Liquidar retenciones '
      OnExecute = MaracarLiquidadasExecute
    end
    object ExportarXLS: TAction
      Caption = 'Exportar a XLS'
      OnExecute = ExportarXLSExecute
    end
    object ExportarSICORE: TAction
      Caption = 'Exportar SICORE'
      OnExecute = ExportarSICOREExecute
    end
    object DepurarCeros: TAction
      Hint = 'Depurar Movimientos en Cero'
      OnExecute = DepurarCerosExecute
    end
    object DesmarcarLiq: TAction
      Caption = 'Desmarcar Liquidadas las Ret.Selecionadas'
      OnExecute = DesmarcarLiqExecute
    end
  end
  ...
  object frConsulta: TfrxReport
    ...
    ReportOptions.CreateDate = 39638.830897164350000000
    ReportOptions.LastChange = 39638.830897164350000000
  ...
  object frDBDRetenciones: TfrxDBDataset
    ...
    FieldDefs = <
      ...
      item
        FieldName = 'NUMEROOPAGO'
        FieldAlias = 'NUMEROOPAGO'
      end
      item
        FieldName = 'NOMBREOPAGO'
        FieldAlias = 'NOMBREOPAGO'
      end
      item
        FieldName = 'CUIT'
        FieldAlias = 'CUIT'
      ...
      item
        FieldName = 'PREFIJOOPAGO'
        FieldAlias = 'PREFIJOOPAGO'
      end
      item
        FieldName = 'TIPOIVA'
        FieldAlias = 'TIPOIVA'
      ...
      item
        FieldName = 'IMPORTEOPAGO'
        FieldAlias = 'IMPORTEOPAGO'
      end
      item
        FieldName = 'FECHARETENCION'
      ...
      item
        FieldName = 'FECHAOPAGO'
        FieldAlias = 'FECHAOPAGO'
      end
      item
  ...
  object DataToTxt: TDataToAscii
    DataSet = CDSRetGan
    Quote = #0
    Fields = <
      item
        DataField = 'FECHARETENCION'
        Title = 'FECHARETENCION'
        FixedLength = 34
      end
      item
        DataField = 'NUMERO_RETENCION'
        Title = 'NUMERO_RETENCION'
        FixedLength = 14
      end
      item
        DataField = 'CODIGO_REGIMEN'
        Title = 'CODIGO_REGIMEN'
        FixedLength = 10
      ...
      item
        ...
        Title = 'IMPUESTO_RETENIDO'
        FixedLength = 16
        Alignment = taRightJustify
      end
      item
        DataField = 'MINIMO_NO_IMPONIBLE'
        Title = 'MINIMO_NO_IMPONIBLE'
        FixedLength = 16
        Alignment = taRightJustify
      end
      item
      ...
      item
        DataField = 'FECHAOPAGO'
        Title = 'FECHAOPAGO'
        FixedLength = 34
      end
      item
        DataField = 'NUMEROOPAGO'
        Title = 'NUMEROOPAGO'
        FixedLength = 8
      end
      item
        DataField = 'IMPORTEOPAGO'
        Title = 'IMPORTEOPAGO'
        FixedLength = 16
        Alignment = taRightJustify
      end
      item
        DataField = 'NOMBREOPAGO'
        Title = 'NOMBREOPAGO'
        FixedLength = 35
      end
      item
  ...
  object PopupMenu: TPopupMenu
    ...
    object DesmarcarLiq1: TMenuItem
      Action = DesmarcarLiq
    end
  end
  object SaveDialog: TSaveDialog
    DefaultExt = 'TXT'
    Title = 'Exportacion TXT'
    Left = 248
    Top = 232
  end
  ...
  object CDSRetGan: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftDate
    ...
    ProviderName = 'DSPRetGan'
    AfterPost = CDSRetGanAfterPost
    OnCalcFields = CDSRetGanCalcFields
    Left = 528
    Top = 152
    object CDSRetGanID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object CDSRetGanNUMERO_RETENCION: TStringField
      FieldName = 'NUMERO_RETENCION'
    ...
    object CDSRetGanCODIGO_REGIMEN: TIntegerField
      FieldName = 'CODIGO_REGIMEN'
      Origin = 'CODIGO_REGIMEN'
      Required = True
    end
    object CDSRetGanCONCEPTO: TStringField
      FieldName = 'CONCEPTO'
      Origin = 'CONCEPTO'
      ProviderFlags = []
      Size = 25
    end
    object CDSRetGanANULADA: TStringField
      FieldName = 'ANULADA'
      Origin = 'ANULADA'
      ProviderFlags = []
      Required = True
    ...
    object CDSRetGanESTADO: TStringField
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
      ProviderFlags = []
      Required = True
    ...
    object CDSRetGanNUMEROOPAGO: TStringField
      FieldName = 'NUMEROOPAGO'
      Origin = 'NUMEROOP'
      ProviderFlags = []
      Size = 8
    end
    object CDSRetGanNOMBREOPAGO: TStringField
      FieldName = 'NOMBREOPAGO'
      Origin = 'NOMBRE'
      ProviderFlags = []
      Size = 35
    end
    object CDSRetGanCUIT: TStringField
      FieldName = 'CUIT'
      Origin = 'CUIT'
      ProviderFlags = []
      Size = 13
    end
    object CDSRetGanPREFIJOOPAGO: TStringField
      FieldName = 'PREFIJOOPAGO'
      Origin = 'SUCOP'
      ProviderFlags = []
      Size = 4
    end
    object CDSRetGanTIPOIVA: TIntegerField
      FieldName = 'TIPOIVA'
      Origin = 'TIPOIVA'
      ProviderFlags = []
    end
    object CDSRetGanBCALCULO: TFloatField
      FieldName = 'BCALCULO'
      Origin = 'BCALCULO'
      ProviderFlags = []
    end
    object CDSRetGanBASECALCULO: TFloatField
    ...
    object CDSRetGanIMPUESTO_RETENIDO: TFloatField
      DisplayLabel = 'Imp.Retenido'
      FieldName = 'IMPUESTO_RETENIDO'
      Origin = 'IMPUESTO_RETENIDO'
    end
    object CDSRetGanMINIMO_NO_IMPONIBLE: TFloatField
      DisplayLabel = 'Min.No Impon.'
      FieldName = 'MINIMO_NO_IMPONIBLE'
      Origin = 'MINIMO_NO_IMPONIBLE'
    end
    object CDSRetGanTASA: TFloatField
      DisplayLabel = '% Tasa'
      FieldName = 'TASA'
      Origin = 'TASA'
    end
    object CDSRetGanIMPORTEOPAGO: TFloatField
      DisplayLabel = 'Imp.O.Pago'
      FieldName = 'IMPORTEOPAGO'
      Origin = 'TOTAL'
      ProviderFlags = []
      ReadOnly = True
    end
    object CDSRetGanFECHARETENCION: TSQLTimeStampField
      DisplayLabel = 'Fecha Ret.'
      FieldName = 'FECHARETENCION'
      Origin = 'FECHA'
      Required = True
    end
    object CDSRetGanFECHAOPAGO: TSQLTimeStampField
    ...
    object CDSRetGanRAZON_SOCIAL: TStringField
      FieldName = 'RAZON_SOCIAL'
      ReadOnly = True
      Size = 35
    end
    object CDSRetGanID_OP: TIntegerField
      FieldName = 'ID_OP'
      ReadOnly = True
    end
  end
  object DSPRetGan: TDataSetProvider
    DataSet = QRetGan
    Left = 432
    Top = 152
  end
  object QRetGan: TFDQuery
    ...
    SQL.Strings = (
      'select rg.id, rg.fecha as FechaRetencion,rg.numero_retencion,'
      '       rg.codigo_regimen,rg.concepto,rg.impuesto_retenido,'
      '       rg.minimo_no_imponible,rg.tasa,rg.anulada,rg.estado,'
      
        '       op.fecha as FechaOPago,op.numeroop as NumeroOPago,op.suco' +
        'p as PrefijoOPago,'
      '       op.total as ImporteOPago,op.nombre as NombreOPago,'
      
        '       op.cuit,(op.Total_neto_gravado + op.Total_pagos_del_mes -' +
        ' MINIMO_NO_IMPONIBLE_GANANCIA) as BCalculo,'
      
        '       op.TipoIva,p.razon_social,op.id_op  from retenciones_gana' +
        'ncia rg'
      'left join ordenpago op on rg.id_op=op.id_op'
      'left join poveedor p on p.codigo=op.codigo'
      'where rg.fecha between :desde and :hasta and rg.anulada='#39'N'#39' '
      'and ( rg.estado = :estado or :estado = '#39'*'#39' )')
    Left = 352
    Top = 144
    ParamData = <
      item
  ...
  object QDesmaracaLiquidad: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'update retenciones_ganancia r set r.estado='#39'P'#39' where'
      '    r.id = :id')
    Left = 808
    Top = 144
    ParamData = <
  ...
  object QDepurar: TFDQuery
    Connection = DMMain_FD.fdcGestion
    SQL.Strings = (
      'delete from retenciones_ganancia r where r.impuesto_retenido<=0')
    Left = 816
    Top = 272
  end
  object spMarcarLiquidadas: TFDStoredProc
    Connection = DMMain_FD.fdcGestion
    ...
    StoredProcName = 'MARCAR_RET_GANANCIA_LIQUIDADA'
    Left = 720
    Top = 336
    ParamData = <
      item
