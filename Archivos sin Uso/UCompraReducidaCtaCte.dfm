inherited FormCompraCtaCteReducida: TFormCompraCtaCteReducida
  Left = 367
  Top = 115
  Caption = 'Comprobante de Compra Reducido'
  ClientHeight = 541
  ClientWidth = 684
  OldCreateOrder = True
  ExplicitWidth = 702
  ...
  inherited pnPrincipal: TPanel
    ...
    object pnDetalle: TPanel
      ...
      object dbgPercepcionIVA: TDBGrid
        ...
        OnEditButtonClick = dbgPrecepcionIVAEditButtonClick
      ...
      object dbgPercepcionIB: TDBGrid
        ...
        TitleFont.Name = 'MS Sans Serif'
        TitleFont.Style = []
        OnColEnter = dbgPrecepcionIBColEnter
  ...
  inherited ImageList1: TImageList
    Bitmap = {
      494C01010A000C00600010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object wwBuscadorSucursal: TwwLookupDialog
    ...
    LookupTable = DatosCompraReducida.CDSBuscaSucursal
    Caption = 'Sucursal'
    MaxWidth = 0
    MaxHeight = 209
  ...
  object wwLookupCondCompra: TwwLookupDialog
    Selected.Strings = (
  ...
  object wwBuscadorComprobantes: TwwLookupDialog
    ...
    LookupTable = DatosCompraReducida.QBuscaComprob
  ...
  object BuscadorPercepcionIva: TwwLookupDialog
    Selected.Strings = (
      'CODIGO'#9'10'#9'Codigo'#9'F'
      'DESCRIPCION'#9'20'#9'Descripci'#243'n'#9'F'
      'MINIMOAPLICABLE'#9'10'#9'Min.Imponible'#9'F'
      'TASA'#9'10'#9'%'#9'F')
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
  ...
  object BuscadorPercepcionIB: TwwLookupDialog
    Selected.Strings = (
      'CODIGO'#9'10'#9'Codigo'#9'F'
      'DESCRIPCION'#9'20'#9'Descripci'#243'n'#9'F'
      'MINIMOAPLICABLE'#9'10'#9'Min.Imponible'#9'F'
