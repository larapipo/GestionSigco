object FormLeerPDF: TFormLeerPDF
  ...
  object pnPie: TPanel
    ...
    DesignSize = (
      1154
      41)
    object acProgress: TAdvCircularProgress
      Left = 690
      Top = 2
      Width = 41
      Height = 36
      ...
      Appearance.ProgressSegmentColor = clMoneyGreen
      Interval = 100
      ExplicitLeft = 686
    end
  ...
  object pnPDF: TPanel
    ...
    object AdvPDFViewer1: TAdvPDFViewer
      ...
      Options.HeaderSize = 5.000000000000000000
      ...
      ZoomFactor = 1.200000047683716000
    end
  end
  ...
  object OpenDialog1: TOpenDialog
    Filter = 'PDF files|*.pdf|Imagenes|*.jpg;*.png'
    Left = 872
    Top = 320
  end
  ...
  object mtComprobante: TFDMemTable
  ...
  object mtTransporte: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
  ...
  object mtObservaciones: TFDMemTable
    FetchOptions.AssignedValues = [evMode]
    FetchOptions.Mode = fmAll
    ResourceOptions.AssignedValues = [rvSilentMode]
    ResourceOptions.SilentMode = True
