inherited FormFacModelo: TFormFacModelo
  Left = 419
  Top = 131
  Caption = 'Modelo de Factura'
  ClientHeight = 667
  ClientWidth = 696
    ...
    object pcDetalleFactura: TPageControl
      ...
      object PagDetalles: TTabSheet
        ...
        object DBGrillaDetalle: TDBGrid
          ...
          Width = 681
          Height = 130
          DataSource = DatosModelo.DSVentaDet
        ...
        object dbcGrupo: TDBLookupComboBox
          Left = 8
          Top = 154
          Width = 215
          Height = 21
          ...
          KeyField = 'ID'
          ListField = 'DETALLE'
          ListSource = DatosModelo.DSListaGrupo
          TabOrder = 1
        end
      end
      object PagPieCpbte: TTabSheet
        ...
        object DBGrillaIva: TDBGrid
          ...
          Height = 68
          Color = clMenu
          DataSource = DatosModelo.DSImpuestos
  ...
  inherited DSBase: TDataSource
    DataSet = DatosModelo.CDSModeloCab
    Left = 608
    Top = 216
  end
  ...
  object ComBuscadorConVta: TComBuscador
    Data = DatosModelo.CDSBuscaCondVenta
    Campo = 'CODIGOPAGO'
  ...
  object ComBuscadorDeposito: TComBuscador
    Data = DatosModelo.CDSBuscaDeposito
    Campo = 'ID'
    Titulo = 'Depositos'
    rOk = False
    Left = 332
  ...
  object ComBuscadorSucursal: TComBuscador
    Data = DatosModelo.CDSBuscaSucursal
    Campo = 'CODIGO'
    Titulo = 'Sucursal'
    rOk = False
    Left = 396
  ...
  object ComBuscadorVendedor: TComBuscador
    Data = DatosModelo.CDSBuscaVendedor
    Campo = 'CODIGO'
    Id = 'CODIGO'
    Titulo = 'Vendedores'
    rOk = False
  ...
  object ComBuscadorComprobantes: TComBuscador
    Data = DatosModelo.CDSBuscaComprob
    Campo = 'ID_COMPROBANTE'
    Titulo = 'Busca Comprobantes'
    rOk = False
    Left = 404
    Top = 325
  end
  object ComBuscadorLdr: TComBuscador
    Data = DatosModelo.CDSBuscaLdr
    Campo = 'CODIGO_LDR'
    Titulo = 'Ldr'
    rOk = False
    Left = 160
