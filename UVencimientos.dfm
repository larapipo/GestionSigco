inherited FormVencimientos: TFormVencimientos
  Left = 58
  Top = 81
    ...
    object PageControl1: TPageControl
      ...
      object Mensual: TTabSheet
        ...
        object DBPlannerMonthView1: TDBPlannerMonthView
          ...
          CaptionColorTo = 15590880
          CaptionGradientDirection = gdVertical
          CaptionHoverColor = clGradientInactiveCaption
          CaptionFont.Charset = ANSI_CHARSET
          CaptionFont.Color = clBlack
          CaptionFont.Height = -16
          CaptionFont.Name = 'Arial Rounded MT Bold'
          CaptionFont.Style = []
          CaptionHeight = 11
          Color = clWhite
          ColorCurrent = clCream
          ...
          DayFont.Height = -15
          DayFont.Name = 'Arial Rounded MT Bold'
          DayFont.Style = []
          DayFont.Quality = fqClearTypeNatural
          DefaultItem.Alarm.Active = True
          DefaultItem.Alarm.NotifyType = anMessage
          DefaultItem.BorderColor = clSkyBlue
          DefaultItem.CaptionAlign = taRightJustify
          DefaultItem.CaptionBkg = clGradientInactiveCaption
          DefaultItem.CaptionBkgTo = 15590880
          DefaultItem.CaptionBkgDirection = gdVertical
          DefaultItem.CaptionFont.Charset = DEFAULT_CHARSET
          DefaultItem.CaptionFont.Color = clBlue
          ...
          DefaultItem.Color = 15263976
          DefaultItem.ColorTo = 13749190
          ...
          DefaultItem.SelectColorTo = clSilver
          DefaultItem.SelectFontColor = clBlue
          ...
          HintPrevYear = 'Previo'
          HintPrevMonth = 'Previo'
          HintNextMonth = 'Proximo'
          HintNextYear = 'Proximo'
          InActiveColor = 14598569
          InversColor = 11370846
          InversBkColor = 16248294
          Items = <>
          ItemSpace = 0
          LineColor = 15524056
          Line3D = False
          MaxItemsDisplayed = 4
          MonthGradientStartColor = 15591909
          MonthGradientEndColor = 15591909
          ...
          OnItemMoving = DBPlannerMonthView1ItemMoving
          OnDaySelect = DBPlannerMonthView1DaySelect
          DataBinding.StartTimeField = 'FECHA_INCIO'
          DataBinding.EndTimeField = 'FECHA_INCIO'
          DataBinding.KeyField = 'ID'
          DataBinding.NotesField = 'ASUNTO_2'
          DataBinding.SubjectField = 'ASUNTO'
          DataBinding.UpdateByQuery = True
          DataSource = DSVencimientos
          OnFieldsToItem = DBPlannerMonthView1FieldsToItem
          TMSStyle = 8
        end
        object DBPlannerDia: TDBPlanner
          Left = 0
          Top = 0
          Width = 286
          Height = 622
          ...
          AttachementGlyph.Data = {
            ...
            8888888888808880888888888888000888888888888888888888}
          Bands.Show = True
          Bands.ActivePrimary = clWhite
          Bands.ActiveSecondary = clWhite
          Bands.NonActivePrimary = clWhite
          Bands.NonActiveSecondary = clWhite
          ...
          DayNames.Strings = (
            ...
            'Sab'
            'Dom')
          DefaultItem.BorderColor = 13948116
          ...
          DefaultItem.ItemPos = 0
          DefaultItem.Name = 'PlannerItem0'
          DefaultItem.SelectColor = 16573128
          DefaultItem.SelectColorTo = 16573128
          DefaultItem.SelectFontColor = clBlack
          DefaultItem.Shadow = False
          DefaultItem.TrackColor = 15381630
          DefaultItem.TrackSelectColor = 15048022
          DeleteGlyph.Data = {
            36050000424D3605000000000000360400002800000010000000100000000100
            0800000000000001000000000000000000000001000000000000000000000000
            80000080000000808000800000008000800080800000C0C0C000C0DCC000F0CA
          ...
          Display.BrushNonSelect = bsClear
          Display.CurrentPosFrom = 45106
          Display.CurrentPosTo = 45106
          ...
          Sidebar.LineColor = 13948116
          Sidebar.Occupied = 14327846
          Sidebar.OccupiedTo = 14327846
          Sidebar.OccupiedFontColor = clBlack
          Sidebar.SeparatorLineColor = 13948116
          ...
          ShowOccupiedInPositionGap = False
          ShowSelection = False
          TrackColor = 15658734
          URLGlyph.Data = {
            F6000000424DF600000000000000760000002800000010000000100000000100
        ...
        object Memo1: TMemo
          ...
          Lines.Strings = (
              ...
              'select v.id, v.fecha_incio, v.fecha_finalizacion, v.asunto, v.as' +
              'unto_2, cast(v.finalizado '
            'as varchar(1)) as Finalizado , v.importe,'
            
              '       v.id_cpbte,v.tipo_cpbte,v.clase_cpbte,v.nrocpbte,v.estado' +
              ' from vencimientos v '
            'where v.estado=:estado or :estado=-1'
            'union'
            
              'select f.id_movcccompra,f.fechavto , f.fechacompra, p.nombre,'#39#39' ' +
              'asunto_2,Cast('#39'N'#39' as '
            'varchar(1)) as Finalizado, f.saldo,'
            
              '       f.id_cpbte,f.tipocpbte,f.clasecpbte,f.nrocpbte,-1 as esta' +
              'do from movcccompra f'
            '  left join poveedor p on p.codigo=f.proveedor'
            'where f.tipocpbte in ('#39'FC'#39','#39'ND'#39') and f.saldo>0')
          TabOrder = 2
          Visible = False
        end
      end
      object TabSheet2: TTabSheet
        ...
        object DBPlanner1: TDBPlanner
          ...
          AttachementGlyph.Data = {
            ...
            8888888880808080888888888080808088888888808080808888888888808080
            8888888888808880888888888888000888888888888888888888}
          AutoPositionPrevNext = True
          Caption.Title = 'Vencimientos '
          Caption.Font.Charset = DEFAULT_CHARSET
          Caption.Font.Color = clBlack
          Caption.Font.Height = -13
          Caption.Font.Name = 'Verdana'
          ...
          DayNames.Strings = (
            ...
            'Fri'
            'Sat')
          DefaultItem.CaptionBkg = clSkyBlue
          ...
          Display.DisplayScale = 60
          Display.DisplayUnit = 40
          Display.ColorActive = 16575452
          Display.ColorNonActive = clWhite
          Display.HourLineColor = 13542013
          EditScroll = ssHorizontal
          EnableFlashing = True
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          ...
          Mode.PeriodEndYear = 2018
          Mode.PlannerType = plMultiMonth
          Mode.TimeLineStart = 43095.000000000000000000
          Mode.TimeLineNVUBegin = 0
          Mode.TimeLineNVUEnd = 0
          Mode.Year = 2017
          Mode.Day = 26
          ...
          URLGlyph.Data = {
            ...
            888887F8F8222208888888776888208888888887777778888888}
          Version = '3.4.6.1'
          ItemSource = DBMultiMonthSource1
          TMSStyle = 0
        end
      end
      object TabSheet1: TTabSheet
        Caption = 'Listado de Vencimientos'
        DesignSize = (
          1252
          622)
        ...
        object DBAdvGrid1: TDBAdvGrid
          ...
          FloatFormat = ',0.00'
          Grouping.HeaderColorTo = clGradientInactiveCaption
      ...
      object TabSheet3: TTabSheet
        ...
        object DBPlanner2: TDBPlanner
          ...
          Display.CurrentPosFrom = 45084
          Display.CurrentPosTo = 45084
          Display.ColorActive = 16575452
          Display.ColorNonActive = clWhite
          Display.HourLineColor = 13542013
          Font.Charset = DEFAULT_CHARSET
          ...
          Items = <>
          Mode.Month = 12
          Mode.PeriodStartDay = 7
          Mode.PeriodStartMonth = 6
          Mode.PeriodStartYear = 2023
          Mode.PeriodEndDay = 25
          Mode.PeriodEndMonth = 7
          Mode.PeriodEndYear = 2023
          Mode.TimeLineStart = 45084.000000000000000000
          Mode.TimeLineNVUBegin = 0
          Mode.TimeLineNVUEnd = 0
          Mode.Year = 1899
          Mode.Day = 30
  ...
  inherited ToolBar1: TToolBar
    ...
    object chConCompras: TCheckBox
      Left = 777
      Top = 0
      Width = 97
      Height = 29
      Caption = 'Incluir Compras'
      TabOrder = 8
    end
  end
  ...
  inherited ActionList1: TActionList
    Top = 112
    object Inserta: TAction
      ImageIndex = 1
      OnExecute = InsertaExecute
    end
    object VerVencimiento: TAction
      Caption = 'VerVencimiento'
      OnExecute = VerVencimientoExecute
    end
  end
  ...
  inherited QUltimoCodigo: TSQLQuery
    SQL.Strings = (
      'select max(id) from vencimientos')
    Top = 456
  end
  ...
  object DSPVencimeintos: TDataSetProvider
  ...
  object ibgDetalle: TIBGenerator
    ...
    GeneratorName = 'NEXT_ID_VENCIMIENTOS'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 42513.617195601850000000
    ReportOptions.LastChange = 42513.619311527780000000
  ...
  object DBMultiMonthSource1: TDBMultiMonthSource
    AutoIncKey = False
    DataSource = DSVencimientos
    ResourceMap = <>
    StartTimeField = 'FECHA_INCIO'
    EndTimeField = 'FECHA_INCIO'
    KeyField = 'ID'
    ReadOnly = True
    SubjectField = 'IMPORTE'
    NotesField = 'ASUNTO'
    UpdateByQuery = False
  ...
  object QVencimientos: TFDQuery
    ...
    SQL.Strings = (
      ...
      'v.clase_cpbte,'
      'v.nrocpbte,'
      'v.estado, 1 as numeracion from vencimientos v'
      'where v.estado = :estado or :estado = -1')
    Left = 500
    Top = 368
    ParamData = <
    ...
    object QVencimientosNUMERACION: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'NUMERACION'
      Origin = 'NUMERACION'
      ProviderFlags = []
      ReadOnly = True
    end
  end
  object QVencimientos2: TFDQuery
    Connection = DMMain_FD.fdcGestion
    ...
    SQL.Strings = (
      ...
      '    v.asunto,'
      '    v.asunto_2,'
      '    CAST(v.finalizado AS varchar(1)) AS Finalizado,'
      '    v.importe,'
      '    v.id_cpbte,'
      '    v.tipo_cpbte,'
      '    v.clase_cpbte,'
      ...
      '    v.estado,'
        ...
        '    Cast(ROW_NUMBER() OVER (PARTITION BY v.fecha_finalizacion OR' +
        'DER BY v.id) as Integer) AS numeracion'
      '  FROM vencimientos v'
      '  WHERE v.estado = :estado OR :estado = -1'
      '  UNION'
      '  SELECT'
      ...
      '    p.nombre,'
      '    '#39#39' asunto_2,'
      '    CAST('#39'N'#39' AS varchar(1)) AS Finalizado,'
      '    f.saldo,'
      '    f.id_cpbte,'
      '    f.tipocpbte,'
      '    f.clasecpbte,'
      ...
      '    -1 AS estado,'
        ...
        '    Cast(ROW_NUMBER() OVER (PARTITION BY f.fechavto ORDER BY f.i' +
        'd_movcccompra) as Integer) AS numeracion'
      '  FROM movcccompra f'
      '  LEFT JOIN poveedor p ON p.codigo = f.proveedor'
      '  WHERE f.tipocpbte IN ('#39'FC'#39', '#39'ND'#39') AND f.saldo > 0.1'
      ') AS subquery'
      'ORDER BY fecha_finalizacion, numeracion')
    Left = 500
    Top = 440
    ParamData = <
      item
    ...
    object QVencimientos2ID: TIntegerField
      FieldName = 'ID'
      Origin = 'ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QVencimientos2FECHA_INCIO: TSQLTimeStampField
      FieldName = 'FECHA_INCIO'
      Origin = 'FECHA_INCIO'
    end
    object QVencimientos2FECHA_FINALIZACION: TSQLTimeStampField
      FieldName = 'FECHA_FINALIZACION'
      Origin = 'FECHA_FINALIZACION'
    end
    object QVencimientos2ASUNTO: TStringField
      FieldName = 'ASUNTO'
      Origin = 'ASUNTO'
      Size = 200
    end
    object QVencimientos2ASUNTO_2: TStringField
      FieldName = 'ASUNTO_2'
      Origin = 'ASUNTO_2'
      Size = 200
    end
    object QVencimientos2IMPORTE: TFloatField
      FieldName = 'IMPORTE'
      Origin = 'IMPORTE'
    end
    object QVencimientos2ID_CPBTE: TIntegerField
      FieldName = 'ID_CPBTE'
      Origin = 'ID_CPBTE'
    end
    object QVencimientos2TIPO_CPBTE: TStringField
      FieldName = 'TIPO_CPBTE'
      Origin = 'TIPO_CPBTE'
      Size = 2
    end
    object QVencimientos2CLASE_CPBTE: TStringField
      FieldName = 'CLASE_CPBTE'
      Origin = 'CLASE_CPBTE'
      Size = 2
    end
    object QVencimientos2NROCPBTE: TStringField
      FieldName = 'NROCPBTE'
      Origin = 'NROCPBTE'
      Size = 13
    end
    object QVencimientos2FINALIZADO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'FINALIZADO'
      Origin = 'FINALIZADO'
      ProviderFlags = []
    ...
    object QVencimientos2ESTADO: TIntegerField
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
    end
    object QVencimientos2NUMERACION: TIntegerField
      AutoGenerateValue = arDefault
      FieldName = 'NUMERACION'
      Origin = 'NUMERACION'
      ProviderFlags = []
  ...
  object CDSVencimientos: TClientDataSet
    ...
    ProviderName = 'DSPVencimeintos'
    OnCalcFields = CDSVencimientosCalcFields
    Left = 676
    Top = 416
    ...
    object CDSVencimientosFECHA_FINALIZACION: TSQLTimeStampField
      DisplayLabel = 'Fecha Finalizacion'
      FieldName = 'FECHA_FINALIZACION'
      Origin = 'FECHA_FINALIZACION'
    end
    ...
    object CDSVencimientosASUNTO_2: TStringField
      FieldName = 'ASUNTO_2'
      Origin = 'ASUNTO_2'
      Size = 200
    end
    ...
    object CDSVencimientosFINALIZADO: TStringField
      FieldName = 'FINALIZADO'
      Origin = 'FINALIZADO'
      ProviderFlags = []
      ReadOnly = True
    ...
    object CDSVencimientosESTADO: TIntegerField
      DisplayLabel = 'Estado'
      FieldName = 'ESTADO'
      Origin = 'ESTADO'
    end
    object CDSVencimientosSTARTTIME: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'STARTTIME'
    end
    object CDSVencimientosENDTIME: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'ENDTIME'
    end
    object CDSVencimientosNUMERACION: TIntegerField
      FieldName = 'NUMERACION'
      Origin = 'NUMERACION'
      ProviderFlags = []
      ReadOnly = True
  ...
  object DBDaySource: TDBDaySource
    ...
    Mode = dmMultiDay
    NumberOfDays = 1
    MinTimeField = 'FECHA_FINALIZACION'
    MaxTimeField = 'FECHA_INCIO'
    Left = 270
    Top = 393
  end
end
